#!/usr/bin/env bun
/**
 * Transform extension files (Zed, etc.) with Cypher branding
 *
 * This script handles extension configuration files by transforming
 * OpenCode references to Cypher.
 */
...
const EXTENSION_REPLACEMENTS: ExtensionReplacement[] = [
  // TOML files (Zed extension)
  {
    ...
    replacement: 'name = "cypher"',
    description: "Extension name",
    fileTypes: [".toml"],
  },
  {
    pattern: /id\s*=\s*"opencode"/g,
    replacement: 'id = "cypher"',
    description: "Extension ID",
    fileTypes: [".toml"],
  },
  {
    pattern: /description\s*=\s*"OpenCode[^"]*"/g,
    replacement: 'description = "Cypher - AI coding assistant"',
  ...
  // GitHub/Repository references
  {
    ...
    replacement: 'repository = "https://github.com/Cypher-Org/cypher"',
  ...
  // Binary/command references
  {
    ...
    replacement: 'command = "cypher"',
    description: "Command name",
    fileTypes: [".toml"],
  },

  // Generic OpenCode -> Cypher in strings
  {
    pattern: /"OpenCode"/g,
    replacement: '"Cypher"',
  ...
  },
  {
    ...
    replacement: "Cypher language server",
