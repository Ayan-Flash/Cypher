 ...
 * by transforming them from anomalyco/opencode to Cypher-Org/cypher.
 */
...
const SCRIPT_REPLACEMENTS: ScriptReplacement[] = [
  // GitHub API URLs
  {
    ...
    replacement: "api.github.com/repos/Cypher-Org/cypher",
    description: "GitHub API URL",
  },
  {
    pattern: /\/repos\/anomalyco\/opencode/g,
    replacement: "/repos/Cypher-Org/cypher",
  ...
  // gh CLI commands
  {
    ...
    replacement: 'gh api "/repos/Cypher-Org/cypher',
