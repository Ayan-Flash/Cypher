...
import { getAvailableUpstreamVersions, getCurrentCypherVersion } from "./utils/version"
...
async function main() {
  ...
  const cypherVersion = await getCurrentCypherVersion()

  console.log()
  success(`Current Cypher version: ${cypherVersion}`)
  console.log()
