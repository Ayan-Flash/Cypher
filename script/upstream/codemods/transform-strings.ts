 ...
 *
 * Transforms string literals containing opencode references to cypher:
 * - "opencode-ai" -> "@cypher/cli"
 * - "npx opencode" -> "npx @cypher/cli"
 * - etc.
 *
 * Usage:
...
const STRING_REPLACEMENTS: StringReplacement[] = [
  ...
  { pattern: /\bopencode-ai\b/g, replacement: "@cypher/cli" },
  ...
  // CLI commands
  { pattern: /\bnpx opencode\b/g, replacement: "npx @cypher/cli" },
  { pattern: /\bbun add opencode\b/g, replacement: "bun add @cypher/cli" },
  { pattern: /\bnpm install opencode\b/g, replacement: "npm install @cypher/cli" },
  { pattern: /\bnpm i opencode\b/g, replacement: "npm i @cypher/cli" },

  // Database filename
  { pattern: /\bopencode\.db\b/g, replacement: "cypher.db" },

  // Binary name references (be careful with these)
  { pattern: /\bopencode upgrade\b/g, replacement: "cypher upgrade" },
  ...
  { pattern: /\bVITE_OPENCODE_/g, replacement: "VITE_CYPHER_" },
  { pattern: /\b_EXTENSION_OPENCODE_/g, replacement: "_EXTENSION_CYPHER_" },
]
