...
Generates UPCOMING_CHANGELOG.md by running the cypher changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for cypher run (default: low)
      --quiet            Suppress cypher command output unless it fails
...
const cmd = ["cypher", "run"] // cypher_change - opencode -> cypher
