...
const forbidden: { pattern: string; reason: string; allow?: string[] }[] = [
  { pattern: "opncd.ai/s/", reason: "legacy upstream share URL pattern" },
  {
    ...
    reason: "upstream repo URL -- should be Cypher-Org/cypher",
    allow: [
      "AGENTS.md",
      "README.md",
      "translations/README.",
      ".opencode/glossary/",
      "packages/cypher-vscode/AGENTS.md",
      "packages/cypher-docs/source-links.md",
      "patches/",
      "script/upstream/",
      "translations/",
    ],
  },
  {
    ...
    reason: "old upstream org path -- should be Cypher-Org/cypher",
    allow: [".cypher/agent/upstream-merge.md", "script/upstream/"],
  },
