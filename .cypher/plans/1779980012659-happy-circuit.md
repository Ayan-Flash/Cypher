...
- [ ] Confirm whether the change belongs in Cypher-owned code or shared upstream code.
...
- Prefer Cypher-owned directories for Cypher-specific behavior.
- If shared upstream files must be edited, keep the change narrow and add `cypher_change` markers where required.
