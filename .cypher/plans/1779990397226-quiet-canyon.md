...
- The relevant files are `packages/cypher-jetbrains/frontend/src/main/kotlin/ai/cypher/client/session/SessionUi.kt`, `.../scroll/SessionScroll.kt`, `.../views/question/QuestionView.kt`, `.../views/permission/PermissionView.kt`, `.../views/LoginRequiredView.kt`, `.../views/base/BaseQuestionView.kt`, and `frontend/src/test/kotlin/ai/cypher/client/session/SessionScrollTest.kt`.
...
- From `packages/cypher-jetbrains/`, run `./gradlew test --tests "ai.cypher.client.session.SessionScrollTest"`.
- From `packages/cypher-jetbrains/`, run `./gradlew typecheck`.
