...
const file = "packages/cypher-jetbrains/package.json"
...
if (values.help) {
  console.log(`
Usage: bun .cypher/skills/release-jetbrains/script/set-pin.ts (--latest | --version <x.y.z>) [--pr]
...
console.log("Test locally with: cd packages/cypher-jetbrains && ./gradlew typecheck && ./gradlew test")
