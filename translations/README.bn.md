...
Cypher CLI হলো একটি AI কোডিং এজেন্ট যা আপনি যেখানে কাজ করেন সেখানেই কাজ করে: [VS Code](https://cypher.ai/landing/vs-code), [JetBrains](https://cypher.ai/features/jetbrains-native) এবং [CLI](https://cypher.ai/cli)। এটি ওপেন সোর্স এবং খোলা মূল্যনীতির। আপনি 500টির বেশি মডেল থেকে বেছে নিতে পারেন, কাজের মাঝখানে মডেল বদলাতে পারেন এবং কোনো অতিরিক্ত চার্জ ছাড়াই মডেল প্রদানকারীর রেট পরিশোধ করেন। শুরু করতে API key দরকার নেই।

### ইনস্টলেশন

আপনি কোথায় Cypher চালাতে চান তা বেছে নিন।
...
[Cypher CLI extension](vscode:extension/cypher.cypher-cli) সরাসরি ইনস্টল করুন, অথবা [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=cypher.Cypher-Code) থেকে নিন। একটি অ্যাকাউন্ট তৈরি করলে GPT-5.5, Claude Opus 4.7, Claude Sonnet 4.6 এবং Gemini 3.1 Pro Preview সহ 500টির বেশি মডেলে প্রদানকারীর দামে অ্যাক্সেস পাবেন।
...
তারপর শুরু করতে যেকোনো প্রজেক্ট ডিরেক্টরিতে `cypher` চালান।
...
JetBrains Marketplace থেকে [Cypher CLI plugin](https://plugins.jetbrains.com/plugin/28350-cypher-cli) ইনস্টল করুন, অথবা যেকোনো JetBrains IDE-তে `Settings → Plugins`-এ "Cypher CLI" খুঁজুন।
...
লোকাল মেশিন ছাড়াই ওয়েব থেকে [app.cypher.ai/cloud](https://app.cypher.ai/cloud)-এ Cypher চালান।
...
[app.cypher.ai/code-reviews](https://app.cypher.ai/code-reviews)-এ আপনার pull request-এ স্বয়ংক্রিয় AI code review সেট আপ করুন।
...
[app.cypher.ai/claw](https://app.cypher.ai/claw)-এ আপনার always-on AI agent চালু করুন।
...
[Releases page](https://github.com/Cypher-Org/cypher/releases) থেকে সর্বশেষ বাইনারি ডাউনলোড করুন।

| প্ল্যাটফর্ম | Asset |
|---|---|
| Windows (বেশিরভাগ PC) | `cypher-windows-x64.zip` |
...
নোট: `x64-baseline` হলো AVX ছাড়া পুরোনো CPU-এর জন্য compatibility build। `musl` হলো Alpine বা glibc ছাড়া minimal Docker image-এর জন্য statically linked build। `cypher-vscode-*.vsix` হলো VS Code extension package, CLI নয়। `Source code` archive source থেকে build করার জন্য।

</details>

### Agents

Cypher বিশেষায়িত agents সহ আসে, কাজ অনুযায়ী আপনি এগুলোর মধ্যে বদলাতে পারেন। আপনি নিজের custom agents-ও বানাতে পারেন।
...
[agents এবং custom agents](https://cypher.ai/docs/code-with-ai/agents/using-agents) সম্পর্কে আরও জানুন।
...
CI/CD pipeline-এর জন্য prompts ছাড়া পুরোপুরি autonomous operation পেতে `cypher run`-এর সাথে `--auto` ব্যবহার করুন:
...
Configuration এবং বাকি সবকিছুর জন্য [docs](https://cypher.ai/docs) দেখুন।

### Contributing

Developer, writer এবং সবাইকে contribution-এর জন্য স্বাগতম। environment setup, coding standard এবং pull request খোলার পদ্ধতির জন্য [Contributing Guide](/CONTRIBUTING.md) দিয়ে শুরু করুন। VS Code extension এবং CLI release process-এর জন্য [RELEASING.md](../RELEASING.md), এবং JetBrains plugin-এর জন্য [packages/cypher-jetbrains/RELEASING.md](../packages/cypher-jetbrains/RELEASING.md) দেখুন।
...
<details>
<summary>Cypher CLI কোথা থেকে এসেছে?</summary>

Cypher CLI হলো [OpenCode](https://github.com/anomalyco/opencode)-এর একটি fork, Cypher agentic engineering platform-এর মধ্যে কাজ করার জন্য উন্নত করা হয়েছে।

</details>

---

**কমিউনিটিতে যোগ দিন** [Discord](https://cypher.ai/discord) | [X](https://x.com/cypher) | [Reddit](https://www.reddit.com/r/cypher/)
