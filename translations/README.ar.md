...
Cypher CLI هو وكيل برمجة بالذكاء الاصطناعي يعمل معك أينما تعمل: [VS Code](https://cypher.ai/landing/vs-code) و[JetBrains](https://cypher.ai/features/jetbrains-native) و[CLI](https://cypher.ai/cli). إنه مفتوح المصدر وبتسعير مفتوح. يمكنك الاختيار من بين أكثر من 500 نموذج، والتبديل بينها أثناء المهمة، ودفع سعر مزود النموذج من دون أي هامش إضافي. لا تحتاج إلى مفاتيح API للبدء.

### التثبيت

اختر المكان الذي تريد تشغيل Cypher فيه.
...
ثبّت [إضافة Cypher CLI](vscode:extension/cypher.cypher-cli) مباشرة، أو احصل عليها من [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=cypher.Cypher-Code). أنشئ حسابًا وستحصل على إمكانية الوصول إلى أكثر من 500 نموذج، بما في ذلك GPT-5.5 وClaude Opus 4.7 وClaude Sonnet 4.6 وGemini 3.1 Pro Preview، كلها بسعر المزود.
...
بعد ذلك شغّل `cypher` في أي مجلد مشروع للبدء.
...
ثبّت [إضافة Cypher CLI](https://plugins.jetbrains.com/plugin/28350-cypher-cli) من JetBrains Marketplace، أو ابحث عن "Cypher CLI" في `Settings → Plugins` داخل أي JetBrains IDE.
...
شغّل Cypher من الويب، من دون جهاز محلي، على [app.cypher.ai/cloud](https://app.cypher.ai/cloud).
...
أعدّ مراجعات كود آلية بالذكاء الاصطناعي لطلبات السحب الخاصة بك على [app.cypher.ai/code-reviews](https://app.cypher.ai/code-reviews).
...
شغّل وكيل الذكاء الاصطناعي الدائم لديك على [app.cypher.ai/claw](https://app.cypher.ai/claw).
...
نزّل أحدث ملف ثنائي من [صفحة Releases](https://github.com/Cypher-Org/cypher/releases).

| المنصة | الملف |
|---|---|
| Windows (معظم أجهزة PC) | `cypher-windows-x64.zip` |
...
ملاحظات: `x64-baseline` هو بناء توافق للمعالجات القديمة التي لا تدعم AVX. `musl` هو البناء المرتبط ثابتًا لـ Alpine أو صور Docker البسيطة من دون glibc. `cypher-vscode-*.vsix` هو حزمة إضافة VS Code وليس CLI. أرشيفات `Source code` مخصصة للبناء من المصدر.

</details>

### Agents

يأتي Cypher مع agents متخصصة يمكنك التبديل بينها حسب المهمة. يمكنك أيضًا إنشاء agents مخصصة خاصة بك.
...
تعرّف أكثر على [agents وagents المخصصة](https://cypher.ai/docs/code-with-ai/agents/using-agents).
...
شغّل `cypher run` مع `--auto` للعمل بشكل مستقل بالكامل ومن دون prompts، وهو مصمم لخطوط CI/CD:
...
لإعدادات التكوين وكل ما عدا ذلك، راجع [التوثيق](https://cypher.ai/docs).

### المساهمة

نرحب بمساهمات المطورين والكتّاب والجميع. ابدأ بـ [Contributing Guide](/CONTRIBUTING.md) لإعداد البيئة ومعايير الكود وكيفية فتح pull request. راجع [RELEASING.md](../RELEASING.md) لعملية إصدار إضافة VS Code وCLI، و[packages/cypher-jetbrains/RELEASING.md](../packages/cypher-jetbrains/RELEASING.md) لإضافة JetBrains.
...
<details>
<summary>من أين جاء Cypher CLI؟</summary>

Cypher CLI هو fork من [OpenCode](https://github.com/anomalyco/opencode)، وتم تحسينه للعمل داخل منصة Cypher agentic engineering.

</details>

---

**انضم إلى المجتمع** [Discord](https://cypher.ai/discord) | [X](https://x.com/cypher) | [Reddit](https://www.reddit.com/r/cypher/)
