...
declare const CYPHER_BWRAP_SHA256: string | undefined
...
function digest() {
  return typeof CYPHER_BWRAP_SHA256 === "undefined" ? undefined : CYPHER_BWRAP_SHA256
}
...
function select(): Selection {
  const override = process.env.CYPHER_BWRAP_PATH
