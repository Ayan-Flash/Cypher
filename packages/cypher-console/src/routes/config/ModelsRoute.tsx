...
import { IconButton } from "@cypher/cypher-web-ui/icon-button"
import type { Model } from "@cypher/sdk/v2/client"
  ...
  return (
    <Show when={state.snap()}>
      <ConfigPage
        ...
        description="The models Cypher uses when an agent or command doesn't pin its own."
      >
        ...
        <Card class="ui-card" padding={0}>
          <header class="ui-card-header">
            <div>
              ...
              <p>Control which Cypher Gateway models appear in model lists.</p>
            </div>
          ...
          <div class="ui-form">
            ...
            >
              <span>
                ...
                <small>Hide Cypher Gateway models whose providers may use your prompts for training.</small>
            ...
            <Show when={state.gateway()}>
              <div class="models-privacy-filter-group">
                ...
                <button
                  ...
                  type="button"
                  aria-label="Hide Cypher Gateway models whose providers may use prompts for training"
