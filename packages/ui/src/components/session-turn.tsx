...
import type { SessionStatus } from "@cypher/sdk/v2"
...
export function SessionTurn(
  ...
  const pending = createMemo(() => {
    if (typeof props.active === "boolean" && typeof props.queued === "boolean") return // cypher_change
    const messages = allMessages() ?? emptyMessages
  ...
  // cypher_change start — restore queued feature
  ...
  const showThinking = createMemo(() => {
    ...
    if (queued()) return false // cypher_change
