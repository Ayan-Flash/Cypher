...
export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Pretplatite se na Cypher Go za pouzdan pristup najboljim open-source modelima, počevši od $5/mjesec.",
  ...
  "ui.tool.swePruned": "SWE-Pruner · zadržano {{kept}} od {{total}} redova", // cypher_change
