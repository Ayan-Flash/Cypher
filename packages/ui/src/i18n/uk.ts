export const dict: Record<string, string> = {
  ...
  "ui.fileMedia.state.unavailable": "Попередній перегляд {{kind}} недоступний.", // cypher_change
  ...
  "ui.sessionTurn.retry.retrying": "повтор спроби", // cypher_change
  "ui.sessionTurn.retry.inSeconds": "через {{seconds}}с", // cypher_change
  "ui.sessionTurn.retry.attempt": "спроба №{{attempt}}",
  "ui.sessionTurn.retry.attemptLine": "{{line}} — спроба №{{attempt}}",
  "ui.sessionTurn.retry.geminiHot": "Gemini зараз перевантажений", // cypher_change
  ...
  // cypher_change start - complete upstream usage-exceeded translations
  "dialog.usageExceeded.freeTier.title": "Досягнуто безкоштовного ліміту",
  "dialog.usageExceeded.freeTier.description":
    "Підпишіться на Cypher Go, щоб отримати надійний доступ до найкращих моделей із відкритим кодом, від $5 на місяць.",
  ...
  "ui.messagePart.title.write": "Записати", // cypher_change
  "ui.messagePart.option.typeOwnAnswer": "Введіть власну відповідь",
  "ui.messagePart.review.title": "Перегляньте свої відповіді", // cypher_change
  ...
  // cypher_change end
  "ui.scrollView.ariaLabel": "вміст з прокруткою", // cypher_change

  "ui.tool.read": "Читання",
  "ui.tool.loaded": "Завантажено",
  "ui.tool.swePruned": "SWE-Pruner · збережено {{kept}} з {{total}} рядків", // cypher_change
  "ui.tool.list": "Список",
  "ui.tool.glob": "Glob",
  "ui.tool.grep": "Grep",
  "ui.tool.task": "Завдання",
  "ui.tool.webfetch": "Веб-запит", // cypher_change
  "ui.tool.websearch": "Веб-пошук",
  "ui.tool.codesearch": "Пошук коду", // cypher_change
  ...
  "ui.patch.action.patched": "Застосовано патч", // cypher_change

  "ui.question.subtitle.answered": "{{count}} відповідей",
  "ui.question.subtitle.dismissed": "{{count}} dismissed", // cypher_change
  "ui.question.answer.none": "(немає відповіді)",
  "ui.question.answer.dismissed": "Dismissed", // cypher_change
