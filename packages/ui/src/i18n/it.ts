...
export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Abbonati a Cypher Go per un accesso affidabile ai migliori modelli open source, a partire da $5 al mese.",
  ...
  "ui.tool.swePruned": "SWE-Pruner · {{kept}} di {{total}} righe mantenute", // cypher_change
  "ui.tool.list": "Elenco",
  "ui.tool.glob": "Glob",
  "ui.tool.grep": "Grep",
