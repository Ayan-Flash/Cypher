export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Subscribe to Cypher Go for reliable access to the best open-source models, starting at $5/month.",
  ...
  "ui.tool.swePruned": "SWE-Pruner · kept {{kept}} of {{total}} lines", // cypher_change
  "ui.tool.list": "List",
  "ui.tool.glob": "Glob",
  "ui.tool.grep": "Grep",
  "ui.tool.task": "Task",
