...
const mainNavItems: NavItem[] = [
  ...
  { label: "Cypher Gateway", href: "/gateway" },
  { label: "CypherClaw", href: "/cypherclaw" },
  { label: "Contributing", href: "/contributing" },
]

const contributingItems: DropdownItem[] = [
  { label: "Contributing Guide", href: "/contributing", description: "How to contribute to Cypher CLI" },
  {
    label: "Code of Conduct",
    href: "https://github.com/Cypher-Org/cypher?tab=coc-ov-file",
    description: "Our community guidelines",
  },
  { label: "GitHub Repository", href: "https://github.com/Cypher-Org/", description: "View source and issues" },
  { label: "Discord Community", href: "https://cypher.ai/discord", description: "Join our community" },
]
...
const helpItems: DropdownItem[] = [
  ...
  { label: "Support", href: "https://cypher.ai/support", description: "Get help from the team" },
  {
    label: "Changelog",
    href: "https://github.com/Cypher-Org/cypher/releases",
...
function preview(url: string) {
  ...
  if (value.hostname !== "cypher.ai" || !value.pathname.startsWith("/docs")) return url
    ...
    <header className="top-header">
      ...
      <div className="top-bar">
        ...
        <Link href="/" className="logo-link flex gap-2 items-center">
          ...
          <div>
            <span className="logo-text font-brand">Cypher CLI</span>
        ...
        <div className="right-actions">
          ...
          <ThemeToggle />
          <Link href="https://cypher.ai/github" className="github-link desktop-nav">
            GitHub
          </Link>
          <Link href="https://app.cypher.ai" className="signin-btn desktop-nav">
            Sign in
          </Link>
        </div>
      </div>
      ...
      <div className="announcement-banner">
        <p>
          The all-new Cypher CLI extension is here, rebuilt on the{" "}
          <Link href="/code-with-ai/platforms/vscode/whats-new">Cypher CLI</Link> for speed, flexibility, and continued
          access to 500+ models via the Cypher Gateway →
        </p>
      </div>
