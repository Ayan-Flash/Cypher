---
title: "Integrations"
description: "Overview of Cypher CLI integrations"
---

# Cypher CLI Integrations

Cypher Integrations lets you connect GitHub or GitLab for repository workflows and DoltHub for Dolt-versioned data. Once connected, Cypher can access authorized resources securely, enabling features like **Code Reviews**, **Cloud Agents**, **Cypher Deploy**, and data workflows through **Cypher Connect**.
...
- **Connect GitHub, GitLab, or DoltHub to Cypher CLI** in a few clicks
- **Enable advanced features** like Cloud Agents, Code Reviews, and Cypher Deploy
- **Authorize GitHub or GitLab repository access** so Cypher can analyze and work with your code
...
- For GitHub: You need permission to install GitHub Apps for the repositories you want Cypher to access.
...
Go to your **Personal** or **Organization Dashboard**, and navigate to the [Integrations](https://app.cypher.ai/integrations) tab.

### 2. Start the Connection Flow

1. Click **Configure** on the GitHub panel.
2. You'll be redirected to GitHub to authorize the **CypherConnect** App.
3. Select the GitHub account or organization you want to connect.

### 3. Choose Repository Access

GitHub will ask which repositories you want Cypher to access:
...
- You'll return to the Cypher Integrations page.
- GitHub will show a **Connected** status.
- Your Cypher workspace can now access GitHub repositories securely.
...
1. Go to the **Integrations** page:
   - **Personal**: [app.cypher.ai/integrations/gitlab](https://app.cypher.ai/integrations/gitlab)
   - **Organization**: Your organization → Integrations → GitLab
2. Click **Connect GitLab**
3. Authorize the application on GitLab
4. You'll be redirected back to Cypher with the connection active
...
2. Create a new application:
   - **Name**: `Cypher CLI`
   - **Redirect URI**: `https://app.cypher.ai/api/integrations/gitlab/callback`
   - **Scopes**: `api`, `read_user`, `read_repository`, `write_repository`
   - **Confidential**: Yes
3. Copy the **Application ID** and **Secret**
4. In Cypher, go to the GitLab integration page
...
> PAT tokens cannot be refreshed automatically. When your token expires, create a new one in GitLab and reconnect in Cypher.
...
Use the DoltHub integration page to connect your DoltHub account. Cypher uses this OAuth connection for [Cypher Connect](/docs/code-with-ai/platforms/cypher-connect) and as the default auth method for [Gas Town Wasteland](/docs/code-with-ai/gastown/wasteland).

1. Go to the **Integrations** page:
   - **Personal**: [app.cypher.ai/integrations/dolthub](https://app.cypher.ai/integrations/dolthub)
   - **Organization**: Your organization → Integrations → DoltHub
2. Click **Connect DoltHub**.
3. Approve Cypher on DoltHub.
4. Return to Cypher and confirm DoltHub shows a **Connected** status.

{% image src="/docs/img/integrations/dolthub/connect.png" alt="DoltHub integration page before OAuth connection" width="900" caption="DoltHub integration page in Cypher" /%}

{% image src="/docs/img/integrations/dolthub/authorize.png" alt="DoltHub OAuth authorization screen for Cypher" width="700" caption="DoltHub OAuth authorization screen" /%}
...
Once your integrations are connected, the following features are enabled in Cypher:

### Cloud Agents

- Run Cypher CLI in the cloud from any device
...
- Deploy Next.js 14 & 15 apps directly from Cypher
...
- Update which repositories Cypher has access to
...
> Disconnecting from Cypher does not revoke OAuth tokens on GitLab's side. You can manually revoke them from **GitLab → User Settings → Applications → Authorized Applications**.
...
- Disconnect DoltHub from Cypher
...
Ensure the CypherConnect App is installed for the correct GitHub org and that repo access includes the repositories you need.
...
- **PAT**: Create a new token in GitLab and reconnect in Cypher.
...
- Verify the redirect URI matches: `https://app.cypher.ai/api/integrations/gitlab/callback`
