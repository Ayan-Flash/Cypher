...
Cypher CLI implements the Model Context Protocol to:
...
- [Using MCP in Cypher CLI](using-in-cypher-cli) - Get started with MCP in Cypher CLI, including creating simple servers
