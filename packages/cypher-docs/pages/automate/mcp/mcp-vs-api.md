...
## Why Cypher CLI Uses MCP

Cypher CLI leverages MCP to provide:
...
MCP creates a universal connector between Cypher CLI and external services, with REST APIs often powering those services behind the scenes.
