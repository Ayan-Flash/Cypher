---
title: "Automate"
description: "Automate your development workflows with Cypher CLI"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Automate repetitive tasks, set up AI-powered code reviews, and extend Cypher CLI's capabilities with integrations and MCP servers.
{% /callout %}
...
Connect Cypher CLI to external tools and services:
...
- [**Using MCP in Cypher CLI**](/docs/automate/mcp/using-in-cypher-cli) — Configuration guide
...
Connect Cypher CLI with your development tools:
...
Customize and extend Cypher CLI's capabilities:
...
2. Configure [MCP servers](/docs/automate/mcp/using-in-cypher-cli) for external integrations
