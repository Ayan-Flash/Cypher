---
title: "Deploy & Secure"
description: "Deploy applications and manage security with Cypher CLI"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Deploy your applications directly from Cypher CLI and manage security with AI-powered reviews and scans.
{% /callout %}
