---
title: "Deploy"
description: "Deploy your applications with Cypher CLI"
---

# Deploy

Cypher Deploy lets you ship **Next.js** and **static sites** directly from Cypher CLI, with:

- **One-click deployment** from the Cypher CLI dashboard
...
2. Click **Configure** and follow the prompts to connect GitHub to Cypher CLI
...
- Navigate to your [Organization dashboard](https://app.cypher.ai/organizations) or [Profile](https://app.cypher.ai/profile)
...
Cypher Deploy does **not** include built-in database hosting, but you can connect to any external database service.

---

## Environment Variables

Cypher Deploy supports Environment Variables and Secrets. Add the variable **key** and **value** during the **Create New Deployment** step, and toggle to mark as secrets.
