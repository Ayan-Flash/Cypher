---
title: "Customize"
description: "Make Cypher CLI work your way with custom modes, rules, instructions, and more"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Cypher CLI is highly customizable. Tailor its behavior to match your workflow, team standards, and project requirements with custom modes, rules, instructions, and more.
{% /callout %}

## Customization

Configure how Cypher CLI behaves and responds:
...
- [**Skills**](/docs/customize/skills) - Extend Cypher's capabilities with reusable skill definitions
- [**Prompt Engineering**](/docs/customize/prompt-engineering) - Write effective prompts for better results

## Context & Indexing

Help Cypher understand your codebase better:
...
1. **Start with Custom Instructions** — Set up instructions in the [Custom Instructions](/docs/customize/custom-instructions) section to guide Cypher CLI's behavior
2. **Explore Custom Modes** — Try the built-in modes first, then create your own
3. **Enable Codebase Indexing** — Help Cypher understand your project structure
...
- Check out [**Code with AI**](/docs/code-with-ai) to learn how to use Cypher effectively
