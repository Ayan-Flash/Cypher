...
description: "Configure Cypher CLI and connect to your AI providers"
---

# Authentication

When you install Cypher CLI, you'll be prompted to sign in or create a free account. This automatically configures everything you need to get started.

## Quick Start with Cypher Account

{% tabs %}
{% tab label="VS Code" %}

The extension prompts you to sign in when you first open Cypher CLI in VS Code. Click **Sign In** and complete the browser-based flow. Sign-in applies across extension surfaces, including the sidebar and Agent Manager.
...
[Add credits to your account](https://app.cypher.ai/profile), or sign up for [Cypher Pass](https://cypher.ai/pricing/cypher-pass).
{% /callout %}

## Cypher Gateway API Key

If you're using the [Cypher AI Gateway](/docs/gateway/) outside of the Cypher CLI extension (for example, with the Vercel AI SDK or OpenAI SDK), you'll need an API key:

1. Go to [app.cypher.ai](https://app.cypher.ai)
...
If you prefer to use your own API key or existing subscription, Cypher CLI supports **over 30 providers**. Here are some popular options to get started:
...
These are just a few examples! Cypher CLI supports many more providers including Google Gemini, DeepSeek, Mistral, Ollama (for local models), AWS Bedrock, Google Vertex, and more. See the complete list at [AI Providers](/docs/ai-providers/).
{% /callout %}

### ChatGPT Plus/Pro Subscription

Already have a ChatGPT subscription? You can use it with Cypher CLI through the [OpenAI ChatGPT provider](/docs/ai-providers/openai-chatgpt-plus-pro)—no API key needed.
...
These settings apply across the extension, including the sidebar and Agent Manager. Agent Manager does not need separate provider or Cypher CLI authentication setup.
...
Or use `cypher auth login` for providers that support OAuth, such as GitHub Copilot or ChatGPT Plus/Pro.
...
Reach out to our [support team](mailto:hi@cypher.ai) or join our [Discord community](https://cypher.ai/discord).
{% /callout %}
