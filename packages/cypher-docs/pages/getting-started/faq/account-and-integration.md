...
description: "Questions about accounts and integrations in Cypher CLI"
tocDepth: 2
---

# Account and Integration

This section contains questions about accounts and integrations in Cypher CLI.
...
This process involves removing the **Cypher Connect** application from your GitHub account settings.
...
2. Find **Cypher Connect** in the list of installed applications
3. Click **Configure** next to Cypher Connect
4. From the configuration page, you can either:
   - **Uninstall** the integration completely, or
   - **Edit** which repositories are connected

{% callout type="tip" %}
If you'd like to reconnect GitHub later, simply open your Cypher CLI profile, go to **Integrations**, and connect GitHub again.
{% /callout %}
