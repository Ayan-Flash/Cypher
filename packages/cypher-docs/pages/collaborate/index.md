---
title: "Collaborate"
description: "Work together with Cypher CLI team features"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Cypher CLI makes it easy to work together with your team. Share sessions, manage team settings, and track AI adoption across your organization.
{% /callout %}

## Sessions & Sharing

Sessions are your platform-agnostic interaction with Cypher. They remember your repository, task, and conversation so you can pause and resume work without losing context.

- [**Sessions & Sharing**](/docs/collaborate/sessions-sharing) — Share and collaborate on Cypher CLI sessions
...
Cypher CLI's paid plans provide powerful team management features:
...
- **Enterprise ([Contact Sales](https://cypher.ai/contact-sales))** — Model controls, audit logs, SSO, dedicated support
...
1. [Install Cypher CLI](/docs/getting-started/installing) in your preferred environment
