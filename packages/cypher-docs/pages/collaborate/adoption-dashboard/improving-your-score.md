...
**Action:** Install the Cypher CLI to enable AI-assisted terminal workflows:
...
**Action:** Use [Cypher Deploy](/docs/deploy-secure/deploy) to spin up live URLs for branches, allowing your team to verify changes before merging.
...
Most teams start with Code mode and stop there. But Cypher's other modes unlock additional value.
...
4. Consider Cypher Deploy to validate AI output
