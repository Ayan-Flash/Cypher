---
title: "About Plans"
description: "Overview of Cypher CLI plans and pricing"
---

# About Plans

Cypher CLI accelerates development with AI-driven code generation and task automation. You can use Cypher CLI as an open source extension in VS Code or JetBrains IDEs.
...
Cypher CLI's paid plans, Teams and Enterprise, are the solution for these organizations.

{% callout type="note" %}

Purchases of Cypher CLI's paid plans are separate from model provider credits.

No credits are included with a Teams or Enterprise plan purchase.

{% /callout %}

## What You Get from Cypher Teams
...
## What You Get from Cypher Enterprise
...
**Cost:** [Contact Sales](https://cypher.ai/contact-sales)
