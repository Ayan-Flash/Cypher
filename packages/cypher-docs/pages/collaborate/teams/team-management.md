...
description: "Add and manage team members in Cypher CLI"
---
...
Members can use the Cypher CLI extension and see data on the team's usage in the [usage dashboard](/docs/collaborate/teams/analytics).
