---
title: "Contributing"
description: "Contribute to Cypher CLI"
---

# Contributing Overview

{% callout type="info" %}
**New versions of the VS Code extension and CLI are being developed in [Cypher-Org/cypher](https://github.com/Cypher-Org/cypher)** (extension at `packages/cypher-vscode`, CLI at `packages/opencode`). If you're looking to contribute to the extension or CLI, please head over to that repository.
{% /callout %}

Cypher CLI is an open-source project that welcomes contributions from developers of all skill levels. This guide will help you get started with contributing to Cypher CLI, whether you're fixing bugs, adding features, improving documentation, or sharing custom modes.

## Ways to Contribute

There are many ways to contribute to Cypher CLI:

1. **Code Contributions**: Implement new features or fix bugs
2. **Documentation**: Improve existing docs or create new guides
3. **Marketplace Contributions**: Create and share custom modes, skills, and MCP servers via the [Cypher Marketplace](https://github.com/Cypher-Org/cypher-marketplace)
...
Before diving into the code, we recommend reviewing the [Architecture Overview](/docs/contributing/architecture) to understand how the different components of Cypher CLI fit together.
...
AI and coding agents are welcome in Cypher contributions. Contributors still own the work they submit: you must personally understand the change, test it appropriately, be able to explain the diff, and understand how it interacts with the affected package and the rest of the repo.
...
- Run `bun run script/extract-source-links.ts` after adding or changing guarded URLs in `packages/cypher-vscode/`, `packages/cypher-vscode/webview-ui/`, or `packages/opencode/src/`.
...
- Use the root [TESTING.md](https://github.com/Cypher-Org/cypher/blob/main/TESTING.md) guide for backend/API validation with `bun dev serve` and `curl`-based requests.
...
2. Go to the [Cypher CLI repository](https://github.com/Cypher-Org/cypher)
...
## Contributing to the Cypher Marketplace

The [Cypher Marketplace](https://github.com/Cypher-Org/cypher-marketplace) is a community-driven repository of agent tooling that extends Cypher CLI's capabilities. You can contribute:
...
3. Submit a pull request to the [Cypher Marketplace repository](https://github.com/Cypher-Org/cypher-marketplace)
...
When participating in the Cypher CLI community:

- Be respectful and inclusive
- Provide constructive feedback
- Help newcomers get started
- Follow the [Code of Conduct](https://github.com/Cypher-Org/cypher/blob/main/CODE_OF_CONDUCT.md)

## Getting Help

If you need help with your contribution:

- Join our [Discord community](https://cypher.ai/discord) for real-time support
- Ask questions on [GitHub Discussions](https://github.com/Cypher-Org/cypher/discussions)
- Visit our [Reddit community](https://www.reddit.com/r/cypher)

## Recognition

All contributors are valued members of the Cypher CLI community. Contributors are recognized in:

- Release notes
- The project's README
- The contributors list on GitHub

Thank you for contributing to Cypher CLI and helping make AI-powered coding assistance better for everyone!
