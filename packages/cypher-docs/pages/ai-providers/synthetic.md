---
title: "Using Synthetic with Cypher CLI"
description: "Access open-source AI models through Synthetic in Cypher CLI. Setup guide for getting an API key and configuring models."
sidebar_label: Synthetic
---

# Using Synthetic With Cypher CLI
...
Cypher CLI supports all "always on" Synthetic AI models. The available models include various open-source options optimized for different use cases.
