---
title: "Using Vercel v0 with Cypher CLI"
description: "Connect Vercel's v0 models to Cypher CLI for UI-focused code generation. Setup guide for VS Code and the CLI."
sidebar_label: v0
---

# Using v0 With Cypher CLI

Cypher CLI supports v0, Vercel's AI model provider that offers an OpenAI-compatible API. This allows you to use v0's models with Cypher CLI through the familiar OpenAI API interface.

## Prerequisites

To use v0 with Cypher CLI, you'll need:
