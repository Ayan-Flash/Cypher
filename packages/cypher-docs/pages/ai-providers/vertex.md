---
title: "Using GCP Vertex AI with Cypher CLI"
description: "Connect Google Cloud Vertex AI to Cypher CLI to use Claude, Gemini, and other models through your GCP account."
sidebar_label: GCP Vertex AI
---

# Using GCP Vertex AI With Cypher CLI

Cypher CLI supports accessing models through Google Cloud Platform's Vertex AI, a managed machine learning platform that provides access to various foundation models, including Anthropic's Claude family.
...
- **Application Default Credentials (ADC):** Cypher CLI uses Application Default Credentials to authenticate with Vertex AI. The easiest way to set this up is to:
...
- **Prompt caching:** Claude models served through Vertex AI support Cypher prompt caching. Cypher applies Anthropic cache controls and tracks cache write/read tokens when Vertex reports them. Native Vertex Gemini models use Google's implicit server-side caching; no extra Cypher configuration is required, and Gemini may not report cache write tokens.
