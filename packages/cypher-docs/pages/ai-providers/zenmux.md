---
title: "Using ZenMux with Cypher CLI | Unified AI Gateway"
description: "Access OpenAI, Anthropic, Google, and other AI models through ZenMux in Cypher CLI with automatic routing and cost optimization."
sidebar_label: ZenMux
---

# Using ZenMux With Cypher CLI
...
3. **Configure in Cypher CLI:** Add your API key to Cypher CLI settings.
...
- Check the [Cypher CLI GitHub repository](https://github.com/Cypher-Org/cypher) for integration-specific issues
