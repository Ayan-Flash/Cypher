---
title: "Using SAP AI Core with Cypher CLI"
description: "Connect SAP AI Core to Cypher CLI to use enterprise foundation models from your SAP BTP account. Setup and authentication guide."
sidebar_label: SAP AI Core
---

# Using SAP AI Core With Cypher CLI

Cypher CLI supports accessing models through SAP AI Core, a service in the SAP Business Technology Platform that lets you efficiently run AI scenarios in a standardized, scalable, and hyperscaler-agnostic manner.
...
To use SAP AI Core with Cypher CLI, you'll need to create a service key for your SAP AI Core service instance:
...
Cypher CLI applies the following filters when fetching models:
...
3. Configure Cypher CLI with your credentials
