---
title: "Using Anthropic Claude with Cypher CLI"
description: "Configure Anthropic's Claude models in Cypher CLI. Guide to getting an API key, setting up Claude Sonnet and Opus in VS Code and the CLI."
sidebar_label: Anthropic
---

# Using Anthropic With Cypher CLI
...
3.  **Create a Key:** Click "Create Key". Give your key a descriptive name (e.g., "Cypher CLI").
