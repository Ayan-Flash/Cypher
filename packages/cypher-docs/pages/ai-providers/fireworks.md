---
title: "Using Fireworks AI with Cypher CLI | Fast Inference"
description: "Run open-source and proprietary models on Fireworks AI's high-performance platform in Cypher CLI. Setup guide for VS Code and the CLI."
---

# Using Fireworks AI With Cypher CLI
...
3. **Create a Key:** Click "Create API key" and give your key a descriptive name (e.g., "Cypher CLI").
