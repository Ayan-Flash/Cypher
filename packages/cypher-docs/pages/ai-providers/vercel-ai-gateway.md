---
title: "Using Vercel AI Gateway with Cypher CLI"
description: Configure the Vercel AI Gateway in Cypher CLI to robustly access 100+ language models from various providers through a centralized interface.
keywords:
  - cypher code
  - vercel ai gateway
  - ai provider
...
# Using Vercel AI Gateway With Cypher CLI
...
The Vercel AI Gateway supports a large and growing number of models. Cypher CLI automatically fetches the list of available models from the `https://ai-gateway.vercel.sh/v1/models` endpoint. Only language models are shown.
