---
title: "App Builder"
description: "Build complete applications with Cypher CLI"
---
...
Cypher's **App Builder** lets you create end-to-end applications through natural language conversation. Describe what you want to build, watch it come to life in a real-time preview, and deploy directly from your Cypher dashboard. No local environment setup required.
...
- **Active Cypher CLI account**  
  Sign up or log in at [app.cypher.ai](https://app.cypher.ai)

---

## Cost

- You pay only for the AI model usage via Cypher CLI credits
...
1. Navigate to **[App Builder](https://app.cypher.ai/app-builder)** from your Cypher dashboard.
