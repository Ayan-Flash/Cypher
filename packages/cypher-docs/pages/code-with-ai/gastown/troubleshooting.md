...
**Fix:**
1. Check that the [Cypher GitHub App](https://github.com/apps/cypher-cli) is installed on your repository
...
| Cause | Fix |
|---|---|
| GitHub App uninstalled | Reinstall at [github.com/apps/cypher-cli](https://github.com/apps/cypher-cli) |
...
3. **Contact support** — reach out at [cypher.ai/discord](https://cypher.ai/discord) with your town ID
