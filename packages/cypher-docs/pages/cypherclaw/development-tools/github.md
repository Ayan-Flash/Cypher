...
description: "Connect a GitHub account to your CypherClaw agent for repository access"
---

# GitHub Integration

Connect a GitHub account to your CypherClaw agent so it can clone repositories, push commits, open pull requests, and leave code reviews — all autonomously.
...
CypherClaw uses a [fine grained Personal Access Token](https://github.com/settings/tokens?type=beta) to authenticate as your bot. When creating the token, use these settings:

| Setting | Recommended Value |
|---|---|
| **Token name** | `cypherclaw-bot` (or any descriptive name) |
...
### Step 3: Enter credentials in CypherClaw
...
CypherClaw accepts both GitHub token formats:
...
When your instance starts, CypherClaw automatically:
...
- Tokens are encrypted at rest using CypherClaw's secret management system
