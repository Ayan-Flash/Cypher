...
description: "Connect your CypherClaw agent to 1Password to securely manage credentials"
---

# 1Password Integration Guide

Connect your CypherClaw agent to 1Password to securely manage credentials. This allows your agent to fetch API keys or passwords without ever seeing them in plain text.
...
2. Create a **New Vault** (e.g., name it `Cypher-Agent-Vault`).
...
## Step 3: Configure CypherClaw

1. Navigate to your CypherClaw dashboard: [app.cypher.ai/claw](https://app.cypher.ai/claw).
