...
description: "How CypherClaw instances are structured"
---

# Architecture Notes

For advanced users — how CypherClaw instances are structured:
...
- **Network isolation** — OpenClaw binds to loopback only; external traffic is proxied through a Cypher controller.
