Use Cypher CLI directly from your terminal for maximum flexibility.
...
1. Go to [Cypher Releases](https://github.com/Cypher-Org/cypher/releases)
2. Download the `-baseline` variant for your platform:
   - Linux x64: `cypher-linux-x64-baseline.tar.gz`
   - macOS x64: `cypher-darwin-x64-baseline.zip`
   - Windows x64: `cypher-windows-x64-baseline.zip`
3. Extract and run the `cypher` binary directly
