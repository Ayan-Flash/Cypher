...
import type {
  ...
  CypherAudioTranscriptionsErrors,
  CypherAudioTranscriptionsResponses,
  CypherAuthStatusErrors,
  CypherAuthStatusResponses,
  CypherClawChatCredentialsErrors,
  CypherClawChatCredentialsResponses,
  CypherClawStatusErrors,
  CypherClawStatusResponses,
  CypherCloudSessionGetErrors,
  CypherCloudSessionGetResponses,
  CypherCloudSessionImportErrors,
  CypherCloudSessionImportResponses,
  CypherCloudSessionsErrors,
  CypherCloudSessionsResponses,
  CyphercodeAgentRequirementsErrors,
  CyphercodeAgentRequirementsResponses,
  CyphercodeHeapSnapshotErrors,
  CyphercodeHeapSnapshotResponses,
  CyphercodeNotebookListErrors,
  CyphercodeNotebookListResponses,
  CyphercodeNotebookRejectErrors,
  CyphercodeNotebookRejectResponses,
  CyphercodeNotebookReplyErrors,
  CyphercodeNotebookReplyResponses,
  CyphercodeRemoveAgentErrors,
  CyphercodeRemoveAgentResponses,
  CyphercodeRemoveSkillErrors,
  CyphercodeRemoveSkillResponses,
  CyphercodeSessionImportMessageErrors,
  CyphercodeSessionImportMessageResponses,
  CyphercodeSessionImportPartErrors,
  CyphercodeSessionImportPartResponses,
  CyphercodeSessionImportProjectErrors,
  CyphercodeSessionImportProjectResponses,
  CyphercodeSessionImportSessionErrors,
  CyphercodeSessionImportSessionResponses,
  CyphercodeSessionModelUsageErrors,
  CyphercodeSessionModelUsageResponses,
  CypherEditErrors,
  CypherEditResponses,
  CypherFimErrors,
  CypherFimResponses,
  CypherModelsImagesErrors,
  CypherModelsImagesResponses,
  CypherModesErrors,
  CypherModesResponses,
  CypherNotificationsErrors,
  CypherNotificationsResponses,
  CypherOrganizationSetErrors,
  CypherOrganizationSetResponses,
  CypherProfileErrors,
  CypherProfileResponses,
  LspStatusErrors,
  LspStatusResponses,
  McpAddErrors,
  McpAddResponses,
...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new CypherClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Cypher system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Cypher system.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Cypher configuration settings and preferences.
   */
   ...
   *
   * Update global Cypher configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Cypher server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Cypher system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Cypher instances, releasing all resources.
   */
   ...
   * Upgrade cypher
   *
   * Upgrade cypher to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Cypher configuration settings and preferences.
   */
   ...
   *
   * Update Cypher configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get project rules
   *
   * List project instruction files used by Cypher and return their current contents.
   */
   ...
   * Update model state
   *
   * Patch TUI-compatible model selections shared with Cypher Console.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local Cypher state.
   */
...
export class Session extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Cypher sessions across projects, sorted by most recently updated. Archived sessions are excluded by default.
   */
...
export class Worktree extends HeyApiClient {
   ...
   * List worktrees
   *
   * List all git worktrees for the current project and whether Cypher manages them.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Cypher instance, releasing all resources.
   */
...
export class Path extends HeyApiClient {
   ...
   * Get paths
   *
   * Retrieve the current working directory and related path information for the Cypher instance.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Cypher system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Cypher.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that Cypher is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Cypher.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Cypher sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Cypher session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Cypher session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Indexing extends HeyApiClient {
  ...
  /**
   * List Cypher embedding models
   *
   * Retrieve the embedding models available through the active Cypher account.
   */
...
export class Audio extends HeyApiClient {
   ...
   *
   * Proxy an audio transcription request to the Cypher Gateway
   */
...
export class Models extends HeyApiClient {
   ...
   *
   * List image-capable models from the Cypher Gateway OpenRouter passthrough
   */
  public images<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<CypherModelsImagesResponses, CypherModelsImagesErrors, ThrowOnError>({
...
export class Organization extends HeyApiClient {
  /**
   * Update Cypher Gateway organization
   *
   * Switch to a different Cypher Gateway organization
   */
  public set<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).post<CypherOrganizationSetResponses, CypherOrganizationSetErrors, ThrowOnError>(
      {
...
export class Claw extends HeyApiClient {
  /**
   * Get CypherClaw instance status
   *
   * Fetch the user's CypherClaw instance status via the CypherClaw worker
   */
  public status<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).get<CypherClawStatusResponses, CypherClawStatusErrors, ThrowOnError>({
  ...
  /**
   * Get CypherClaw chat credentials
   *
   * Returns the bearer token and endpoint URLs the client uses to talk to the Cypher Chat worker and the Event Service. The bearer is the user's existing long-lived Cypher JWT — cypher-chat and event-service both verify it directly with NEXTAUTH_SECRET, so no separate token mint is needed.
   */
...
export class Session4 extends HeyApiClient {
   ...
   * Get cloud session
   *
   * Fetch full session data from the Cypher cloud for preview
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      id: string
    ...
    return (options?.client ?? this.client).get<CypherCloudSessionGetResponses, CypherCloudSessionGetErrors, ThrowOnError>({
...
export class Cypher extends HeyApiClient {
  /**
   * Get Cypher Gateway profile
   *
   * Fetch user profile and organizations from Cypher Gateway
   */
  public profile<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<CypherProfileResponses, CypherProfileErrors, ThrowOnError>({
      url: "/cypher/profile",
      ...options,
      ...params,
    })
  ...
  /**
   * Get Cypher authentication status
   *
   * Check whether a locally stored Cypher credential can authenticate Gateway requests
   */
  public authStatus<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<CypherAuthStatusResponses, CypherAuthStatusErrors, ThrowOnError>({
  ...
  public modes<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<CypherModesResponses, CypherModesErrors, ThrowOnError>({
      url: "/cypher/modes",
      ...options,
      ...params,
    })
   ...
   * FIM completion
   *
   * Proxy a Fill-in-the-Middle completion request to the Cypher Gateway
   */
  public fim<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).sse.post<CypherFimResponses, CypherFimErrors, ThrowOnError>({
      url: "/cypher/fim",
      ...options,
      ...params,
      headers: {
  ...
  public edit<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<CypherEditResponses, CypherEditErrors, ThrowOnError>({
      url: "/cypher/edit",
      ...options,
      ...params,
      headers: {
  ...
  /**
   * Get Cypher notifications
   *
   * Fetch notifications from Cypher Gateway for CLI display
   */
  public notifications<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<CypherNotificationsResponses, CypherNotificationsErrors, ThrowOnError>({
   ...
   * Get cloud sessions
   *
   * Fetch cloud CLI sessions from Cypher API
   */
  public cloudSessions<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<CypherCloudSessionsResponses, CypherCloudSessionsErrors, ThrowOnError>({
...
export class Cyphercode extends HeyApiClient {
  /**
  ...
  public removeSkill<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<CyphercodeRemoveSkillResponses, CyphercodeRemoveSkillErrors, ThrowOnError>(
      {
  ...
  public removeAgent<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<CyphercodeRemoveAgentResponses, CyphercodeRemoveAgentErrors, ThrowOnError>(
      {
...
export class Telemetry extends HeyApiClient {
   ...
   *
   * Forward a telemetry event to PostHog via cypher-telemetry.
   */
...
export class CypherClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<CypherClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    CypherClient.__registry.set(this, args?.key)
  }
  ...
  private _cypher?: Cypher
  get cypher(): Cypher {
    return (this._cypher ??= new Cypher({ client: this.client }))
  }

  private _cypherCode?: Cyphercode
  get cypherCode(): Cyphercode {
    return (this._cypherCode ??= new Cyphercode({ client: this.client }))
  }
