...
// visual style of the legacy Cypher CLI VS Code extension.
//
// Two themes are provided:
// - cypher:        For web/desktop (light + dark variants from legacy VS Code themes) [DEFAULT]
// - cypher-vscode: For the VS Code extension (adapts to user's VS Code theme)
//
...
export { CYPHER_THEMES, cypherTheme, cypherVscodeTheme } from "./theme/default-themes"
