...
const STYLE_ID = "storybook-cypher-theme"
...
export function applyCypherTheme(themeId: string, colorScheme: "light" | "dark") {
...
export function ThemeDecorator(props: ThemeDecoratorProps): JSX.Element {
  createEffect(() => {
    applyCypherTheme(props.theme, props.colorScheme)
  })
  return <props.Story />
}
