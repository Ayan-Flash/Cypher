...
// cypher_change start - review follow-up uses non-blocking question prompts
it.instance(
  ...
  () =>
    Effect.gen(function* () {
      ...
      if (Exit.isFailure(exit)) {
        ...
        // cypher_change start - preserve upstream unknown-request failure behavior during facade migration
