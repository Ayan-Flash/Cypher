...
import { preparePluginDependencies } from "../cypher/plugin-dependencies" // cypher_change
...
function writeProviderAuthPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* Effect.promise(() => preparePluginDependencies(dir)) // cypher_change

    yield* fs.writeWithDirs(
      path.join(dir, ".cypher", "plugin", "provider-oauth-parity.ts"), // cypher_change
      [
        "export default {",
...
function writeProviderAuthValidationPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".cypher", "plugin", "provider-oauth-validation.ts"), // cypher_change
      [
        "export default {",
...
function writeFunctionOptionsPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".cypher", "plugin", "provider-function-options.ts"), // cypher_change
      [
        "export default {",
...
function writeProviderModelsMutationPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".cypher", "plugin", "provider-models-mutation.ts"), // cypher_change
      [
        "export default {",
...
describe("provider HttpApi", () => {
  it.instance.skip(
    ...
    Effect.gen(function* () {
      ...
      const response = yield* Effect.promise(() =>
        Promise.resolve(
          app().request("/api/provider/missing", { headers: { "x-cypher-directory": instance.directory } }),
        ),
      )
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      ...
      const headers = { "x-cypher-directory": instance.directory, "content-type": "application/json" }
      const server = app()
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      ...
      const response = yield* requestAuthorize({
        ...
        method: 0,
        inputs: { token: "nope" },
        headers: { "x-cypher-directory": instance.directory, "content-type": "application/json" },
      })
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      ...
      const headers = { "x-cypher-directory": instance.directory }
