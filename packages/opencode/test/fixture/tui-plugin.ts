  ...
  return {
    ...
    attention: {
      ...
      soundboard: {
        ...
        current: () => opts.attention?.soundboard?.current?.() ?? "cypher.default", // cypher_change
    ...
    state: {
      ...
      session: {
        ...
        processes: opts.state?.session?.processes ?? (() => []), // cypher_change
