...
const describeWatcher =
  FileWatcher.hasNativeBinding() && (!process.env.CI || process.env.CYPHER_TEST_PROFILE === "darwin")
    ? describe
    : describe.skip
// cypher_change end
...
const watcherConfigLayer = ConfigProvider.layer(
  ConfigProvider.fromUnknown({
    CYPHER_EXPERIMENTAL_FILEWATCHER: "true",
    CYPHER_EXPERIMENTAL_DISABLE_FILEWATCHER: "false",
  }),
)
