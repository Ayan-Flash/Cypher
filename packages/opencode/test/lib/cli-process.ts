...
//   - CYPHER_CONFIG_CONTENT      : provider config inline, no files to find
//   - CYPHER_TEST_HOME           : pins os.homedir() → tmpdir
//   - CYPHER_DISABLE_PROJECT_CONFIG : skip walking up for opencode.json
//   - CYPHER_PURE                : skip external plugin discovery + install
//   - CYPHER_DISABLE_AUTOUPDATE / AUTOCOMPACT / MODELS_FETCH : no background work
