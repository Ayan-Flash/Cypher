...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CYPHER_CALLER", () => {
    process.env["CYPHER_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CYPHER_CALLER", () => {
    process.env["CYPHER_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CYPHER_CALLER", () => {
    process.env["CYPHER_CALLER"] = "unknown"
