...
import { hasAtomicChatPlugin } from "@/cypher/atomic-chat-feature"
import { CyphercodeDefaultPlugins } from "@/cypher/config/default-plugins"
import { PluginLoader } from "@/plugin/loader"

const atomic = "@cypher/plugin-atomic-chat"

describe("cypher default atomic chat plugin", () => {
  test("injects atomic chat without registering an external plugin origin", () => {
    ...
    CyphercodeDefaultPlugins.apply(cfg, { disabled: false })
  ...
  test("does not add atomic chat plugin when default plugins are disabled", () => {
    ...
    CyphercodeDefaultPlugins.apply(cfg, { disabled: true })
