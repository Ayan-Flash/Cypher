...
import { defaultEndpoint, resolveEndpoint } from "@/cypher/session-export/worker/endpoint"
...
describe("session export endpoint", () => {
  ...
  test("allows approved production endpoint", () => {
    const endpoint = "https://supermassive-black-hole.cypherapps.io/v1/session-export/batch"
