...
import { legacyReviewMessage, parseReviewCommand, reviewCommand } from "../../src/cypher/review/command"
...
describe("review command parsing", () => {
  test("parses every supported review invocation", () => {
    ...
    expect(parseReviewCommand("/review https://github.com/Cypher-Org/cypher/pull/11084")).toBe("review")
