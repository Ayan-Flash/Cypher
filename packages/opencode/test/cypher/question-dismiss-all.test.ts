...
import { CypherSessionPromptQueue } from "../../src/cypher/session/prompt-queue"
  ...
  it.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const first = yield* CypherSessionPromptQueue.enqueue(
          sessionID,
        ...
        const second = yield* CypherSessionPromptQueue.enqueue(
          sessionID,
