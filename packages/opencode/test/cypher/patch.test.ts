// Tests the cypher-specific patch module guarantees:
...
// These round-trip through the apply_patch tool so the Cypher encoding layer is
...
describe("Patch encoding preservation", () => {
  ...
  beforeEach(async () => {
    dir = await fs.mkdtemp(path.join(tmpdir(), "cypher-patch-"))
  })
