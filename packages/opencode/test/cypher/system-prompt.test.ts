...
import { environmentDetails } from "../../src/cypher/editor-context"
...
import PROMPT_GPT55 from "../../src/session/prompt/cypher-gpt-5.5.txt"
...
describe("environmentDetails", () => {
  test("includes cwd and worktree in dynamic context", () => {
    const result = environmentDetails({
      directory: "/repo/.cypher/worktrees/feature",
      worktree: "/repo/.cypher/worktrees/feature",
      activeFile: "src/app.ts",
    })

    expect(result).toContain("Working directory: /repo/.cypher/worktrees/feature")
    expect(result).toContain("Workspace root folder: /repo/.cypher/worktrees/feature")
