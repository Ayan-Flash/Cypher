...
import { formatTable, formatMarkdown, handle, isTextModel, outputLimit } from "../../../src/cypher/cli/cmd/roll-call"
...
describe("formatTable", () => {
  test("formats simple table correctly", () => {
    const rows = [
      ["cypher/test-model", "YES", "Hello!", "1000ms"],
      ["cypher/another-model", "NO", "(Error)", "500ms"],
    ]
