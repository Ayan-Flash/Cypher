...
import Attention from "@/cypher/plugins/attention"
import type { Event, Session, SessionNetworkWait, SuggestionRequest } from "@cypher/sdk/v2"
import type { TuiAttentionNotifyInput } from "@cypher/plugin/tui"
...
describe("Cypher attention TUI plugin", () => {
