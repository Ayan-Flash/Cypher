  ...
  describe("latest", () => {
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(npmCalls).toContain(`https://registry.npmjs.org/@cypher%2fcli/${InstallationChannel}`) // cypher_change
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(bunCalls).toContain(`https://registry.npmjs.org/@cypher%2fcli/${InstallationChannel}`) // cypher_change
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(pnpmCalls).toContain(`https://registry.npmjs.org/@cypher%2fcli/${InstallationChannel}`) // cypher_change
      }),
    )
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("Cypher-Org/tap/cypher")) return "" // cypher_change
          if (cmd === "brew" && args.includes("--formula") && args.includes("cypher")) return "cypher" // cypher_change
          return ""
        },
      ),
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("Cypher-Org/tap/cypher") && args.includes("--formula")) return "cypher" // cypher_change
