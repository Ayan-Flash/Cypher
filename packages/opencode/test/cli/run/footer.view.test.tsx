...
import type { QuestionRequest } from "@cypher/sdk/v2"
import {
    ...
    () => (
      <box width={100} height={8}>
        <RunFooterView
          ...
          onLayout={() => {}}
          onStatus={() => {}}
          onTerminalWrite={async () => {}} // cypher_change
          onTerminalResize={async () => {}} // cypher_change
          onTerminalClose={async () => {}} // cypher_change
        />
      </box>
    ),
    {
