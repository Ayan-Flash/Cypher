...
const disabled = process.env["CYPHER_DISABLE_SHARE"] === "true" || process.env["CYPHER_DISABLE_SHARE"] === "1"
...
// cypher_change start - preserve the share transport contract when stored legacy summary diffs omit file details
