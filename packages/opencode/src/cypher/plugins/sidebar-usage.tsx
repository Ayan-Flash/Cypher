...
import { fmtAttemptCost, fmtScore } from "@/cypher/components/model-info-panel-utils"
import {
  failed,
  formatCost,
  formatCount,
  ...
  select,
  type UsageResult,
} from "@/cypher/plugins/model-usage"

const id = "internal:cypher-sidebar-usage"
...
function View(props: { api: TuiPluginApi; session_id: string }) {
  ...
  const [result, { refetch }] = createResource(
    ...
    (sessionID): Promise<UsageResult> =>
      props.api.client.cypherCode.sessionModelUsage({ sessionID }).then(
