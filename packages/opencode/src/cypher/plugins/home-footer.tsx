...
/**
 * Cypher-specific home footer plugin.
 *
...
import { RemoteIndicator } from "@/cypher/remote-tui"

const id = "internal:cypher-home-footer"

// ---------------------------------------------------------------------------
// Sub-components (mirror upstream home/footer with cypher additions)
// ---------------------------------------------------------------------------
...
function View(props: { api: TuiPluginApi }) {
  const cypher = createMemo(() => props.api.state.provider.some((p) => p.id === "cypher"))
