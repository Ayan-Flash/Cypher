...
import { ReadyStatus, Status } from "@/cypher/anaconda-desktop/domain"
...
const root = "/cypher/anaconda-desktop"
      ...
      .add(
        ...
        HttpApiEndpoint.post("sync", AnacondaDesktopPaths.sync, {
          ...
          OpenApi.annotations({
            ...
            description:
              "Discover the active local inference server and replace Cypher provider authentication metadata.",
          }),
        ),
      )
      .annotateMerge(
