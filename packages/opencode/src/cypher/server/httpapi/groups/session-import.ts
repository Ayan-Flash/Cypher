...
const root = "/cypher/session-import"

const ResultSchema = Schema.Struct({
  ok: Schema.Boolean,
  id: Schema.String,
  skipped: Schema.optional(Schema.Boolean),
}).annotate({ identifier: "CyphercodeSessionImportResult" })
    ...
    HttpApiGroup.make("session-import")
      .add(
        HttpApiEndpoint.post("project", SessionImportPaths.project, {
          ...
          OpenApi.annotations({
            identifier: "cypher.sessionImport.project",
        ...
        HttpApiEndpoint.post("session", SessionImportPaths.session, {
          ...
          OpenApi.annotations({
            identifier: "cypher.sessionImport.session",
        ...
        HttpApiEndpoint.post("message", SessionImportPaths.message, {
          ...
          OpenApi.annotations({
            identifier: "cypher.sessionImport.message",
        ...
        HttpApiEndpoint.post("part", SessionImportPaths.part, {
          ...
          OpenApi.annotations({
            identifier: "cypher.sessionImport.part",
      ...
      .annotateMerge(
        OpenApi.annotations({
          ...
          description: "Cypher legacy session import routes.",
        }),
      )
