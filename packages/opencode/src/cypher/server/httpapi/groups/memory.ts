...
import { MemoryContract } from "@cypher/cypher-memory/effect/httpapi"
...
import { MemoryApiClientError, MemoryApiServerError } from "@cypher/cypher-memory/effect/errors"
  ...
  .add(
    HttpApiGroup.make("memory")
      ...
      .annotateMerge(
        OpenApi.annotations({
          title: "memory",
          description: "Cypher memory routes.",
        }),
      )
