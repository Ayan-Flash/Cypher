...
export const CypherPassState = Schema.Struct({
...
export const ProfileWithBalance = Schema.Struct({
  ...
  cypherPass: Schema.NullOr(CypherPassState),
...
export const CypherGatewayPaths = {
  modes: `${root}/modes`,
...
export const CypherGatewayApi = HttpApi.make("cypher")
  .add(
    HttpApiGroup.make("cypher")
      .add(
        HttpApiEndpoint.get("profile", CypherGatewayPaths.profile, {
          query: WorkspaceRoutingQuery,
          success: described(ProfileWithBalance, "Profile data"),
          error: [HttpApiError.BadRequest, HttpApiError.Unauthorized],
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "cypher.profile",
            summary: "Get Cypher Gateway profile",
            description: "Fetch user profile and organizations from Cypher Gateway",
          }),
        ),
        HttpApiEndpoint.get("authStatus", CypherGatewayPaths.authStatus, {
          query: WorkspaceRoutingQuery,
          success: described(AuthStatus, "Cypher authentication status"),
          error: HttpApiError.BadRequest,
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "cypher.authStatus",
            summary: "Get Cypher authentication status",
            description: "Check whether a locally stored Cypher credential can authenticate Gateway requests",
          }),
        ),
        HttpApiEndpoint.get("modes", CypherGatewayPaths.modes, {
          query: WorkspaceRoutingQuery,
          success: described(OrganizationModes, "Organization modes list"),
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "cypher.modes",
            summary: "Get organization custom modes",
            description: "Fetch custom modes defined for the current organization",
          }),
        ),
        HttpApiEndpoint.post("fim", CypherGatewayPaths.fim, {
          query: WorkspaceRoutingQuery,
          payload: FimBody,
        ...
        HttpApiEndpoint.post("audioTranscriptions", CypherGatewayPaths.audioTranscriptions, {
          query: WorkspaceRoutingQuery,
        ...
        HttpApiEndpoint.post("organization", CypherGatewayPaths.organization, {
          query: WorkspaceRoutingQuery,
        ...
        HttpApiEndpoint.get("cloudSessions", CypherGatewayPaths.cloudSessions, {
          query: {
            ...WorkspaceRoutingQueryFields,
          ...
          OpenApi.annotations({
            identifier: "cypher.cloudSessions",
            summary: "Get cloud sessions",
            description: "Fetch cloud CLI sessions from Cypher API",
          }),
        ),
        HttpApiEndpoint.get("cloudSession", CypherGatewayPaths.cloudSession, {
          ...
          OpenApi.annotations({
            identifier: "cypher.cloud.session.get",
            summary: "Get cloud session",
            description: "Fetch full session data from the Cypher cloud for preview",
          }),
        ),
        HttpApiEndpoint.post("cloudSessionImport", CypherGatewayPaths.cloudSessionImport, {
          query: WorkspaceRoutingQuery,
          ...
          OpenApi.annotations({
            identifier: "cypher.cloud.session.import",
      ...
      .annotateMerge(
        OpenApi.annotations({
          title: "cypher",
          description: "Cypher Gateway routes.",
        }),
      )
