...
/**
 * CypherClaw TUI types — Cypher Chat protocol.
 *
 * Mirrors `@cypher/cypher-chat` from the cloud monorepo. We carry our own
...
export type ClawStatus = {
  ...
  secretCount?: number
  userId?: string
  // User-chosen name for the CypherClaw bot, set during onboarding via the
  ...
  // literal string "CypherClaw" when null.
  botName?: string | null
}
