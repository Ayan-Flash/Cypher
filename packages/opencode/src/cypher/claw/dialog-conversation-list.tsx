/**
 * Conversation selector for the CypherClaw chat.
 *
...
export function DialogConversationList(props: Props) {
  ...
  return (
    <DialogSelect
      title="CypherClaw Conversations"
      options={options()}
      ...
      actions={[
        ...
        {
          command: "cypherclaw.conversation.new",
          title: "new",
          side: "right",
          onTrigger: async () => {
      ...
      bindings={[{ key: "ctrl+n", cmd: "cypherclaw.conversation.new" }]}
    />
  )
}
