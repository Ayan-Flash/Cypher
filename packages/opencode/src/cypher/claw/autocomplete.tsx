/**
 * CypherClaw chat slash-command autocomplete.
 *
 ...
 * with cypherclaw's own `/new` for conversations.
 *
...
export function ClawAutocomplete(props: {
  ...
  useBindings(() => ({
    ...
    bindings: [
      { key: "up", desc: "Previous command", group: "CypherClaw", cmd: () => move(-1) },
      { key: "ctrl+p", desc: "Previous command", group: "CypherClaw", cmd: () => move(-1) },
      { key: "down", desc: "Next command", group: "CypherClaw", cmd: () => move(1) },
      { key: "ctrl+n", desc: "Next command", group: "CypherClaw", cmd: () => move(1) },
      { key: "escape", desc: "Hide autocomplete", group: "CypherClaw", cmd: hide },
      { key: "return", desc: "Select command", group: "CypherClaw", cmd: select },
      { key: "tab", desc: "Select command", group: "CypherClaw", cmd: select },
      {
        key: "right",
        fallthrough: true,
        cmd: () => {
