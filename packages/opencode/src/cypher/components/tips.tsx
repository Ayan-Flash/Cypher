...
const TIPS = [
  ...
  "Cypher can {highlight}configure itself{/highlight} if you ask it",
  "Ask Cypher to {highlight}add Supabase MCP globally{/highlight}",
  "Ask Cypher to {highlight}create a review agent for this project{/highlight}",
  "Ask Cypher to {highlight}add a plugin for desktop alerts{/highlight}",
  "Ask Cypher to {highlight}set Claude Sonnet as my default model{/highlight}",
  "Ask Cypher to {highlight}make my review agent read-only{/highlight}",
  "Ask Cypher to {highlight}require approval before git push{/highlight}",
  "Ask Cypher to {highlight}turn off auto-formatting{/highlight}",
  "Ask Cypher to {highlight}block access to .env files{/highlight}",
  "Ask Cypher to {highlight}turn off the F2 shortcut{/highlight}",
  "Ask Cypher to {highlight}match my terminal theme{/highlight}",
  "Ask Cypher to {highlight}disable sharing for all sessions{/highlight}",
  "Ask Cypher to {highlight}add rules from docs/ai-rules.md{/highlight}",
  "Ask Cypher to {highlight}enable tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
  "Ask Cypher to {highlight}save this workflow as a /command{/highlight}",
  "Cypher auto-handles OAuth for remote MCP servers requiring auth",
  "Cypher auto-formats files using prettier, gofmt, ruff, and more",
  "Cypher uses LSP servers for intelligent code analysis",
  "Use {highlight}cypher run{/highlight} for non-interactive scripting",
  "Use {highlight}cypher --continue{/highlight} to resume the last session",
  "Use {highlight}cypher run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}cypher serve{/highlight} for headless API access to Cypher",
  "Use {highlight}cypher run --attach{/highlight} to connect to a running server",
  "Run {highlight}cypher upgrade{/highlight} to update to the latest version",
  "Run {highlight}cypher auth list{/highlight} to see all configured providers",
