/**
 * Custom OAuth handler for Cypher Gateway
 *
...
import { DialogCypherOrganization } from "./dialog-cypher-organization.js"
...
interface CypherAutoMethodProps {
  index: number
  providerID: string
  title: string
...
export function CypherAutoMethod(props: CypherAutoMethodProps) {
  ...
  onMount(async () => {
    try {
      ...
      const profileResponse = await sdk.client.cypher.profile()
      ...
      console.warn("Failed to fetch Cypher profile, using personal account:", error)
      setStatus("error")
