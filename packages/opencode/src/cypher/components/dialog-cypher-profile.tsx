...
import type { CyphercodeProfile, CyphercodeBalance } from "@cypher/cypher-gateway"

interface DialogCypherProfileProps {
  profile: CyphercodeProfile
  balance: CyphercodeBalance | null
  currentOrgId?: string | null
}

export function DialogCypherProfile(props: DialogCypherProfileProps) {
  ...
  const usageUrl = props.currentOrgId
    ? `https://app.cypher.ai/organizations/${props.currentOrgId}/usage-details`
