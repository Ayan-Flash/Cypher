/**
 * Cypher Gateway Organization Selection Dialog
 *
...
import { getOrganizationOptions, getDefaultOrganizationSelection } from "@cypher/cypher-gateway/tui"
...
interface DialogCypherOrganizationProps {
...
export function DialogCypherOrganization(props: DialogCypherOrganizationProps) {
    ...
    <DialogSelect
      ...
      onSelect={async (option: any) => {
        try {
          ...
          await sdk.client.cypher.organization.set({
