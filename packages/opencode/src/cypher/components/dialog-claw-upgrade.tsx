...
/**
 * CypherClaw Upgrade Dialog
 *
 * Shown when the user has an active CypherClaw instance but no chat credentials,
  ...
  return (
    <box paddingLeft={2} paddingRight={2} gap={1}>
      <box flexDirection="row" justifyContent="space-between">
        <text fg={theme.text}>
          <span style={{ bold: true }}>CypherClaw Chat requires an upgrade</span>
        </text>
      ...
      <box paddingBottom={1} gap={1}>
        ...
        <text fg={theme.textMuted} wrapMode="word">
          Use the <span style={{ fg: theme.warning, bold: true }}>↻ Upgrade to Latest</span> button on the CypherClaw
