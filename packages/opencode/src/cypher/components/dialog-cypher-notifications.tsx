/**
 * Cypher Notifications Dialog
 *
 * Displays all notifications from Cypher API in a scrollable dialog.
...
interface DialogCypherNotificationsProps {
  notifications: CyphercodeNotification[]
}

export function DialogCypherNotifications(props: DialogCypherNotificationsProps) {
