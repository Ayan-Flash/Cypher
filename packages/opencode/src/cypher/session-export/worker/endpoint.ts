export const defaultEndpoint = "https://supermassive-black-hole.cypherapps.io/v1/session-export/batch"

const hosts = new Set(["supermassive-black-hole.cypherapps.io"])
