...
import { isIndexingPlugin } from "@cypher/cypher-indexing/detect"
import { ensureAtomicChatPlugin, isAtomicChatPlugin } from "@/cypher/atomic-chat-feature"
import { ensureIndexingPlugin, resolveIndexingPlugin } from "@/cypher/indexing-feature"
...
export namespace CyphercodeDefaultPlugins {
