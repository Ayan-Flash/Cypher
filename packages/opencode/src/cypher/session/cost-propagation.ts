...
export namespace CypherCostPropagation {
  /**
   ...
   */
  export const childCost = Effect.fn("CypherCostPropagation.childCost")(function* (
   ...
   */
  export const propagate = Effect.fn("CypherCostPropagation.propagate")(function* (
    sessions: Session.Interface,
    sid: SessionID,
    mid: MessageID,
    amount: number,
