...
import { CypherSessionOverflow } from "./overflow"

const SAFETY = 2048
const MIN_OUTPUT = 1024

export namespace CypherLLM {
  ...
  export function capOutputTokens(input: {
    ...
    usage?: ReturnType<typeof CypherSessionOverflow.measure>
    reported?: number
  }): number | undefined {
    ...
    const estimated =
      ...
      CypherSessionOverflow.measure({ messages: input.messages, tools: input.tools }).normalized
