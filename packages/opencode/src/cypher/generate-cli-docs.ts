...
const TABLE_PATH = root + "packages/cypher-docs/markdoc/partials/cli-commands-table.md"
const REFERENCE_PATH = root + "packages/cypher-docs/pages/code-with-ai/platforms/cli-reference.md"
...
// them here as well to keep cypher.ai/docs in sync with the shipped binary.
