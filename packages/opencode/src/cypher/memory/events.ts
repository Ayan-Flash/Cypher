...
import { capture as captureInstance } from "@/cypher/instance"
import * as Log from "@opencode-ai/core/util/log"
import { MemoryEvents as Core } from "@cypher/cypher-memory/effect/events"
 ...
 * event sink to opencode's Bus. The package stays free of the host event system until `install()`. */
