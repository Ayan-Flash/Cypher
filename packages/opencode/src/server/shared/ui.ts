...
import { ConsoleAssets } from "@/cypher/console/assets" // cypher_change
...
export function serveUIEffect(
  ...
  return Effect.gen(function* () {
    ...
    // cypher_change start - serve Cypher Console under /console
    ...
    // cypher_change - no proxy fallback to app.opencode.ai; embedded UI only
    return notFound()
  })
}
