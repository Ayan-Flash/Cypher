...
function ref(request: HttpServerRequest.HttpServerRequest): Location.Ref {
  ...
  return {
    directory: AbsolutePath.make(
      query.get("location[directory]") || request.headers["x-cypher-directory"] || process.cwd(),
    ),
    workspaceID: query.get("location[workspace]") || request.headers["x-cypher-workspace"],
  }
}
