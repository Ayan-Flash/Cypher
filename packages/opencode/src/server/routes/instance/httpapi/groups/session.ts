...
export const SessionPaths = {
  ...
  viewed: `${root}/viewed`, // cypher_change
} as const
      ...
      .add(
        HttpApiEndpoint.get("list", SessionPaths.list, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all Cypher sessions, sorted by most recently updated.", // cypher_change
          }),
        ),
        ...
        HttpApiEndpoint.get("get", SessionPaths.get, {
          ...
          OpenApi.annotations({
            ...
            summary: "Get session",
            description: "Retrieve detailed information about a specific Cypher session.", // cypher_change
          }),
        ),
        ...
        HttpApiEndpoint.post("create", SessionPaths.create, {
          ...
          OpenApi.annotations({
            ...
            description: "Create a new Cypher session for interacting with AI assistants and managing conversations.", // cypher_change
          }),
        ),
        ...
        HttpApiEndpoint.post("fork", SessionPaths.fork, {
          params: { sessionID: SessionID },
          query: WorkspaceRoutingQuery,
          payload: [HttpApiSchema.NoContent, ForkPayload], // cypher_change - carry upstream bodyless full-session fork support
          success: described(Session.Info, "200"),
          error: [HttpApiError.BadRequest, ApiNotFoundError], // cypher_change - carry upstream malformed payload response
        }).annotateMerge(
          OpenApi.annotations({
