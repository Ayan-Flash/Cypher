...
import { Snapshot } from "@/snapshot" // cypher_change
import { MCP } from "@/mcp"
...
export const ExperimentalPaths = {
  ...
  worktreeDiff: "/experimental/worktree/diff", // cypher_change
  worktreeDiffFile: "/experimental/worktree/diff/file", // cypher_change
  worktreeDiffSummary: "/experimental/worktree/diff/summary", // cypher_change
      ...
      .add(
        ...
        HttpApiEndpoint.post("consoleSwitch", ExperimentalPaths.consoleSwitch, {
          ...
          OpenApi.annotations({
            ...
            description: "Persist a new active Console account/org selection for the current local Cypher state.", // cypher_change
          }),
        ),
        ...
        HttpApiEndpoint.get("worktree", ExperimentalPaths.worktree, {
          query: WorkspaceRoutingQuery,
          success: described(WorktreeList, "List of worktrees"), // cypher_change
          error: WorktreeApiError,
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "worktree.list",
            summary: "List worktrees",
            description: "List all git worktrees for the current project and whether Cypher manages them.", // cypher_change
          }),
        ),
        ...
        HttpApiEndpoint.get("session", ExperimentalPaths.session, {
          ...
          OpenApi.annotations({
            ...
            description:
              "Get a list of all Cypher sessions across projects, sorted by most recently updated. Archived sessions are excluded by default.", // cypher_change
          }),
        ),
