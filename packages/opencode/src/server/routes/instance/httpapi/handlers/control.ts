...
import { invalidateAfterProviderAuthChange } from "@/cypher/server/provider-auth-lifecycle" // cypher_change
...
export const controlHandlers = HttpApiBuilder.group(RootHttpApi, "control", (handlers) =>
  Effect.gen(function* () {
    ...
    const authSet = Effect.fn("ControlHttpApi.authSet")(function* (ctx: {
      ...
      yield* invalidateAfterProviderAuthChange(ctx.params.providerID) // cypher_change
      return true
    })
