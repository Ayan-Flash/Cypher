...
import type { Model } from "@cypher/sdk/v2"
...
// cypher_change start - Cypher branding for the DigitalOcean OAuth callback page
const HTML_CALLBACK = `<!doctype html>
<html>
  <head>
    <meta charset="utf-8" />
    <title>Cypher - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to Cypher."
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Cypher will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.", // cypher_change
