import type { TuiDialogSelectOption, TuiPluginApi, TuiRouteDefinition, TuiSlotProps } from "@cypher/plugin/tui"
...
function routeCurrent(route: ReturnType<typeof useRoute>): TuiPluginApi["route"]["current"] {
  ...
  // cypher_change start
  if (route.data.type === "cypherclaw") return { name: "cypherclaw" }
  // cypher_change end
