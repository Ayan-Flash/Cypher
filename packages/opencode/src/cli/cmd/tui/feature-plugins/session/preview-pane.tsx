import { createResource, Show, createMemo, createSignal, onCleanup, onMount, type Accessor, type JSX } from "solid-js" // cypher_change
import { TextAttributes, type RGBA } from "@opentui/core"
import { useTerminalDimensions } from "@opentui/solid"
import type { Message, Part, Session as SdkSession, SnapshotFileDiff } from "@cypher/sdk/v2"
...
export function createLeadingTrailingSignal<T>(initial: T, ms: number): [Accessor<T>, (v: T) => void, (v: T) => void] {
  ...
  // cypher_change start - Cypher preview equivalent of anomalyco/opencode#31748
