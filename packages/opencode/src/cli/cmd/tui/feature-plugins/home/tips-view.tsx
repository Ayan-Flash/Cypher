import type { TuiPluginApi } from "@cypher/plugin/tui"
import { createMemo, For, type Accessor } from "solid-js"
import { DEFAULT_THEMES, useTheme } from "@tui/context/theme"
import { CYPHER_TIPS } from "@/cypher/cli/cmd/tui/feature-plugins/home/tips" // cypher_change
...
export function Tips(props: { api: TuiPluginApi; connected?: boolean }) {
  ...
  const tip = createMemo(() => {
    ...
    // cypher_change start
    const tips = CYPHER_TIPS.flatMap((item) => {
...
const TIPS: Tip[] = [
  /* cypher_change hide the entire list for if it is accidentally used
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.cypher/commands/{/highlight} to define reusable custom prompts", // cypher_change
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.cypher/agents/{/highlight} for specialized AI personas", // cypher_change
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.cypher/tools/{/highlight} to define new LLM tools", // cypher_change
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.cypher/plugins/{/highlight} for event hooks", // cypher_change
  ...
  "Create JSON theme files in {highlight}.cypher/themes/{/highlight} directory", // cypher_change
