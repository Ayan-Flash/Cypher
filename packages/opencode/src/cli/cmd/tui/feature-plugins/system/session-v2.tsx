import type { TuiPlugin, TuiPluginApi } from "@cypher/plugin/tui"
...
function Question(props: ToolProps) {
  ...
  // cypher_change start - show dismissed question content; use questions()
  ...
  return (
    <Switch>
      {/* cypher_change start - gate on dismissed or answers so dismissed/answered render, pending falls through to Asking... */}
