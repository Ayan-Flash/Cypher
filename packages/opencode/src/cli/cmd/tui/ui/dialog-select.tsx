...
export interface DialogSelectProps<T> {
  ...
  actions?: DialogSelectAction<T>[] // cypher_change - supports actions without a selected option
  footerHints?: {
    title: string
    label: string
    side?: "left" | "right"
...
// cypher_change start - support list-level actions when no option is selected
    ...
    return {
      commands: [
        ...
        ...enabledActions.map((item) => ({
          ...
          run() {
            setStore("input", "keyboard")
            // cypher_change start - allow actions such as scope toggles on empty lists
