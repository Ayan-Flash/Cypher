...
import type { Path, Workspace } from "@cypher/sdk/v2"
  ...
  init: () => {
    ...
    const [store, setStore] = createStore({
      project: {
        ...
        worktree: undefined as string | undefined, // cypher_change
      },
      instance: {
        path: defaultPath,
      },
    ...
    async function sync() {
      ...
      batch(() => {
        ...
        setStore("project", "worktree", project.data?.worktree) // cypher_change
      })
    }
