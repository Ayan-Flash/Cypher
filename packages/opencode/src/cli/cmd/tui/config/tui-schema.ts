...
import { TuiAttentionSoundNames, type TuiAttentionSoundName } from "@cypher/plugin/tui"
import { CypherTitleIcon } from "@/cypher/cli/cmd/tui/title-icon" // cypher_change
...
export const TuiInfo = Schema.Struct({
  ...
  title_icon: Schema.optional(CypherTitleIcon.Value), // cypher_change
  ...
  // cypher_change start - vim modal editing toggle
