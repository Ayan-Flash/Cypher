...
export const Definitions = {
  ...
  "prompt.vim.toggle": keybind("none", "Toggle vim modal editing in the prompt input"), // cypher_change
  ...
  news_toggle: keybind("none", "Toggle news on home screen"), // cypher_change
...
export const CommandMap = {
  ...
  news_toggle: "news.toggle", // cypher_change
