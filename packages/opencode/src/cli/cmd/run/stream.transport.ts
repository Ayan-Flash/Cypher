...
import type { GlobalEvent, CypherClient } from "@cypher/sdk/v2"
...
function sid(event: Event): string | undefined {
  ...
  if (event.type === "interactive_terminal.updated") return event.properties.info.sessionID // cypher_change
  ...
  if (
    ...
    event.type === "interactive_terminal.data" || // cypher_change
    event.type === "interactive_terminal.deleted" || // cypher_change
