// Per-tool display rules shared across `cypher run` output paths. // cypher_change
//
...
import type { ToolPart } from "@cypher/sdk/v2"
...
import type { InteractiveTerminalTool } from "@/cypher/tool/interactive-terminal" // cypher_change
...
type ToolDefs = {
  ...
  interactive_terminal: typeof InteractiveTerminalTool // cypher_change
