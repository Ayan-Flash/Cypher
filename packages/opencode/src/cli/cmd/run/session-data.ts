...
import type { Part, PermissionRequest, QuestionRequest, ToolPart } from "@cypher/sdk/v2"
...
export type SessionData = {
  ...
  terminal?: RunInteractiveTerminalSnapshot // cypher_change
...
function pickSessionView(data: SessionData): FooterView {
  return pickBlockerView({
    terminal: data.terminal, // cypher_change
...
export function reduceSessionData(input: SessionDataInput): SessionDataOutput {
  ...
  // cypher_change start - direct interactive mode terminal footer
