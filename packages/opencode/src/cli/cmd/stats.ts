...
// cypher_change start - expose Effect stats aggregation for Cypher regression coverage
      ...
      Effect.gen(function* () {
        ...
        for (const message of messages) {
          if (message.info.role === "assistant") {
            // cypher_change start - count propagated subagent cost once but keep child model stats (#6321)
            ...
            sessionModelUsage[modelKey].cost += cost // cypher_change
