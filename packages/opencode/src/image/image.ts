...
export const MAX_BASE64_BYTES = 5 * 1024 * 1024 // cypher_change - share user file pre-read limit
...
// cypher_change start - preserve valid in-limit images when Photon is unavailable
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __CYPHER_PHOTON_WASM_PATH?: string }).__CYPHER_PHOTON_WASM_PATH = wasm
      }).pipe(
