...
export function alreadyInstalled() {
  return process.env["CYPHER_CALLER"] === "vscode" || process.env["CYPHER_CALLER"] === "vscode-insiders"
}

// cypher_change start - Cypher's VS Code extension bundles the CLI; auto-install from CLI is not applicable
