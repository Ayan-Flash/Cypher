...
const cache = process.env.CYPHER_BWRAP_CACHE ?? path.join(os.tmpdir(), "cypher-bubblewrap", commit)
...
#define PACKAGE_STRING "bubblewrap ${version} for Cypher"
...
Cypher distributes Bubblewrap as a separate executable. The complete license text is
