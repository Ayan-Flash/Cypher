 ...
 *
 * All JSON parsing is delegated to [CypherCliDataParser].
 */
class CypherBackendChatManager(
    ...
    private var normalizer = CypherCliDataParser.ChatEventNormalizer()
    ...
    fun stop() {
        ...
        client = null
        base = null
        normalizer = CypherCliDataParser.ChatEventNormalizer()
    ...
    suspend fun enhancePrompt(dir: String, text: String): String {
        ...
        val url = requireBase()
        val body = CypherCliDataParser.buildEnhancePromptJson(text)
        ...
        return call.await().use { response ->
            ...
            CypherCliDataParser.parseEnhancedPrompt(raw)
        }
    }
    ...
    fun prompt(id: String, dir: String, prompt: PromptDto) {
        ...
        val body = CypherCliDataParser.buildPromptJson(prompt)
    ...
    fun command(id: String, dir: String, command: String, args: String, prompt: PromptDto) {
        ...
        val body = CypherCliDataParser.buildCommandJson(command, args, prompt)
    ...
    fun compact(id: String, dir: String, model: ModelSelectionDto) {
        ...
        val http = requireClient()
        val url = requireBase()
        val body = CypherCliDataParser.buildSummarizeJson(model)
        val request = Request.Builder()
    ...
    suspend fun revert(id: String, dir: String, message: String, part: String?) {
        ...
        val body = CypherCliDataParser.buildRevertJson(message, part)
    ...
    fun messages(id: String, dir: String): List<MessageWithPartsDto> {
        ...
        return http.newCall(request).execute().use { response ->
            ...
            val parsed = CypherCliDataParser.parseMessages(raw)
    ...
    fun updateConfig(dir: String, update: ConfigUpdateDto) {
        ...
        val partial = CypherCliDataParser.buildConfigPartial(update)
    ...
    fun replyPermission(requestId: String, dir: String, reply: PermissionReplyDto) {
        ...
        val body = CypherCliDataParser.buildPermissionReplyJson(reply)
    ...
    fun savePermissionRules(requestId: String, dir: String, rules: PermissionAlwaysRulesDto) {
        ...
        val body = CypherCliDataParser.buildPermissionAlwaysRulesJson(rules)
    ...
    fun replyQuestion(requestId: String, dir: String, answers: QuestionReplyDto) {
        ...
        val body = CypherCliDataParser.buildQuestionReplyJson(answers)
    ...
    fun pendingPermissions(dir: String): List<PermissionRequestDto> {
        ...
        val parsed = CypherCliDataParser.parsePermissionRequests(raw)
    ...
    fun pendingQuestions(dir: String): List<QuestionRequestDto> {
        ...
        val parsed = CypherCliDataParser.parseQuestionRequests(raw)
