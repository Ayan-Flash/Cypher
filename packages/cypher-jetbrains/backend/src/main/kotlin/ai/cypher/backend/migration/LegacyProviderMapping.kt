...
/**
 * Port of packages/cypher-vscode/src/legacy-migration/provider-mapping.ts
 *
...
val PROVIDER_MAP: Map<String, ProviderMapping> = mapOf(
    ...
    "cypher" to ProviderMapping(id = "cypher", key = "cypherToken", name = "Cypher (Gateway)", modelField = "cypherModel", organizationIdField = "cypherOrganizationId"),
