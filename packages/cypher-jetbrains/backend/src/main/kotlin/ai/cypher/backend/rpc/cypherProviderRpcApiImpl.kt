...
import ai.cypher.backend.provider.CypherBackendProviderSettingsManager
...
internal class CypherProviderRpcApiImpl : CypherProviderRpcApi {
    companion object {
        private val LOG = CypherLog.create(CypherProviderRpcApiImpl::class.java)
    }

    private val manager: CypherBackendProviderSettingsManager
        get() = CypherBackendProviderSettingsManager(service<CypherBackendAppService>())
