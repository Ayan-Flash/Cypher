...
import ai.cypher.jetbrains.api.infrastructure.Serializer
import ai.cypher.jetbrains.api.model.Config
import ai.cypher.jetbrains.api.model.GlobalHealth200Response
import ai.cypher.jetbrains.api.model.CypherNotifications200ResponseInner
import ai.cypher.jetbrains.api.model.CypherNotifications200ResponseInnerAction
import ai.cypher.jetbrains.api.model.CypherProfile200Response
import ai.cypher.jetbrains.api.model.CypherProfile200ResponseBalance
import ai.cypher.jetbrains.api.model.CypherProfile200ResponseProfile
import ai.cypher.jetbrains.api.model.CypherProfile200ResponseProfileOrganizationsInner
...
class ApiModelSerializationTest {
    ...
    @Test
    fun `CypherNotifications200ResponseInner with action`() {
        val src = """{
            "id": "notif-1",
        ...
        val obj = json.decodeFromString<CypherNotifications200ResponseInner>(src)
    ...
    @Test
    fun `CypherNotifications200ResponseInner without action`() {
    ...
    @Test
    fun `CypherNotifications200ResponseInner with showIn and suggestModelId`() {
        val src = """{
            "id": "n3",
            "title": "Try new model",
    ...
    fun `empty notifications array`() {
        val list = json.decodeFromString<List<CypherNotifications200ResponseInner>>("[]")
        assertTrue(list.isEmpty())
    }

    @Test
    fun `CypherProfile200Response with balance`() {
        val src = """{
        ...
        val obj = json.decodeFromString<CypherProfile200Response>(src)
    ...
    @Test
    fun `CypherProfile200Response with null balance`() {
        val src = """{
    ...
    @Test
    fun `CypherProfile200Response with organizations`() {
        val src = """{
            "profile": {
                "email": "user@test.com",
                "organizations": [
    ...
    @Test
    fun `CypherProfile200Response with cypher pass`() {
        val src = """{
            "profile": {"email": "user@test.com"},
        ...
        val obj = json.decodeFromString<CypherProfile200Response>(src)
        assertNotNull(obj.cypherPass)
        assertEquals(199.0, obj.cypherPass!!.currentPeriodBaseCreditsUsd)
        assertEquals(73.27, obj.cypherPass!!.currentPeriodUsageUsd)
        assertEquals(99.5, obj.cypherPass!!.currentPeriodBonusCreditsUsd)
        assertEquals("2026-07-01T00:00:00.000Z", obj.cypherPass!!.nextBillingAt)
    }
