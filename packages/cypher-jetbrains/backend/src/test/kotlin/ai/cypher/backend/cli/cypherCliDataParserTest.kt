...
import ai.cypher.rpc.dto.AgentConfigPatchDto
...
import ai.cypher.rpc.dto.PermissionRuleDto
import ai.cypher.rpc.dto.ModelSelectionDto
import ai.cypher.rpc.dto.ModelStateDto
import ai.cypher.rpc.dto.PartSourceDto
import ai.cypher.rpc.dto.PartSourceTextDto
import ai.cypher.rpc.dto.PromptDto
import ai.cypher.rpc.dto.PromptPartDto
import ai.cypher.rpc.dto.QuestionReplyDto
import ai.cypher.rpc.dto.SkillsPatchDto
...
/**
 * Pure unit tests for [CypherCliDataParser].
 *
...
class CypherCliDataParserTest {
    ...
    inner class SseEvents {
        ...
        fun `extractEventType - parses type from JSON data`() {
            val result = CypherCliDataParser.extractEventType(
        ...
        fun `extractEventType - returns unknown for missing type`() {
            assertEquals("unknown", CypherCliDataParser.extractEventType("""{"data":"something"}"""))
        }

        @Test
        fun `extractEventType - returns unknown for empty string`() {
            assertEquals("unknown", CypherCliDataParser.extractEventType(""))
        }
        ...
        fun `parseChatEvent - message updated with GlobalEvent wrapper`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("message.updated", data)
        ...
        fun `parseChatEvent - message part delta`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("message.part.delta", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - message part updated`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("message.part.updated", data)
            assertNotNull(result)
        ...
        fun `ChatEventNormalizer - user part updated sanitizes text`() {
            val norm = CypherCliDataParser.ChatEventNormalizer()
        ...
        fun `parseChatEvent - todowrite part parses typed todo metadata`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("message.part.updated", data) as ChatEventDto.PartUpdated
        ...
        fun `parseChatEvent - turn open`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("session.turn.open", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - turn close`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("session.turn.close", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session error`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("session.error", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session error preserves nested named error details`() {
            val data = globalEvent("""
                ...
                "properties": {
                    ...
                    "error": {
                        "name": "UnknownError",
                        "data": {
                            "message": "Cannot find module '@cypher/plugin' from '/workspace/.opencode/tool/github-triage.ts'",
                            "ref": "err_123"
                        }
                    }
                }
            ...
            assertEquals("Cannot find module '@cypher/plugin' from '/workspace/.opencode/tool/github-triage.ts'", result.error?.message)
        ...
        fun `parseChatEvent - message removed`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("message.removed", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - message part removed`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("message.part.removed", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session idle`() {
            val data = globalEvent("""
                ...
                "properties": { "sessionID": "ses_1" }
            """)
            val result = CypherCliDataParser.parseChatEvent("session.idle", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session compacted`() {
            val data = globalEvent("""
                ...
                "properties": { "sessionID": "ses_1" }
            """)
            val result = CypherCliDataParser.parseChatEvent("session.compacted", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session updated`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("session.updated", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session created`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("session.created", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session diff`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("session.diff", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session diff clamps large counts`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("session.diff", data) as ChatEventDto.SessionDiffChanged
        ...
        fun `parseChatEvent - todo updated`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("todo.updated", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session status idle`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("session.status", data) as ChatEventDto.SessionStatusChanged
        ...
        fun `parseChatEvent - permission asked`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("permission.asked", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - permission replied`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("permission.replied", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - question asked`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("question.asked", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - question replied`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("question.replied", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - question rejected`() {
            ...
            val result = CypherCliDataParser.parseChatEvent("question.rejected", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - unknown type returns null`() {
            val data = globalEvent("""
                ...
                "properties": { "sessionID": "ses_1" }
            """)
            assertNull(CypherCliDataParser.parseChatEvent("some.unknown.event", data))
        }

        @Test
        fun `parseChatEvent - malformed JSON returns null`() {
            assertNull(CypherCliDataParser.parseChatEvent("message.updated", "not json"))
        }

        @Test
        fun `parseChatEvent - missing properties returns null`() {
            assertNull(CypherCliDataParser.parseChatEvent("message.updated", """{"payload":{"type":"x"}}"""))
        }
        ...
        fun `parseChatEvent - missing sessionID returns null`() {
            ...
            """)
            assertNull(CypherCliDataParser.parseChatEvent("message.updated", data))
        }
        ...
        fun `parseSessionStatus - valid status event`() {
            ...
            val result = CypherCliDataParser.parseSessionStatus(data)
            assertNotNull(result)
        ...
        fun `parseSessionStatus - missing sessionID returns null`() {
            ...
            assertNull(CypherCliDataParser.parseSessionStatus(data))
        }
        ...
        fun `parsePermissionRequests - parses list`() {
            ...
            val result = CypherCliDataParser.parsePermissionRequests(raw)
        ...
        fun `parsePermissionRequests - empty list`() {
            assertEquals(emptyList(), CypherCliDataParser.parsePermissionRequests("[]"))
        }
        ...
        fun `parseQuestionRequests - parses list`() {
            ...
            val result = CypherCliDataParser.parseQuestionRequests(raw)
            assertEquals(1, result.size)
    ...
    inner class HttpResponses {
        ...
        fun `parseConfig - local mcp server`() {
            val cfg = CypherCliDataParser.parseConfig(
        ...
        fun `parseConfig - disabled mcp form remains present`() {
            val cfg = CypherCliDataParser.parseConfig("""{"mcp":{"sample":{"enabled":false}}}""")
            val mcp = cfg.mcp["sample"]
        ...
        fun `parseConfig - scalars instructions and skills`() {
            val cfg = CypherCliDataParser.parseConfig(
                """{
                    ...
                    "skills":{"paths":[".cypher/skills"],"urls":["https://example.test/skill.md"]}
                }"""
            )
            ...
            assertEquals(listOf(".cypher/skills"), cfg.skills?.paths)
        ...
        fun `parseConfig - malformed body returns empty config`() {
            assertEquals(ConfigDto(), CypherCliDataParser.parseConfig("not json"))
            assertEquals(ConfigDto(), CypherCliDataParser.parseConfig("[]"))
        }
            ...
            val cfg = CypherCliDataParser.parseConfig(
                """{
                    ...
                    "mcp":{
                        "sample":{
                            "type":"local",
                            "command":["node",".cypher/mcp/sample-server.js"],
                            "environment":{"TOKEN":"x"},
                            "enabled":true,
                            "timeout":12000
                        }
        ...
        fun `parseSession - full session response`() {
            ...
            val result = CypherCliDataParser.parseSession(raw)
        ...
        fun `parseMessages - empty array`() {
            assertEquals(emptyList(), CypherCliDataParser.parseMessages("[]"))
        }
        ...
        fun `parseMessages - user and assistant messages`() {
            ...
            val result = CypherCliDataParser.parseMessages(raw)
        ...
        fun `parseMessages - preserves synthetic and source metadata`() {
            ...
            val result = CypherCliDataParser.parseMessages(raw).single()
        ...
        fun `parseMessages - step finish part with tokens`() {
            ...
            val part = CypherCliDataParser.parseMessages(raw)[0].parts[0]
        ...
        fun `parseMessages - malformed JSON returns empty`() {
            assertEquals(emptyList(), CypherCliDataParser.parseMessages("not json"))
        }
        ...
        fun `parseCloudSessions maps cloud session list`() {
            ...
            val result = CypherCliDataParser.parseCloudSessions(raw)
        ...
        fun `parseCloudSessions tolerates malformed response`() {
            assertEquals(emptyList(), CypherCliDataParser.parseCloudSessions("not json").sessions)
            assertNull(CypherCliDataParser.parseCloudSessions("{}").nextCursor)
        }
        ...
        fun `parseProviders - maps provider id, name, source, connected, and defaults`() {
            ...
            val result = CypherCliDataParser.parseProviders(raw)
        ...
        fun `parseProviders - maps model capabilities, limit, and recommendedIndex`() {
            ...
            val provider = CypherCliDataParser.parseProviders(raw).providers[0]
        ...
        fun `parseProviders - maps model preview metadata`() {
            val raw = """{
                "all": [{
                    "id": "cypher", "name": "Cypher", "source": "api", "env": [], "options": {},
                    "models": {
                        "auto": {
                            "id": "auto",
                            "name": "Cypher Auto",
            ...
            val model = CypherCliDataParser.parseProviders(raw).providers.single().models.getValue("auto")
        ...
        fun `parseProviders - malformed optional preview metadata is ignored`() {
            ...
            val model = CypherCliDataParser.parseProviders(raw).providers.single().models.getValue("m")
        ...
        fun `parseProviders - orders variants by effort rank then name`() {
            ...
            val model = CypherCliDataParser.parseProviders(raw).providers[0].models["m"]
            assertNotNull(model)
        ...
        fun `parseProviders - missing collections default to empty`() {
            val result = CypherCliDataParser.parseProviders("""{"all":[],"default":{},"connected":[]}""")
        ...
        fun `parseProviderSettingsProviders - preserves provider metadata and unknown fields`() {
            ...
            val result = CypherCliDataParser.parseProviderSettingsProviders(raw)
        ...
        fun `parseProviderSettingsProviders - malformed metadata becomes null`() {
            ...
            val provider = CypherCliDataParser.parseProviderSettingsProviders(raw).first.single()
        ...
        fun `parseProviders - throws for malformed JSON`() {
            assertFailsWith<Exception> {
                CypherCliDataParser.parseProviders("not json")
            }
        }
        ...
        fun `parseProviders - throws for non-object JSON`() {
            assertFailsWith<Exception> {
                CypherCliDataParser.parseProviders("""[1,2,3]""")
            }
        }
        ...
        fun `parseProviderAuth - maps structured select options`() {
            ...
            val prompt = CypherCliDataParser.parseProviderAuth(raw).getValue("azure").single().prompts.single()
        ...
        fun `parseCommands - maps name, description, source, and hints`() {
            ...
            val result = CypherCliDataParser.parseCommands(raw)
        ...
        fun `parseCommands - empty array`() {
            assertEquals(emptyList<CommandInfo>(), CypherCliDataParser.parseCommands("[]"))
        }
        ...
        fun `parsePathState - extracts state from valid path response`() {
            val raw = """{"home":"/home/user","state":"/home/user/.local/state/cypher","config":"/home/user/.config/cypher","worktree":"/project","directory":"/project"}"""
            assertEquals("/home/user/.local/state/cypher", CypherCliDataParser.parsePathState(raw))
        }

        @Test
        fun `parsePathState - returns null for missing state field`() {
            assertNull(CypherCliDataParser.parsePathState("""{"home":"/home/user"}"""))
        }

        @Test
        fun `parsePathState - returns null for malformed JSON`() {
            assertNull(CypherCliDataParser.parsePathState("not json"))
        }

        @Test
        fun `parsePathState - returns null for non-string state value`() {
            assertNull(CypherCliDataParser.parsePathState("""{"state":42}"""))
            assertNull(CypherCliDataParser.parsePathState("""{"state":null}"""))
            assertNull(CypherCliDataParser.parsePathState("""{"state":{}}"""))
        }
    }
    ...
    inner class RequestBuilders {
        ...
        fun `buildPromptJson - text only`() {
            ...
            val result = CypherCliDataParser.buildPromptJson(prompt)
        ...
        fun `buildProviderOAuthJson - numeric method index`() {
            val result = CypherCliDataParser.buildProviderOAuthJson("0", mapOf("deploymentType" to "github.com"))
        ...
        fun `buildCommandJson - file part includes source metadata`() {
            ...
            val result = CypherCliDataParser.buildCommandJson("review", "", prompt)
        ...
        fun `buildCommandJson - includes agent variant model and arguments`() {
            ...
            val result = CypherCliDataParser.buildCommandJson("review", "src/", prompt)

            assertEquals(
                """{"command":"review","arguments":"src/","agent":"code","variant":"high","model":"cypher/gpt-5"}""",
                result,
            )
        }
        ...
        fun `buildSummarizeJson - writes provider and model`() {
            val result = CypherCliDataParser.buildSummarizeJson(ModelSelectionDto("anthropic", "claude-4"))
        ...
        fun `buildRevertJson - writes message only`() {
            val result = CypherCliDataParser.buildRevertJson("m1", null)
            assertEquals("""{"messageID":"m1"}""", result)
        }

        @Test
        fun `buildRevertJson - writes message and part`() {
            val result = CypherCliDataParser.buildRevertJson("m1", "p1")
            assertEquals("""{"messageID":"m1","partID":"p1"}""", result)
        }

        @Test
        fun `buildRevertJson - escapes ids`() {
            val result = CypherCliDataParser.buildRevertJson("m\"\\1", "p\"\\1")
        ...
        fun `buildConfigPartial - model only`() {
            val result = CypherCliDataParser.buildConfigPartial(ConfigUpdateDto(model = "anthropic/claude-4"))
            assertEquals("""{"model":"anthropic/claude-4"}""", result)
        }

        @Test
        fun `buildConfigPartial - agent and temperature`() {
            val result = CypherCliDataParser.buildConfigPartial(
        ...
        fun `buildConfigPartial - empty update`() {
            val result = CypherCliDataParser.buildConfigPartial(ConfigUpdateDto())
            assertEquals("{}", result)
        }
        ...
        fun `buildConfigPatch - top-level model set`() {
            ...
            assertEquals("{\"model\":\"anthropic/claude\"}", CypherCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPatch - top-level model clear emits null`() {
            val patch = ConfigPatchDto(values = linkedMapOf("model" to null))
            assertEquals("{\"model\":null}", CypherCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPatch - small and subagent values`() {
            val patch = ConfigPatchDto(values = linkedMapOf("small_model" to "cypher/auto-small", "subagent_model" to null, "subagent_variant" to null))
            assertEquals("{\"small_model\":\"cypher/auto-small\",\"subagent_model\":null,\"subagent_variant\":null}", CypherCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPatch - per-agent model set`() {
            val patch = ConfigPatchDto(agents = linkedMapOf("code" to AgentConfigPatchDto(model = "cypher/gpt-5")))
            assertEquals("{\"agent\":{\"code\":{\"model\":\"cypher/gpt-5\"}}}", CypherCliDataParser.buildConfigPatch(patch))
        }
        ...
        fun `buildConfigPatch - per-agent model clear emits null`() {
            ...
            assertEquals("{\"agent\":{\"code\":{\"model\":null}}}", CypherCliDataParser.buildConfigPatch(patch))
        }
        ...
        fun `buildConfigPatch - per-agent description patch does not clear model`() {
            ...
            assertEquals("{\"agent\":{\"code\":{\"description\":\"New description\"}}}", CypherCliDataParser.buildConfigPatch(patch))
        }
        ...
        fun `buildConfigPatch - agent behavior top-level fields`() {
            val patch = ConfigPatchDto(
                ...
                skills = SkillsPatchDto(paths = listOf(".cypher/skills"), urls = listOf("https://example.com/skill")),
            )

            assertEquals(
                "{\"default_agent\":\"build\",\"instructions\":[\"AGENTS.md\"],\"skills\":{\"paths\":[\".cypher/skills\"],\"urls\":[\"https://example.com/skill\"]}}",
                CypherCliDataParser.buildConfigPatch(patch),
            )
        }
        ...
        fun `buildConfigPatch - full agent permission object`() {
            ...
            assertEquals(
                "{\"agent\":{\"custom\":{\"model\":\"cypher/gpt-5\",\"mode\":\"primary\",\"hidden\":false,\"temperature\":0.2,\"top_p\":0.9,\"steps\":12,\"permission\":{\"bash\":{\"*\":\"ask\",\"npm test\":\"allow\"},\"read\":null}}}}",
                CypherCliDataParser.buildConfigPatch(patch),
            )
        }
        ...
        fun `buildConfigPatch - empty patch`() {
            assertEquals("{}", CypherCliDataParser.buildConfigPatch(ConfigPatchDto()))
        }

        @Test
        fun `buildConfigPatch - escapes special characters`() {
            val patch = ConfigPatchDto(values = linkedMapOf("model" to "cypher/a\\b\"c"))
            assertEquals("{\"model\":\"cypher/a\\\\b\\\"c\"}", CypherCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPartial - temperature without agent defaults to ask`() {
            val result = CypherCliDataParser.buildConfigPartial(ConfigUpdateDto(temperature = 0.5))
        ...
        fun `buildPermissionReplyJson - once reply`() {
            val result = CypherCliDataParser.buildPermissionReplyJson(PermissionReplyDto(reply = "once"))
            assertEquals("""{"reply":"once"}""", result)
        }

        @Test
        fun `buildPermissionReplyJson - always reply with message`() {
            val result = CypherCliDataParser.buildPermissionReplyJson(PermissionReplyDto(reply = "always", message = "approved"))
        ...
        fun `buildPermissionAlwaysRulesJson - approved list`() {
            val result = CypherCliDataParser.buildPermissionAlwaysRulesJson(
        ...
        fun `buildQuestionReplyJson - single question single answer`() {
            val result = CypherCliDataParser.buildQuestionReplyJson(QuestionReplyDto(answers = listOf(listOf("A"))))
            assertEquals("""{"answers":[["A"]]}""", result)
        }

        @Test
        fun `buildQuestionReplyJson - multiple questions`() {
            val result = CypherCliDataParser.buildQuestionReplyJson(
        ...
        fun `parseModelState - parses favorites`() {
            val result = CypherCliDataParser.parseModelState(
                """{"favorite":[{"providerID":"cypher","modelID":"auto"},{"providerID":"openai","modelID":"gpt"}]}""",
            )
            assertEquals(listOf("cypher/auto", "openai/gpt"), result.favorite.map { "${it.providerID}/${it.modelID}" })
        }
        ...
        fun `parseModelState - parses model selections and variants`() {
            val result = CypherCliDataParser.parseModelState(
                """{"model":{"code":{"providerID":"cypher","modelID":"auto"}},"variant":{"cypher/auto":"medium"}}""",
            )
            assertEquals("cypher", result.model["code"]?.providerID)
            assertEquals("auto", result.model["code"]?.modelID)
            assertEquals("medium", result.variant["cypher/auto"])
        }

        @Test
        fun `parseModelState - drops malformed favorites`() {
            val result = CypherCliDataParser.parseModelState(
                """{"favorite":[{"providerID":"cypher"},false,{"providerID":"openai","modelID":"gpt"}]}""",
            )
        ...
        fun `parseModelState - malformed inputs return empty favorites`() {
            for (raw in listOf("", "not-json", "[]", "42", "null")) {
                assertTrue(CypherCliDataParser.parseModelState(raw).favorite.isEmpty(), raw)
            }
        }
        ...
        fun `parseModelState - drops malformed model selections and variants`() {
            val result = CypherCliDataParser.parseModelState(
                """{"model":{"bad":false,"ok":{"providerID":"cypher","modelID":"auto"}},"variant":{"":"low","cypher/auto":false,"openai/gpt":"high"}}""",
            )
        ...
        fun `buildModelStateJson - preserves unrelated keys and replaces favorites`() {
            val raw = """{"model":{"code":{"providerID":"cypher","modelID":"auto"}},"recent":[{"providerID":"old","modelID":"recent"}],"variant":{"cypher/auto":"fast"},"extra":true,"favorite":[]}"""
            val result = CypherCliDataParser.buildModelStateJson(raw, listOf(ModelSelectionDto("anthropic", "claude")))
            ...
            assertEquals(listOf("anthropic/claude"), CypherCliDataParser.parseModelState(result).favorite.map { "${it.providerID}/${it.modelID}" })
        }

        @Test
        fun `buildModelStateJson - writes model selections and variants`() {
            val raw = """{"recent":[],"extra":true}"""
            val result = CypherCliDataParser.buildModelStateJson(
                raw,
                ModelStateDto(
                    model = mapOf("code" to ModelSelectionDto("cypher", "auto")),
                    variant = mapOf("cypher/auto" to "medium"),
                    recent = listOf(ModelSelectionDto("anthropic", "claude")),
                ),
            )

            val state = CypherCliDataParser.parseModelState(result)
            assertEquals("auto", state.model["code"]?.modelID)
            assertEquals("medium", state.variant["cypher/auto"])
    ...
    fun `sanitizeUserPromptText - removes read payload lines`() {
        ...
        assertEquals("before\nafter", CypherCliDataParser.sanitizeUserPromptText(text))
    }
    ...
    fun `sanitizeUserPromptText - preserves ordinary prose without path key`() {
        ...
        assertEquals(text, CypherCliDataParser.sanitizeUserPromptText(text))
    }
    ...
    fun `sanitizeUserPromptText - collapses only blanks introduced by payload removal`() {
        ...
        assertEquals("before\n\nafter\n\n\nkeep", CypherCliDataParser.sanitizeUserPromptText(text))
    }
