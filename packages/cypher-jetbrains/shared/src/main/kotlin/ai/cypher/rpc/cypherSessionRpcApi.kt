 ...
 */
@Rpc
interface CypherSessionRpcApi : RemoteApi<Unit> {
    companion object {
        suspend fun getInstance(): CypherSessionRpcApi {
            return RemoteApiProviderService.resolve(remoteApiDescriptor<CypherSessionRpcApi>())
        }
    }
