...
@Serializable
data class ProfileCypherPassDto(
...
data class ProfileDto(
    ...
    val cypherPass: ProfileCypherPassDto? = null,
...
@Serializable
data class CypherAppStateDto(
    val status: CypherAppStatusDto,
