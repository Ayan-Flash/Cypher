...
object ChatLogSummary {
    ...
    private fun mode(): Mode = when ((System.getProperty("cypher.dev.log.chat.content") ?: "off").lowercase()) {
        "preview" -> Mode.PREVIEW
        "full" -> Mode.FULL
        else -> Mode.OFF
    }

    private fun max(): Int = (System.getProperty("cypher.dev.log.chat.preview.max")?.toIntOrNull() ?: 160)
        .coerceIn(1, 2000)
