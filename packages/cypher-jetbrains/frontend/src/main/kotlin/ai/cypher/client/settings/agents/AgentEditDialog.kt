...
import ai.cypher.client.settings.base.SettingsStackedRow
import ai.cypher.client.settings.base.SettingsToggle
import ai.cypher.client.settings.base.SettingsRows
import ai.cypher.client.settings.models.ModelSettingPicker
import ai.cypher.client.ui.FilledBadgeIcon
import ai.cypher.client.ui.HoverIcon
...
internal class AgentEditDialog(
    ...
    private val model = ModelSettingPicker().apply {
        picker.emptyText = CypherBundle.message("settings.agentBehavior.agents.edit.default")
    ...
    private val mode = ComboBox(arrayOf(CypherCliParser.MODE_PRIMARY, CypherCliParser.MODE_SUBAGENT, CypherCliParser.MODE_ALL)).apply {
    ...
    init {
        title = CypherBundle.message("settings.agentBehavior.agents.edit.title", agent.displayName ?: agent.name)
        init()
        initValidation()
    }
    ...
    override fun createCenterPanel(): JComponent {
        ...
        SettingsRows().apply {
            row(SettingsStackedRow(
                CypherBundle.message("settings.agentBehavior.agents.edit.name"),
                value = identity(),
                action = exportButton().takeIf { !agent.native },
            ))
            row(SettingsRow(
                CypherBundle.message("settings.agentBehavior.agents.edit.mode"),
                CypherBundle.message("settings.agentBehavior.agents.edit.mode.description"),
                mode,
            ))
            panel.next(this)
        }
        SettingsRows().apply {
            row(SettingsStackedRow(
                CypherBundle.message("settings.agentBehavior.agents.edit.description"),
                if (canEditDescription(agent)) {
                    CypherBundle.message("settings.agentBehavior.agents.edit.description.description")
                } else {
                    CypherBundle.message("settings.agentBehavior.agents.edit.description.native.description")
                },
                scroll(description),
            ))
            row(SettingsStackedRow(
                if (agent.native) {
                    CypherBundle.message("settings.agentBehavior.agents.edit.prompt.native")
                } else {
                    CypherBundle.message("settings.agentBehavior.agents.edit.prompt")
                },
                if (agent.native) {
                    CypherBundle.message("settings.agentBehavior.agents.edit.prompt.native.description")
                } else {
                    CypherBundle.message("settings.agentBehavior.agents.edit.prompt.description")
                },
                scroll(prompt),
            ))
            panel.next(this)
        }
        panel.section(CypherBundle.message("settings.agentBehavior.agents.edit.model")).apply {
            row(SettingsRow(
                CypherBundle.message("settings.agentBehavior.agents.edit.model.override"),
                CypherBundle.message("settings.agentBehavior.agents.edit.model.override.description"),
                model,
            ))
            row(SettingsRow(
                CypherBundle.message("settings.agentBehavior.agents.edit.variant"),
                CypherBundle.message("settings.agentBehavior.agents.edit.variant.description"),
                variant,
            ))
            row(SettingsRow(
                CypherBundle.message("settings.agentBehavior.agents.edit.temperature"),
                CypherBundle.message("settings.agentBehavior.agents.edit.temperature.description"),
                temperature,
            ))
            row(SettingsRow(
                CypherBundle.message("settings.agentBehavior.agents.edit.topP"),
                CypherBundle.message("settings.agentBehavior.agents.edit.topP.description"),
                top,
            ))
            row(SettingsRow(
                CypherBundle.message("settings.agentBehavior.agents.edit.steps"),
                CypherBundle.message("settings.agentBehavior.agents.edit.steps.description"),
                steps,
            ))
        }
        if (canEditVisibility(agent)) panel.section(CypherBundle.message("settings.agentBehavior.agents.edit.visibility")).apply {
            row(SettingsRow(
                CypherBundle.message("settings.agentBehavior.agents.edit.hidden"),
                CypherBundle.message("settings.agentBehavior.agents.edit.hidden.description"),
                SettingsToggle(hidden) { hidden = it },
            ))
            row(SettingsRow(
                CypherBundle.message("settings.agentBehavior.agents.edit.disabled"),
                CypherBundle.message("settings.agentBehavior.agents.edit.disabled.description"),
    ...
    override fun getDimensionServiceKey(): String = "Cypher.AgentEditDialog"
    ...
    private fun validateMode(): ValidationInfo? {
        ...
        if (value == CypherCliParser.MODE_PRIMARY || value == CypherCliParser.MODE_SUBAGENT || value == CypherCliParser.MODE_ALL) return null
        return ValidationInfo(CypherBundle.message("settings.agentBehavior.agents.edit.mode.invalid"), mode)
    }
    ...
    private fun validateNumber(field: NumericField, key: String, min: Double? = null, max: Double? = null): ValidationInfo? {
        ...
        if (parsed == null || !parsed.isFinite()) return ValidationInfo(CypherBundle.message(key), field)
        if (min != null && parsed < min) return ValidationInfo(CypherBundle.message(key), field)
        if (max != null && parsed > max) return ValidationInfo(CypherBundle.message(key), field)
        return null
    }
    ...
    private fun validateSteps(): ValidationInfo? {
        ...
        return ValidationInfo(CypherBundle.message("settings.agentBehavior.agents.edit.steps.invalid"), steps)
    }

    private class NumericField(value: String, decimal: Boolean) : JBTextField(value) {
        init {
            columns = NUMERIC_COLUMNS
            emptyText.text = CypherBundle.message("settings.agentBehavior.agents.edit.default")
    ...
    private fun identity(): JComponent {
        val badges = listOfNotNull(
            badge(
                CypherBundle.message("settings.agentBehavior.badge.subagent"),
                UiStyle.Badge.Primary,
            ).takeIf { CypherCliParser.isSubagent(agent.mode) },
            badge(
                CypherBundle.message("settings.agentBehavior.badge.custom"),
                UiStyle.Badge.Primary,
            ).takeIf { canDelete(agent) },
            badge(CypherBundle.message("settings.agentBehavior.badge.hidden")).takeIf { agent.hidden },
            badge(CypherBundle.message("settings.agentBehavior.badge.disabled")).takeIf { agent.disable },
            badge(
                CypherBundle.message("settings.agentBehavior.badge.deprecated"),
                UiStyle.Badge.Alert,
    ...
    private fun exportButton() = HoverIcon().apply {
        ...
        val text = CypherBundle.message("settings.agentBehavior.agents.edit.export")
        toolTipText = text
    ...
    private fun export() {
        ...
        val descriptor = FileSaverDescriptor(
            CypherBundle.message("settings.agentBehavior.agents.edit.export.title"),
            CypherBundle.message("settings.agentBehavior.agents.edit.export.description"),
            "agent.json",
        )
        ...
        ApplicationManager.getApplication().executeOnPooledThread {
            runCatching {
                ...
                notify(NotificationType.INFORMATION, CypherBundle.message("settings.agentBehavior.agents.edit.export.success", wrapper.file.name))
            }.onFailure { err ->
                notify(NotificationType.ERROR, CypherBundle.message("settings.agentBehavior.agents.edit.export.failed"), err.message)
            }
        }
    }
    ...
    private fun notify(type: NotificationType, title: String, content: String? = null) {
        ApplicationManager.getApplication().invokeLater {
            val notification = NotificationGroupManager.getInstance()
                .getNotificationGroup("Cypher CLI")
                ?.createNotification(title, content.orEmpty(), type)
                ?: Notification("Cypher CLI", title, content.orEmpty(), type)
    ...
    private class PromptField(value: String) : EditorTextField(
        ...
        init {
            ...
            setPlaceholder(CypherBundle.message("settings.agentBehavior.agents.edit.prompt.placeholder"))
