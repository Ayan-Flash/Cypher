 ...
 *
 * Both [ai.cypher.client.session.views.question.QuestionView] and
 * [ai.cypher.client.session.views.LoginRequiredView] use this as their
...
class BaseQuestionView(
     ...
     * [ai.cypher.client.session.views.question.QuestionView]). Calling with
