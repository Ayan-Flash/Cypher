...
class SessionMessageListPanel(
    ...
    private val openAttachment: (String, FileAttachment) -> Unit = { _, item -> ai.cypher.client.session.views.AttachmentView.openDefault(item, openFile, openUrl) },
    ...
    private fun onTurnAdded(turn: ai.cypher.client.session.model.Turn) {
    ...
    private fun onTurnUpdated(turn: ai.cypher.client.session.model.Turn) {
