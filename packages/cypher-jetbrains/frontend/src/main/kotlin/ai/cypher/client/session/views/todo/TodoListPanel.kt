package ai.cypher.client.session.views.todo
...
class TodoListPanel(
    ...
    private fun hidden(count: Int, earlier: Boolean): String {
        ...
        return CypherBundle.message(key, count)
    }
    ...
    private class Row(todo: TodoDto, style: SessionEditorStyle) {
        ...
        fun update(todo: TodoDto, style: SessionEditorStyle) {
            ...
            syncIcon(done)
            check.accessibleContext.accessibleName = CypherBundle.message(accessible(done), todo.content)
