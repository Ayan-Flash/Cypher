...
import ai.cypher.client.session.ui.popup.HeaderPopupBody
import ai.cypher.client.session.ui.popup.HeaderPopupRequest
...
import ai.cypher.client.ui.md.MdCodeBlockBorder
import ai.cypher.client.ui.md.MdCodeBlockFactory
import ai.cypher.client.ui.md.MdCodeBlockOptions
import ai.cypher.client.ui.md.MdViewFactory
import ai.cypher.client.ui.md.hybrid.MdTerminal
...
private data class ShellContent(
    ...
    val markdown: String = buildString {
        section(CypherBundle.message("session.part.tool.shell.command"), command, "shell-command")
        section(CypherBundle.message("session.part.tool.shell.output"), rawOutput, outputLang(rawOutput))
        section(CypherBundle.message("session.part.tool.shell.error"), rawError, "ansi-stderr")
    }
}
