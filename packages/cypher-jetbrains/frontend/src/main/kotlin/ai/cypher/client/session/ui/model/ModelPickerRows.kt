...
internal fun modelPickerRows(
    ...
    emptyText: String = CypherBundle.message("settings.models.notSet"),
    ...
    if (q.isBlank()) {
        ...
        if (fav.isNotEmpty()) {
            val section = CypherBundle.message("model.picker.favorites")
            out += fav.map { ModelPickerRow(it, section, favorite = true) }
        }
    }
    if (recommended.isNotEmpty()) {
        val section = CypherBundle.message("model.picker.recommended")
