...
object UiStyle {
    ...
    object Badge {
        ...
        object Primary : Style {
            override fun bg(): Color = JBColor.namedColor(
                "Cypher.History.activityBadgeBackground",
                JBUI.CurrentTheme.Link.Foreground.ENABLED,
            )

            override fun fg(): Color = JBColor.namedColor(
                "Cypher.History.activityBadgeForeground",
                Color.WHITE,
            )
        }
        ...
        object Highlight : Style {
            override fun bg(): Color = JBColor.namedColor(
                "Cypher.ModelPicker.freeBadgeBackground",
                JBColor(0x95D6AC, 0x7FCA99),
            )

            override fun fg(): Color = JBColor.namedColor(
                "Cypher.ModelPicker.freeBadgeForeground",
                JBColor.WHITE,
            )
        }
        ...
        object Alert : Style {
            override fun bg(): Color = JBColor.namedColor(
                "Cypher.History.runningBadgeBackground",
                JBColor(0xF5C542, 0x7A5A00),
            )

            override fun fg(): Color = JBColor.namedColor(
                "Cypher.History.runningBadgeForeground",
    ...
    object Colors {
        ...
        fun floatingPanel(): Color = JBColor.namedColor(
            "Cypher.FloatingPanel.background",
