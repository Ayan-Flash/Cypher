package ai.cypher.client.ui.md.hybrid
...
import ai.cypher.client.ui.md.MdCommon
import ai.cypher.client.ui.md.MdStyle
...
internal open class MdViewHybrid(
    ...
    companion object {
        private val LOG = CypherLog.create(MdViewHybrid::class.java)
    }
