...
import ai.cypher.client.session.history.HistoryActivitySnapshot
import ai.cypher.client.session.history.HistoryTime
import ai.cypher.client.session.history.LocalHistoryItem
import ai.cypher.client.session.history.itemAt
...
internal class RecentsList(
    ...
    private val title = JBLabel(CypherBundle.message("session.empty.recent")).apply {
