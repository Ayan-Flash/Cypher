...
object HistoryDataKeys {
    val SELECTION: DataKey<HistorySelection> = DataKey.create("ai.cypher.client.session.history.HistorySelection")
    val CONTROLLER: DataKey<HistoryController> = DataKey.create("ai.cypher.client.session.history.HistoryController")
}
