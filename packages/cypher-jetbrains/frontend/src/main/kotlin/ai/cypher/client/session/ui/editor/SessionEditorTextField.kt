package ai.cypher.client.session.ui.editor
...
internal open class SessionEditorTextField(
    ...
    private val undo = action(CypherBundle.message("session.editor.undo"), true)
    private val redo = action(CypherBundle.message("session.editor.redo"), false)
