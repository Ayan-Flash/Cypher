...
class CypherVirtualFile(
    ...
    override fun getFileSystem(): CypherVirtualFileSystem = CypherVirtualFileSystem.getInstance()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is CypherVirtualFile) return false
        return path == other.path
    }

    override fun hashCode(): Int = path.hashCode()

    private fun kind(): CypherVirtualFileKind? = service<CypherVirtualFileKindRegistry>().get(path.kind)
}
