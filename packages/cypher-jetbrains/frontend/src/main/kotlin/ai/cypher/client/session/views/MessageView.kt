 ...
 * driven by [ai.cypher.client.session.ui.SessionLayout] so that each
 ...
 * messages is owned by [ai.cypher.client.session.ui.SessionLayout].
 */
class MessageView(
    val msg: Message,
...
) : ai.cypher.client.session.ui.SessionLayoutPanel(
