package ai.cypher.client.session.ui.mode

import ai.cypher.client.plugin.CypherBundle
import ai.cypher.client.session.ui.PickerRow
...
internal class ModePickerRenderer(
    ...
    private val badge = JBLabel(FilledBadgeIcon(CypherBundle.message("mode.picker.deprecated"), UiStyle.Badge.Alert)).apply {
