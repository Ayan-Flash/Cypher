package ai.cypher.client.session.scroll
...
internal class SessionScroll(
    ...
    init {
        jump = JBLabel(ScrollButtonIcon.create()).apply {
            ...
            toolTipText = CypherBundle.message("session.scroll.bottom")
            isVisible = false
    ...
    private fun syncIcon() {
        ...
        jump.toolTipText = CypherBundle.message(if (question) "session.scroll.question" else "session.scroll.bottom")
    }
