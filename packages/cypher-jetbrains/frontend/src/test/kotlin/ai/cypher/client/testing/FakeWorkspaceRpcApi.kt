...
/**
 * Fake [CypherWorkspaceRpcApi] for testing.
 *
 ...
 */
class FakeWorkspaceRpcApi : CypherWorkspaceRpcApi {

    var directory = "/test"
    val state = MutableStateFlow(CypherWorkspaceStateDto(CypherWorkspaceStatusDto.PENDING))
    var reloads = 0
        private set
    ...
    var openResult = true
    var localConfigPath = "/test/.cypher/cypher.jsonc"
    var globalConfigPath = "/config/cypher.jsonc"
