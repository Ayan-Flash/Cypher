...
class MdViewHybridTest : BasePlatformTestCase() {
    ...
    fun `test prose inline code is styled without code chrome or editor`() {
        ...
        assertTrue(view.html().contains("<code style=\"color: $color\"><a class=\"cypher-file-ref\" href=\"packages/opencode/src/session/prompt.ts\">packages/opencode/src/session/prompt.ts</a></code>"))
    ...
    fun `test prose file refs are styled as file links`() {
        ...
        assertTrue(html.contains("<a class=\"cypher-file-ref\" href=\"packages/opencode/src/session/prompt.ts\">packages/opencode/src/session/prompt.ts</a>"))
        assertTrue(view.overrideSheet().contains("a.cypher-file-ref, code a.cypher-file-ref"))
    ...
    fun `test file ref links include line suffix and exclude punctuation`() {
        view.set("See cypher/session/prompt.ts:302, native-plan-prompt.txt:37-38.")
        val html = view.html()

        assertTrue(html.contains("href=\"cypher/session/prompt.ts:302\">cypher/session/prompt.ts:302</a>,"))
    ...
    fun `test existing links are not nested as file refs`() {
        ...
        assertFalse(html.contains("cypher-file-ref"))
    }
    ...
    fun `test fenced code file refs are not linkified`() {
        ...
        assertFalse(view.html().substringBefore("</pre>").contains("cypher-file-ref"))
        assertTrue(htmls().single().text.contains("cypher-file-ref"))
    }
    ...
    fun `test shell output renders plain text with semantic highlighters`() {
        val output = """
            ...
            e8b9785 Add second change
             packages/cypher-jetbrains/frontend/src/main/kotlin/App.kt | 14 ++++++++++----
