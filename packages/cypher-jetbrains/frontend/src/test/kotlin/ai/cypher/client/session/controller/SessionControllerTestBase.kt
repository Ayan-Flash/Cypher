...
/**
 * Base class for [ai.cypher.client.session.controller.SessionController] tests.
 *
...
abstract class SessionControllerTestBase : BasePlatformTestCase() {
    ...
    protected data class Snapshot(
        ...
        val diff: List<ai.cypher.rpc.dto.DiffFileDto>,
        val todos: List<ai.cypher.rpc.dto.TodoDto>,
        val compacted: Int,
    ) {
    ...
    override fun setUp() {
        ...
        workspaces = CypherWorkspaceService(scope, projectRpc)
    ...
    protected fun controller(
        ...
        val m = SessionController(
            ...
            timers = timers,
            log = log ?: CypherLog.create(SessionController::class.java),
        )
        controllers.add(m)
        roots[m] = root
        return m
    ...
    protected fun assertQuestionReply(expected: String, replies: List<Triple<String, String, ai.cypher.rpc.dto.QuestionReplyDto>>) {
    ...
    protected fun workspaceReady(
        ...
        connected: List<String> = listOf("cypher"),
        defaults: Map<String, String> = emptyMap(),
    ) = CypherWorkspaceStateDto(
