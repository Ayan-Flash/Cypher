export const dict = {
  ...
  "provider.connect.cypherGateway.line1":
    "Cypher Gateway giver dig adgang til et udvalgt sæt pålidelige, optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.cypherGateway.visit.prefix": "Besøg ",
  "provider.connect.cypherGateway.visit.link": "cypher.ai",
  "provider.connect.cypherGateway.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.cypherGateway.byok.prefix": "For flere brugsstatistikker, brug ",
  ...
  "settings.providers.note.cypher": "Adgang til 500+ AI-modeller",
  ...
  "marketplace.install.about.mcp":
    "En MCP-server giver Cypher yderligere værktøjer til at arbejde med eksterne tjenester eller lokale programmer.",
  "marketplace.install.about.agent": "En agent tilføjer en genanvendelig rolle med egne instruktioner og tilladelser.",
  "marketplace.install.about.skill":
    "En færdighed tilføjer opgavespecifikke instruktioner og ressourcer, som Cypher kan indlæse efter behov.",
  "marketplace.install.mcp.warning":
    "MCP-servere kan køre lokale kommandoer eller oprette forbindelse til eksterne tjenester. Cypher beder om tilladelse, før deres værktøjer bruges, medmindre dine tilladelser automatisk tillader det.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Slå Cyphers snapshots fra for dette projekt. Du mister fortryd/gentag for Cypher-ændringer, men git sporer stadig alt.",
