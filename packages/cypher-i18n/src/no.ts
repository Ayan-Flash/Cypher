export const dict = {
  ...
  "provider.connect.cypherGateway.line1":
    "Cypher Gateway gir deg tilgang til et utvalgt sett med pålitelige, optimaliserte modeller for kodingsagenter.",
  ...
  "provider.connect.cypherGateway.visit.prefix": "Besøk ",
  "provider.connect.cypherGateway.visit.link": "cypher.ai",
  "provider.connect.cypherGateway.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.cypherGateway.byok.prefix": "For mer bruksstatistikk, bruk ",
  ...
  "settings.providers.note.cypher": "Tilgang til 500+ AI-modeller",
  ...
  "marketplace.install.about.mcp":
    "En MCP-server gir Cypher flere verktøy for å arbeide med eksterne tjenester eller lokale programmer.",
  "marketplace.install.about.agent": "En agent legger til en gjenbrukbar rolle med egne instruksjoner og tillatelser.",
  "marketplace.install.about.skill":
    "En ferdighet legger til oppgavespesifikke instruksjoner og ressurser som Cypher kan laste inn ved behov.",
  "marketplace.install.mcp.warning":
    "MCP-servere kan kjøre lokale kommandoer eller koble til eksterne tjenester. Cypher ber om tillatelse før verktøyene brukes, med mindre tillatelsene dine automatisk tillater det.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Slå av Cyphers snapshots for dette prosjektet. Du mister angre/gjør om for Cypher-endringer, men git fortsetter å spore alt.",
