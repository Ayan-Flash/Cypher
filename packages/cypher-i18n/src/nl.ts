...
export const dict = {
  ...
  "provider.connect.cypherGateway.line1":
    "Cypher Gateway geeft je toegang tot een gecureerde set van betrouwbare, geoptimaliseerde modellen voor coding agents.",
  ...
  "provider.connect.cypherGateway.visit.prefix": "Bezoek ",
  "provider.connect.cypherGateway.visit.link": "cypher.ai",
  "provider.connect.cypherGateway.visit.suffix": " om je API key op te halen.",
  "provider.connect.cypherGateway.byok.prefix": "Voor meer gebruiksstatistieken, gebruik ",
  ...
  "settings.providers.note.cypher": "Toegang tot 500+ AI modellen",
  ...
  "marketplace.install.about.mcp":
    "Een MCP-server geeft Cypher extra hulpmiddelen om met externe diensten of lokale programma's te werken.",
  "marketplace.install.about.agent": "Een agent voegt een herbruikbare rol toe met eigen instructies en machtigingen.",
  "marketplace.install.about.skill":
    "Een vaardigheid voegt taakspecifieke instructies en bronnen toe die Cypher indien nodig kan laden.",
  "marketplace.install.mcp.warning":
    "MCP-servers kunnen lokale opdrachten uitvoeren of verbinding maken met externe diensten. Cypher vraagt toestemming voordat hun hulpmiddelen worden gebruikt, tenzij je machtigingen dit automatisch toestaan.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Zet Cypher-snapshots uit voor dit project. Je verliest ongedaan maken/opnieuw doen van Cypher-wijzigingen, maar git blijft alles volgen.",
