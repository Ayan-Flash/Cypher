// Cypher-specific translations and overrides
// Keys here will override any matching keys from upstream translations
export const dict = {
  // Cypher Gateway provider translations
  "provider.connect.cypherGateway.line1":
    "Cypher Gateway gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.cypherGateway.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.cypherGateway.visit.prefix": "Visit ",
  "provider.connect.cypherGateway.visit.link": "cypher.ai",
  "provider.connect.cypherGateway.visit.suffix": " to collect your API key.",
  "provider.connect.cypherGateway.byok.prefix": "For more usage stats, ",
  "provider.connect.cypherGateway.byok.link": "BYOK via Cypher's Gateway",
  "provider.connect.cypherGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Recommended",
  "settings.providers.note.cypher": "Access 500+ AI models",
  ...
  "marketplace.install.about.mcp":
    "An MCP server gives Cypher additional tools for working with external services or local programs.",
  "marketplace.install.about.agent": "An agent adds a reusable role with its own instructions and permissions.",
  "marketplace.install.about.skill": "A skill adds task-specific instructions and resources that Cypher can load when needed.",
  "marketplace.install.mcp.warning":
    "MCP servers can run local commands or connect to external services. Cypher will ask for permission before using their tools unless your permissions allow them automatically.",
  ...
  // are still what the backend matches on (see packages/opencode/src/cypher/plan-followup.ts).
  ...
  // packages/opencode/src/cypher/snapshot/track.ts.
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Turn off Cypher's snapshots for this project. You will lose undo/redo of Cypher file changes, but git still tracks everything.",
