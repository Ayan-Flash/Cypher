...
export const dict = {
  ...
  "provider.connect.cypherGateway.line1":
    "Cypher Gateway ti offre una selezione curata di modelli affidabili e ottimizzati per agenti di coding.",
  "provider.connect.cypherGateway.line2":
    "Con una sola API key puoi accedere a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.cypherGateway.visit.prefix": "Visita ",
  "provider.connect.cypherGateway.visit.link": "cypher.ai",
  "provider.connect.cypherGateway.visit.suffix": " per ottenere la tua API key.",
  "provider.connect.cypherGateway.byok.prefix": "Per ulteriori statistiche sull'utilizzo, utilizza ",
  "provider.connect.cypherGateway.byok.link": "BYOK tramite Cypher's Gateway",
  "provider.connect.cypherGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Consigliati",
  "settings.providers.note.cypher": "Accesso a oltre 500 modelli AI",
  ...
  "marketplace.install.about.mcp":
    "Un server MCP fornisce a Cypher strumenti aggiuntivi per interagire con servizi esterni o programmi locali.",
  "marketplace.install.about.agent":
    "Un agente aggiunge un ruolo riutilizzabile con istruzioni e autorizzazioni proprie.",
  "marketplace.install.about.skill":
    "Una skill aggiunge istruzioni e risorse specifiche per un'attività che Cypher può caricare quando necessario.",
  "marketplace.install.mcp.warning":
    "I server MCP possono eseguire comandi locali o connettersi a servizi esterni. Cypher chiederà l'autorizzazione prima di usare i loro strumenti, a meno che le tue autorizzazioni non lo consentano automaticamente.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Disattiva gli snapshot di Cypher per questo progetto. Perderai annulla/ripeti sulle modifiche ai file fatte da Cypher, ma git continuerà a tracciare tutto.",
