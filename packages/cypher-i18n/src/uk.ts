export const dict = {
  ...
  "provider.connect.cypherGateway.line1":
    "Cypher Gateway надає доступ до добірки надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.cypherGateway.visit.prefix": "Відвідайте ",
  "provider.connect.cypherGateway.visit.link": "cypher.ai",
  "provider.connect.cypherGateway.visit.suffix": " щоб отримати свій API-ключ.",
  "provider.connect.cypherGateway.byok.prefix": "Для отримання додаткової статистики використання використовуйте ",
  ...
  "settings.providers.note.cypher": "Доступ до 500+ моделей ШІ",
  ...
  "marketplace.install.about.mcp":
    "MCP-сервер надає Cypher додаткові інструменти для роботи із зовнішніми сервісами або локальними програмами.",
  "marketplace.install.about.agent":
    "Агент додає багаторазову роль із власними інструкціями та дозволами.",
  "marketplace.install.about.skill":
    "Навичка додає інструкції та ресурси для певних завдань, які Cypher може завантажити за потреби.",
  "marketplace.install.mcp.warning":
    "MCP-сервери можуть виконувати локальні команди або підключатися до зовнішніх сервісів. Cypher запитає дозвіл перед використанням їхніх інструментів, якщо ваші дозволи не дають змоги робити це автоматично.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Вимкніть знімки Cypher для цього проєкту. Ви втратите скасування/повторення для змін Cypher, але git продовжить відстежувати все.",
