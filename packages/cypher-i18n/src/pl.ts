export const dict = {
  ...
  "provider.connect.cypherGateway.line1":
    "Cypher Gateway zapewnia dostęp do wyselekcjonowanego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodowania.",
  ...
  "provider.connect.cypherGateway.visit.prefix": "Odwiedź ",
  "provider.connect.cypherGateway.visit.link": "cypher.ai",
  "provider.connect.cypherGateway.visit.suffix": ", aby otrzymać swój klucz API.",
  "provider.connect.cypherGateway.byok.prefix": "Aby uzyskać więcej statystyk użycia, użyj ",
  "provider.connect.cypherGateway.byok.link": "BYOK przez Cypher's Gateway",
  "provider.connect.cypherGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Polecane",
  "settings.providers.note.cypher": "Dostęp do ponad 500 modeli AI",
  ...
  "marketplace.install.about.mcp":
    "Serwer MCP zapewnia Cypher dodatkowe narzędzia do pracy z usługami zewnętrznymi lub programami lokalnymi.",
  "marketplace.install.about.agent": "Agent dodaje rolę wielokrotnego użytku z własnymi instrukcjami i uprawnieniami.",
  "marketplace.install.about.skill":
    "Umiejętność dodaje instrukcje i zasoby dotyczące określonych zadań, które Cypher może wczytać w razie potrzeby.",
  "marketplace.install.mcp.warning":
    "Serwery MCP mogą uruchamiać lokalne polecenia lub łączyć się z usługami zewnętrznymi. Cypher poprosi o pozwolenie przed użyciem ich narzędzi, chyba że uprawnienia zezwalają na to automatycznie.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Wyłącz snapshoty Cypher dla tego projektu. Stracisz cofanie/przywracanie zmian Cypher, ale git nadal śledzi wszystko.",
