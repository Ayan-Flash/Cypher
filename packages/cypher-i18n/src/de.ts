export const dict = {
  ...
  "provider.connect.cypherGateway.line1":
    "Cypher Gateway bietet Ihnen Zugang zu einer kuratierten Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.cypherGateway.visit.prefix": "Besuchen Sie ",
  "provider.connect.cypherGateway.visit.link": "cypher.ai",
  "provider.connect.cypherGateway.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.cypherGateway.byok.prefix": "Für weitere Nutzungsstatistiken ",
  "provider.connect.cypherGateway.byok.link": "BYOK via Cypher's Gateway",
  "provider.connect.cypherGateway.byok.suffix": " nutzen.",

  // Provider settings translations
  "settings.providers.group.recommended": "Empfohlen",
  "settings.providers.note.cypher": "Zugriff auf 500+ KI-Modelle",
  ...
  "marketplace.install.about.mcp":
    "Ein MCP-Server stellt Cypher zusätzliche Werkzeuge für die Arbeit mit externen Diensten oder lokalen Programmen bereit.",
  ...
  "marketplace.install.about.skill":
    "Ein Skill fügt aufgabenspezifische Anweisungen und Ressourcen hinzu, die Cypher bei Bedarf laden kann.",
  "marketplace.install.mcp.warning":
    "MCP-Server können lokale Befehle ausführen oder eine Verbindung zu externen Diensten herstellen. Cypher fragt vor der Verwendung ihrer Werkzeuge um Erlaubnis, sofern Ihre Berechtigungen dies nicht automatisch erlauben.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Cypher-Snapshots für dieses Projekt ausschalten. Rückgängig/Wiederherstellen für Cypher-Änderungen ist nicht mehr möglich, aber git verfolgt weiterhin alles.",
