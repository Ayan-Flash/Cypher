export const dict = {
  ...
  "provider.connect.cypherGateway.line1":
    "يمنحك Cypher Gateway الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسّنة لوكلاء البرمجة.",
  ...
  "provider.connect.cypherGateway.visit.prefix": "قم بزيارة ",
  "provider.connect.cypherGateway.visit.link": "cypher.ai",
  "provider.connect.cypherGateway.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.cypherGateway.byok.prefix": "للحصول على المزيد من إحصائيات الاستخدام، استخدم ",
  "provider.connect.cypherGateway.byok.link": "BYOK عبر Cypher's Gateway",
  "provider.connect.cypherGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "موصى به",
  "settings.providers.note.cypher": "الوصول إلى أكثر من 500 نموذج ذكاء اصطناعي",
  ...
  "marketplace.install.about.mcp":
    "يمنح خادم MCP منصة Cypher أدوات إضافية للعمل مع الخدمات الخارجية أو البرامج المحلية.",
  "marketplace.install.about.agent": "يضيف الوكيل دورًا قابلاً لإعادة الاستخدام بتعليماته وأذوناته الخاصة.",
  "marketplace.install.about.skill": "تضيف المهارة تعليمات وموارد خاصة بمهام معينة يمكن لـ Cypher تحميلها عند الحاجة.",
  "marketplace.install.mcp.warning":
    "يمكن لخوادم MCP تشغيل أوامر محلية أو الاتصال بخدمات خارجية. ستطلب Cypher الإذن قبل استخدام أدواتها ما لم تسمح أذوناتك بذلك تلقائيًا.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "أوقف لقطات Cypher لهذا المشروع. ستفقد ميزة التراجع/الإعادة لتعديلات Cypher، لكن git سيستمر في تتبع كل شيء.",
