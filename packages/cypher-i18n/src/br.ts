export const dict = {
  ...
  "provider.connect.cypherGateway.line1":
    "O Cypher Gateway oferece acesso a um conjunto selecionado de modelos confiáveis e otimizados para agentes de codificação.",
  ...
  "provider.connect.cypherGateway.visit.prefix": "Visite ",
  "provider.connect.cypherGateway.visit.link": "cypher.ai",
  "provider.connect.cypherGateway.visit.suffix": " para obter sua chave de API.",
  "provider.connect.cypherGateway.byok.prefix": "Para mais estatísticas de uso, utilize ",
  ...
  "settings.providers.note.cypher": "Acesso a mais de 500 modelos de IA",
  ...
  "marketplace.install.about.mcp":
    "Um servidor MCP fornece ao Cypher ferramentas adicionais para trabalhar com serviços externos ou programas locais.",
  "marketplace.install.about.agent": "Um agente adiciona uma função reutilizável com instruções e permissões próprias.",
  "marketplace.install.about.skill":
    "Uma habilidade adiciona instruções e recursos específicos para tarefas que o Cypher pode carregar quando necessário.",
  "marketplace.install.mcp.warning":
    "Servidores MCP podem executar comandos locais ou se conectar a serviços externos. O Cypher solicitará permissão antes de usar suas ferramentas, a menos que suas permissões permitam isso automaticamente.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Desligue os snapshots do Cypher para este projeto. Você perde desfazer/refazer das mudanças feitas pelo Cypher, mas o git continua rastreando tudo.",
