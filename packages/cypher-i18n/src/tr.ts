export const dict = {
  ...
  "provider.connect.cypherGateway.line1":
    "Cypher Gateway, kodlama ajanları için optimize edilmiş güvenilir modellere erişim sağlar.",
  ...
  "provider.connect.cypherGateway.visit.prefix": "API anahtarınızı almak için ",
  "provider.connect.cypherGateway.visit.link": "cypher.ai",
  "provider.connect.cypherGateway.visit.suffix": " adresini ziyaret edin.",
  "provider.connect.cypherGateway.byok.prefix": "Daha fazla kullanım istatistiği için ",
  "provider.connect.cypherGateway.byok.link": "Cypher's Gateway üzerinden BYOK",
  "provider.connect.cypherGateway.byok.suffix": " kullanın.",

  // Provider settings translations
  "settings.providers.group.recommended": "Önerilen",
  "settings.providers.note.cypher": "500+ AI modeline erişim",
  ...
  "marketplace.install.about.mcp":
    "Bir MCP sunucusu, harici hizmetler veya yerel programlarla çalışmak için Cypher'ya ek araçlar sağlar.",
  "marketplace.install.about.agent": "Bir ajan, kendi talimatları ve izinleri olan yeniden kullanılabilir bir rol ekler.",
  "marketplace.install.about.skill":
    "Bir yetenek, Cypher'nun gerektiğinde yükleyebileceği göreve özel talimatlar ve kaynaklar ekler.",
  "marketplace.install.mcp.warning":
    "MCP sunucuları yerel komutları çalıştırabilir veya harici hizmetlere bağlanabilir. İzinleriniz otomatik olarak izin vermediği sürece Cypher, araçlarını kullanmadan önce izin ister.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Bu proje için Cypher anlık görüntülerini kapat. Cypher değişiklikleri için geri alma/yeniden yapmayı kaybedersiniz, ancak git her şeyi izlemeye devam eder.",
