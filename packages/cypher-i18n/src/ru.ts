export const dict = {
  ...
  "provider.connect.cypherGateway.line1":
    "Cypher Gateway предоставляет доступ к подборке надёжных оптимизированных моделей для агентов кодирования.",
  "provider.connect.cypherGateway.line2":
    "С одним API-ключом вы получите доступ к моделям Claude, GPT, Gemini, GLM и другим.",
  "provider.connect.cypherGateway.visit.prefix": "Посетите ",
  "provider.connect.cypherGateway.visit.link": "cypher.ai",
  "provider.connect.cypherGateway.visit.suffix": ", чтобы получить ваш API-ключ.",
  "provider.connect.cypherGateway.byok.prefix": "Для получения дополнительной статистики использования используйте ",
  "provider.connect.cypherGateway.byok.link": "BYOK через Cypher's Gateway",
  "provider.connect.cypherGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Рекомендуемые",
  "settings.providers.note.cypher": "Доступ к 500+ моделям ИИ",
  ...
  "marketplace.install.about.mcp":
    "MCP-сервер предоставляет Cypher дополнительные инструменты для работы с внешними сервисами или локальными программами.",
  ...
  "marketplace.install.about.skill":
    "Навык добавляет инструкции и ресурсы для определённых задач, которые Cypher может загрузить при необходимости.",
  "marketplace.install.mcp.warning":
    "MCP-серверы могут выполнять локальные команды или подключаться к внешним сервисам. Cypher запросит разрешение перед использованием их инструментов, если только ваши разрешения не допускают это автоматически.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Выключите снимки Cypher для этого проекта. Вы потеряете отмену/повтор изменений Cypher, но git по-прежнему отслеживает всё.",
