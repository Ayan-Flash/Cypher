export const dict = {
  ...
  "provider.connect.cypherGateway.line1":
    "Cypher Gateway omogućava pristup pažljivo odabranom skupu pouzdanih modela optimizovanih za rad sa agentima za kodiranje.",
  ...
  "provider.connect.cypherGateway.visit.prefix": "Posjetite ",
  "provider.connect.cypherGateway.visit.link": "cypher.ai",
  "provider.connect.cypherGateway.visit.suffix": " da preuzmete svoj API ključ.",
  "provider.connect.cypherGateway.byok.prefix": "Za više statistika korištenja, koristite ",
  "provider.connect.cypherGateway.byok.link": "BYOK putem Cypher's Gateway",
  "provider.connect.cypherGateway.byok.suffix": ".",

  // Provider settings translations
  "settings.providers.group.recommended": "Preporučeno",
  "settings.providers.note.cypher": "Pristup za 500+ AI modela",
  ...
  "marketplace.install.about.skill":
    "Vještina dodaje upute i resurse za određene zadatke koje Cypher može učitati kada su potrebni.",
  "marketplace.install.mcp.warning":
    "MCP serveri mogu pokretati lokalne naredbe ili se povezivati s vanjskim servisima. Cypher će zatražiti dozvolu prije korištenja njihovih alata, osim ako vaše dozvole to automatski dopuštaju.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Isključi Cypher snapshotove za ovaj projekat. Izgubićete poništi/vrati za izmjene koje napravi Cypher, ali git i dalje prati sve.",
