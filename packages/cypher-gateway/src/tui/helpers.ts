/**
 * TUI-specific helper functions for Cypher Gateway integration
 *
...
import type { CyphercodeProfile, CyphercodeBalance, Organization } from "../types.js"
...
export function formatProfileInfo(
  ...
  const usageUrl = currentOrgId
    ? `https://app.cypher.ai/organizations/${currentOrgId}/usage-details`
