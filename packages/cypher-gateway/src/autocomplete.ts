export type AutocompleteProviderID = "cypher" | "mistral" | "inception"
export type DirectAutocompleteProviderID = Exclude<AutocompleteProviderID, "cypher">
...
interface AutocompleteModelBase {
  ...
  /** Provider key to use for direct BYOK. Empty means Cypher Gateway. */
...
export type AutocompleteModelDef = AutocompleteModelBase &
  (
    | {
        /** Route through `/cypher/edit` using the Next Edit pipeline. */
        readonly kind: "edit"
...
const models: AutocompleteModelDef[] = [
  {
    id: "cypher/mistralai/codestral-2508",
    modelID: "mistralai/codestral-2508",
    label: "Codestral",
    providerID: "cypher",
    provider: "Cypher Gateway",
    requestModel: "mistralai/codestral-2508",
    temperature: 0.2,
  },
  {
    id: "cypher/inception/mercury-edit-2",
  ...
  {
    // Same wire-level model as `cypher/inception/mercury-edit-2`, but routed
    // through the Cypher Gateway's Next Edit endpoint instead of FIM. Picked by
    // users who want multi-line next-edit predictions with the jump-to-edit UX.
    id: "cypher/inception/mercury-next-edit",
    ...
    temperature: 0,
    kind: "edit",
    fimModelID: "cypher/inception/mercury-edit-2",
  },
  {
...
export const DEFAULT_AUTOCOMPLETE_PROVIDER_ID: AutocompleteProviderID = "cypher"
...
export function getAutocompleteModel(provider?: string, model?: string): AutocompleteModelDef {
  // When provider is unset, always default to Cypher Gateway. Direct-provider
