...
import type { CypherProvider, CypherProviderOptions } from "./types.js"
...
/**
 * Create a Cypher provider instance
 *
 * This provider wraps the OpenRouter SDK with Cypher-specific configuration
 * including custom authentication, headers, and base URL.
 *
 * @example
 * ```typescript
 * const provider = createCypher({
 *   cypherToken: "your-token-here",
 ...
 * ```
 */
export function createCypher(options: CypherProviderOptions = {}): CypherProvider {
