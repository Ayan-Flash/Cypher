...
export const IndexingConfig = z
  .object({
    ...
    cypher: z
      ...
      .strict()
      .optional()
      .describe("Cypher-hosted embedding provider options"),
    openai: z
...
export const IndexingSchema = Schema.Struct({
  ...
  cypher: Schema.optional(
    Schema.Struct({
      apiKey: Schema.optional(Schema.String),
      baseUrl: Schema.optional(Schema.String),
      organizationId: Schema.optional(Schema.String),
    }),
  ).annotate({ description: "Cypher-hosted embedding provider options" }),
...
export function toIndexingConfigInput(cfg: IndexingConfig | undefined): IndexingConfigInput {
  ...
  return {
    ...
    cypherApiKey: cfg?.cypher?.apiKey,
    cypherBaseUrl: cfg?.cypher?.baseUrl,
    cypherOrganizationId: cfg?.cypher?.organizationId,
