...
export class CodeIndexConfigManager {
  ...
  private cypherOptions?: { apiKey: string; baseUrl?: string; organizationId?: string }
  ...
  private applyInput(input: IndexingConfigInput): void {
    ...
    this.cypherOptions = input.cypherApiKey
      ? { apiKey: input.cypherApiKey, baseUrl: input.cypherBaseUrl, organizationId: input.cypherOrganizationId }
      : undefined
  ...
  private captureSnapshot(): PreviousConfigSnapshot {
    return {
      ...
      cypherApiKey: this.cypherOptions?.apiKey ?? "",
      cypherBaseUrl: this.cypherOptions?.baseUrl ?? "",
      cypherOrganizationId: this.cypherOptions?.organizationId ?? "",
  ...
  public isConfigured(): boolean {
    ...
    if (provider === "cypher")
      return !!(this.cypherOptions?.apiKey && this.modelId && this.currentModelDimension && hasStore)
  ...
  doesConfigChangeRequireRestart(prev: PreviousConfigSnapshot): boolean {
    ...
    // Auth changes
    if ((prev.cypherApiKey ?? "") !== (this.cypherOptions?.apiKey ?? "")) return true
    if ((prev.cypherBaseUrl ?? "") !== (this.cypherOptions?.baseUrl ?? "")) return true
    if ((prev.cypherOrganizationId ?? "") !== (this.cypherOptions?.organizationId ?? "")) return true
  ...
  public getConfig(): CodeIndexConfig {
    return {
      ...
      modelId: this.modelId,
      modelDimension: this.modelDimension,
      cypherOptions: this.cypherOptions,
