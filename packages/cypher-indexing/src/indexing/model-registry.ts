 ...
 * metadata. Cypher-hosted embedding catalog metadata is fetched from Cloud so the
...
export function normalizeCypherModelId(modelId: string | undefined): string | undefined {
  return modelId
}
