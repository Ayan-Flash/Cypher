/** Provider id and `cypher.json` key (see https://atomic.chat and models.dev). */
...
export const LOG_PREFIX = "[@cypher/plugin-atomic-chat]" as const

export const ATOMIC_CHAT_PLUGIN = "@cypher/plugin-atomic-chat" as const
