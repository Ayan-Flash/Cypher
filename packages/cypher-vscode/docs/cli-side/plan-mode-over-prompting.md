...
**Priority:** P1
**Issue:** [#6143](https://github.com/Cypher-Org/cypher/issues/6143)

An experimental plan mode prompt exists (`Flag.CYPHER_EXPERIMENTAL_PLAN_MODE`) that is verbose. Agent still tends to ask "Should I implement this?" repeatedly.
