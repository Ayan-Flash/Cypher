...
- Consider reusing cypher-ui's `MessageNav` component
- Evaluate whether CLI session undo/redo/revert maps to Cypher's checkpoint model or if extension needs its own git-based implementation
