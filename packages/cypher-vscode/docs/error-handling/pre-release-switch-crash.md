...
**Priority:** P0
**Issue:** [#6083](https://github.com/Cypher-Org/cypher/issues/6083)
...
- Check if both versions attempt to spawn `cypher serve` simultaneously causing port/race conflicts
