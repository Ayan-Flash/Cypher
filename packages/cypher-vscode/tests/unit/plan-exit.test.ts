...
describe("planDisplayPath", () => {
  it("returns a relative path unchanged", () => {
    expect(planDisplayPath(".cypher/plans/my-plan.md", "/repo")).toBe(".cypher/plans/my-plan.md")
  })

  it("returns absolute path inside repo as repo-relative", () => {
    expect(planDisplayPath("/repo/.cypher/plans/my-plan.md", "/repo")).toBe(".cypher/plans/my-plan.md")
  })
  ...
  it("handles Windows absolute paths inside root", () => {
    expect(planDisplayPath("C:\\repo\\.cypher\\plans\\plan.md", "C:\\repo")).toBe(".cypher\\plans\\plan.md")
  })
