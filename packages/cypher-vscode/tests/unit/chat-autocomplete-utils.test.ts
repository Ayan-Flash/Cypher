...
describe("getChatAutocompleteModel", () => {
  it("uses the matching FIM model for Next Edit settings", () => {
    expect(getChatAutocompleteModel("cypher", "inception/mercury-next-edit").id).toBe("cypher/inception/mercury-edit-2")
  ...
  it("keeps FIM settings unchanged", () => {
    expect(getChatAutocompleteModel("cypher", "mistralai/codestral-2508").id).toBe("cypher/mistralai/codestral-2508")
  })
})
