 ...
 *   - Webview (sidebar + agent manager): merged from app, ui, cypher-i18n, agent-manager dicts
...
// Layer 2: upstream UI (@opencode-ai/ui re-exported via @cypher/cypher-ui)
...
// Layer 3: cypher-i18n overrides
import { dict as cypherEn } from "../../../cypher-i18n/src/en"
import { dict as cypherZh } from "../../../cypher-i18n/src/zh"
import { dict as cypherZht } from "../../../cypher-i18n/src/zht"
import { dict as cypherKo } from "../../../cypher-i18n/src/ko"
import { dict as cypherDe } from "../../../cypher-i18n/src/de"
import { dict as cypherEs } from "../../../cypher-i18n/src/es"
import { dict as cypherFr } from "../../../cypher-i18n/src/fr"
import { dict as cypherDa } from "../../../cypher-i18n/src/da"
import { dict as cypherJa } from "../../../cypher-i18n/src/ja"
import { dict as cypherPl } from "../../../cypher-i18n/src/pl"
import { dict as cypherRu } from "../../../cypher-i18n/src/ru"
import { dict as cypherAr } from "../../../cypher-i18n/src/ar"
import { dict as cypherNo } from "../../../cypher-i18n/src/no"
import { dict as cypherBr } from "../../../cypher-i18n/src/br"
import { dict as cypherTh } from "../../../cypher-i18n/src/th"
import { dict as cypherBs } from "../../../cypher-i18n/src/bs"
import { dict as cypherTr } from "../../../cypher-i18n/src/tr"
import { dict as cypherNl } from "../../../cypher-i18n/src/nl"
import { dict as cypherUk } from "../../../cypher-i18n/src/uk"
import { dict as cypherIt } from "../../../cypher-i18n/src/it"
...
const cypherLocales: Record<string, Record<string, string>> = {
  en: cypherEn,
  zh: cypherZh,
  zht: cypherZht,
  ko: cypherKo,
...
const webviewKeys = new Set(Object.keys({ ...appEn, ...uiEn, ...cypherEn, ...amEn }))
...
describe("i18n locale completeness — every English key exists in all locales", () => {
  ...
  it("cypher-i18n: every English key has a translation in all locales", () => {
    const missing = findMissingLocaleKeys(cypherEn, cypherLocales)
    if (missing.length > 0) {
      expect(
        missing,
        `Found ${missing.length} missing cypher-i18n translation(s):\n${formatLocaleReport(missing)}`,
      ).toEqual([])
    }
    expect(missing).toEqual([])
  })
