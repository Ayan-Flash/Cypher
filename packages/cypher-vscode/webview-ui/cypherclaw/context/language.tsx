// CypherClaw lightweight language context
//
// Self-contained i18n for the CypherClaw panel. Does not depend on
...
export function CypherClawLanguageProvider(props: { locale: () => string | undefined; children: JSX.Element }) {
...
export function useCypherClawLanguage(): LanguageCtx {
  const ctx = useContext(LanguageContext)
  if (!ctx) throw new Error("useCypherClawLanguage must be used within CypherClawLanguageProvider")
  return ctx
}
