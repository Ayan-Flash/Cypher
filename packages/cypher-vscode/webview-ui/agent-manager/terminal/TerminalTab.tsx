...
export const TerminalTab: Component<Props> = (props) => {
  ...
  const log = (...args: unknown[]) => console.warn(`[Cypher New][XTerm][${props.terminalId}]`, ...args)
  ...
  onMount(() => {
    ...
    // `CypherProvider.handleWebviewMessage` path which already calls
    ...
    const fontSub = vscode.onMessage((message) => {
      ...
      // fontSizeChanged/ready control the Cypher chat UI font — do not apply
