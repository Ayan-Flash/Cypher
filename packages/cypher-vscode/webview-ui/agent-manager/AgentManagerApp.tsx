...
import { DialogProvider, useDialog } from "@cypher/cypher-ui/context/dialog"
import { Dialog } from "@cypher/cypher-ui/dialog"
import { DropdownMenu } from "@cypher/cypher-ui/dropdown-menu"
import { ContextMenu } from "@cypher/cypher-ui/context-menu"
...
import { Toast, showToast } from "@cypher/cypher-ui/toast"
import { ResizeHandle } from "@cypher/cypher-ui/resize-handle"
import { Icon } from "@cypher/cypher-ui/icon"
import { Button } from "@cypher/cypher-ui/button"
import { IconButton } from "@cypher/cypher-ui/icon-button"
import { Spinner } from "@cypher/cypher-ui/spinner"
import { Tooltip, TooltipKeybind } from "@cypher/cypher-ui/tooltip"
import { Popover } from "@cypher/cypher-ui/popover"
...
import { CypherEmbeddingModelsProvider } from "../src/context/cypher-embedding-models"
  ...
  onMount(() => {
    ...
    const unsub = vscode.onMessage((msg) => {
      ...
      if (msg.type === "agentManager.state") {
        ...
        // When not a git repo, also mark sessions as loaded since the Cypher
      ...
      // to send the prompt through the normal CypherProvider sendMessage path.
