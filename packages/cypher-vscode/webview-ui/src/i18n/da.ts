export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installer Anaconda Desktop på denne maskine, og vend derefter tilbage hertil. Cypher kører ikke installationsprogrammet for dig.",
  ...
  "provider.anaconda.state.signedOut": "Åbn Anaconda Desktop og log ind, før du forbinder Cypher.",
  "provider.anaconda.state.unauthorized":
    "Cypher kunne ikke få adgang til Anaconda Desktop. Åbn Desktop, log ind igen, og genstart den om nødvendigt.",
  ...
  "provider.anaconda.state.ready":
    "Cypher fandt en sund lokal tekstgenereringsserver og kan importere dens aktuelle forbindelsesindstillinger.",
  ...
  "provider.anaconda.toast.refreshed.description": "Den aktive lokale server og modeller er opdaterede i Cypher.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Cypher kunne ikke kontrollere de tilgængelige skills.",
  "agentRequirements.error.mcpStatusFailed": "Cypher kunne ikke kontrollere MCP-serverstatus.",
  "agentRequirements.error.scopeMismatch": "Denne agentkravskontrol er ikke længere aktiv.",
  "agentRequirements.error.requestFailed": "Cypher kunne ikke kontrollere agentkravene.",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Cypher",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Cypher.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Cypher.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Cypher.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox er aktiveret. Shell-kommandoer for agenten er begrænset til projekt- og Cypher-mapperne.",
  "prompt.action.sandbox.disabled":
    "Sandbox er deaktiveret. Klik for at begrænse skrivning af shell-kommandoer for agenten til projekt- og Cypher-mapperne.",
  ...
  "prompt.action.sandbox.description.enabled": "Skrivning er begrænset til projekt- og Cypher-mapperne.",
  ...
  "speechToText.tooltip.start": "Start stemmeinput med Cypher Gateway",
  ...
  "speechToText.error.loginRequired": "Log ind på Cypher for at bruge stemmeinput.",
  ...
  "dialog.server.description": "Skift hvilken Cypher-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Cypher ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Cypher-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Cypher understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Cypher inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Cypher",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Cypher ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Cypher er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Cypher starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Cypher.",
  ...
  "settings.indexing.cypherModel.title": "Cypher-modelpreset",
  "settings.indexing.cypherModel.description": "Vælg en understøttet Cypher-hostet embedding-model.",
  "settings.indexing.cypherSignIn.title": "Cypher-login kræves",
  "settings.indexing.cypherSignIn.description": "Log ind på Cypher for at bruge hostede embeddings.",
  ...
  "settings.providers.betaNotice":
    "I øjeblikket kan kun Cypher Gateway-udbyderen konfigureres i indstillingsgrænsefladen. Understøttelse af konfiguration af andre udbydere kommer snart i løbet af betaperioden. I mellemtiden kan du konfigurere udbydere via CLI eller konfigurationsfilen. Vi er dedikerede til at holde Cypher åben, ingen lock-in.",
  ...
  "settings.models.hidePromptTraining.description":
    "Skjul Cypher Gateway-modeller, hvis udbydere muligvis bruger dine prompts til træning.",
  ...
  "settings.config.title": "Åbn {{scope}} Cypher konfigurationsfil",
  "settings.config.placeholder":
    "Konfigurationsfiler flettes i rækkefølge; filer markeret som indlæst påvirker i øjeblikket indstillingerne.",
  "settings.config.noWorkspace": "Åbn en arbejdsområdemappe for at redigere den lokale Cypher konfigurationsfil.",
  "settings.config.openFailed": "Kunne ikke åbne {{scope}} Cypher konfigurationsfil: {{message}}",
  ...
  "settings.config.source.projectCyphercode": "Forældet .cypher konfiguration",
  ...
  "workStyle.choice.human-in-the-loop.description": "Cypher holder pause og viser dig sin plan undervejs.",
  ...
  "session.cloud.import.placeholder": "Sessions-ID, URL eller cypher import-kommando",
  ...
  "deviceAuth.title": "Log ind på Cypher CLI",
  ...
  "profile.action.login": "Log ind med Cypher CLI",
  ...
  "profile.pass.subscribe": "Få Cypher Pass for at tilføje kredit og optjene bonusser",
  ...
  "session.messages.welcome":
    "Cypher CLI er en AI-kodningsassistent. Bed den om at bygge funktioner, rette fejl eller forklare din kodebase.",
  ...
  "settings.aboutCypher.status.connected": "Forbundet",
  "settings.aboutCypher.status.connecting": "Forbinder...",
  "settings.aboutCypher.status.disconnected": "Afbrudt",
  "settings.aboutCypher.status.error": "Fejl",
  "settings.aboutCypher.cliServer": "CLI-server",
  "settings.aboutCypher.status.label": "Status:",
  "settings.aboutCypher.port.label": "Port:",
  "settings.aboutCypher.versionInfo": "Versionsinformation",
  "settings.aboutCypher.version.label": "Version:",
  "settings.aboutCypher.extensionName": "Cypher CLI-udvidelse",
  "settings.aboutCypher.community": "Fællesskab og support",
  ...
  "settings.aboutCypher.support.prefix": "For fakturerings- eller kontospørgsmål, kontakt kundesupport på",
  "settings.aboutCypher.resetSettings.title": "Nulstil indstillinger",
  ...
  "settings.aboutCypher.resetSettings.button": "Nulstil alle indstillinger",
  "settings.aboutCypher.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutCypher.settingsTransfer.title": "Overførsel af indstillinger",
  ...
  "settings.aboutCypher.exportSettings": "Eksportér",
  "settings.aboutCypher.importSettings": "Importér",
  "settings.aboutCypher.importSettings.invalidJson": "Ugyldig JSON-fil. Vælg venligst en gyldig indstillingsfil.",
  "settings.aboutCypher.importSettings.invalidConfig": "Filen indeholder ikke gyldige Cypher-indstillinger.",
  "settings.aboutCypher.importSettings.tooLarge": "Filen er for stor. Indstillingsfiler skal være under 1 MB.",
  "settings.aboutCypher.importSettings.newerVersion":
    "Denne fil blev eksporteret fra en nyere version af Cypher. Nogle indstillinger kan blive ignoreret.",
  ...
  "settings.aboutCypher.telemetry.openSettings": "Åbn telemetriindstillinger",
  ...
  "settings.language.description": 'Vælg sproget til Cypher CLI-brugerfladen. "Auto" bruger VS Codes visningssprog.',
  ...
  "settings.experimental.speechToText.description":
    "Aktivér stemmeinput i prompt-felter ved hjælp af din Cypher-konto gennem Cypher Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Aktivér og log ind på Cypher-udbyderen for at bruge Speech to Text. Speech to Text understøttes i øjeblikket kun med Cypher Gateway.",
  "settings.models.speechToTextModel.title": "Model til tale til tekst",
  "settings.models.speechToTextModel.description": "Vælg Cypher Gateway-transskriptionsmodellen til stemmeinput.",
  ...
  "settings.experimental.remote.description":
    "Aktivér Remote-styring af sessioner via Cypher Cloud. Dette vil også påvirke CLI'er på denne maskine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Indlæs CLAUDE.md-instruktioner og -færdigheder fra din Claude Code-konfigurationsmappe i sessioner. Aktivér dette, hvis du vil have Cypher til at bruge dine Claude Code-instruktioner og -færdigheder. Kræver genstart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Ingen MCP-servere konfigureret. Tilføj MCP-servere i cypher.jsonc, eller bed agenten om at tilføje dem.",
  ...
  "settings.sandboxing.enabled.description":
    "Kør shell-kommandoer for agenten i en sandbox på operativsystemniveau, der begrænser skrivning til projekt- og Cypher-tilstandsmapperne",
  ...
  "settings.display.fontSize.description": "Juster skriftstørrelsen for Cypher webview UI uafhængigt af VS Code.",
  ...
  "settings.aboutCypher.legacyMigration.title": "Legacy-migrering",
  "settings.aboutCypher.legacyMigration.description":
    "Migrer indstillinger fra en tidligere installation af Cypher CLI, herunder udbyder API-nøgler og standardmodel.",
  "settings.aboutCypher.rooImport.description": "Importer samtalehistorik fra en installation af Roo Code.",
  "settings.aboutCypher.rooImport.button": "Importer sessioner fra Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nyheder i Cypher CLI",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én lille, effektiv kerne på tværs af alle Cypher-produkter. En velkendt oplevelse uanset hvordan du vælger at arbejde.",
  ...
  "diffViewer.source.session.tooltip":
    "Filer ændret af Cypher i den aktuelle session, baseret på snapshots pr. tur. Nulstilles, når du starter en ny session.",
