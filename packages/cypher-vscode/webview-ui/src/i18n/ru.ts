export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Установите Anaconda Desktop на этом компьютере, затем вернитесь сюда. Cypher не запускает установщик за вас.",
  ...
  "provider.anaconda.state.signedOut": "Откройте Anaconda Desktop и войдите в систему перед подключением Cypher.",
  "provider.anaconda.state.unauthorized":
    "Cypher не удалось получить доступ к Anaconda Desktop. Откройте Desktop, войдите снова и при необходимости перезапустите его.",
  ...
  "provider.anaconda.state.ready":
    "Cypher обнаружил исправный локальный сервер генерации текста и может импортировать его текущие настройки подключения.",
  ...
  "provider.anaconda.toast.refreshed.description": "Активный локальный сервер и модели актуальны в Cypher.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Cypher не смог проверить доступные навыки.",
  "agentRequirements.error.mcpStatusFailed": "Cypher не смог проверить состояние сервера MCP.",
  "agentRequirements.error.scopeMismatch": "Эта проверка требований агента больше не активна.",
  "agentRequirements.error.requestFailed": "Cypher не смог проверить требования агента.",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Cypher",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Cypher.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Cypher.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Cypher.",
  ...
  "prompt.action.sandbox.enabled": "Песочница включена. Команды оболочки агента ограничены каталогами проекта и Cypher.",
  "prompt.action.sandbox.disabled":
    "Песочница отключена. Нажмите, чтобы ограничить запись команд оболочки агента каталогами проекта и Cypher.",
  ...
  "prompt.action.sandbox.description.enabled": "Запись разрешена только в каталогах проекта и Cypher.",
  ...
  "speechToText.tooltip.start": "Начать голосовой ввод с Cypher Gateway",
  ...
  "speechToText.error.loginRequired": "Войдите в Cypher, чтобы использовать голосовой ввод.",
  ...
  "dialog.server.description": "Переключите сервер Cypher к которому подключается приложение.",
  ...
  "toast.update.description": "Новая версия Cypher ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Cypher",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Cypher пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Cypher включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Cypher",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как Cypher выглядит на вашем устройстве",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Cypher.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Cypher",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Cypher.",
  ...
  "settings.indexing.cypherModel.title": "Предустановка модели Cypher",
  "settings.indexing.cypherModel.description": "Выберите поддерживаемую модель эмбеддингов, размещенную в Cypher.",
  "settings.indexing.cypherSignIn.title": "Требуется вход в Cypher",
  "settings.indexing.cypherSignIn.description": "Войдите в Cypher, чтобы использовать размещенные эмбеддинги.",
  ...
  "settings.providers.betaNotice":
    "В настоящее время в интерфейсе настроек можно настроить только провайдер Cypher Gateway. Поддержка настройки других провайдеров скоро появится в период бета-тестирования. А пока вы можете настраивать провайдеров с помощью CLI или конфигурационного файла. Мы стремимся сохранить Cypher открытым — без привязки к поставщикам.",
  ...
  "settings.models.hidePromptTraining.description":
    "Скрывать модели Cypher Gateway, поставщики которых могут использовать ваши запросы для обучения.",
  ...
  "settings.config.title": "Открыть файл конфигурации Cypher ({{scope}})",
  ...
  "settings.config.noWorkspace":
    "Откройте папку рабочей области для редактирования локального файла конфигурации Cypher.",
  "settings.config.openFailed": "Не удалось открыть файл конфигурации Cypher ({{scope}}): {{message}}",
  "settings.config.source.xdg": "Глобальная конфигурация XDG",
  "settings.config.source.homeCypher": "Конфигурация .cypher (Home)",
  "settings.config.source.homeCyphercode": "Конфигурация .cypher (Home)",
  "settings.config.source.homeOpencode": "Конфигурация .opencode (Home)",
  "settings.config.source.envFile": "Файл среды CYPHER_CONFIG",
  "settings.config.source.envDir": "CYPHER_CONFIG_DIR",
  "settings.config.source.envContent": "Встроенная конфигурация среды",
  "settings.config.source.projectCypher": "Конфигурация .cypher проекта",
  "settings.config.source.projectRoot": "Корневая конфигурация проекта",
  "settings.config.source.projectCyphercode": "Устаревшая конфигурация .cypher",
  ...
  "workStyle.onboarding.welcome": "Добро пожаловать в Cypher",
  ...
  "workStyle.choice.human-in-the-loop.description": "Cypher приостанавливается и показывает свой план по ходу работы.",
  ...
  "session.cloud.import.placeholder": "ID сессии, URL или команда cypher import",
  ...
  "deviceAuth.title": "Войти в Cypher CLI",
  ...
  "profile.action.login": "Войти через Cypher CLI",
  ...
  "profile.pass.subscribe": "Оформите Cypher Pass, чтобы добавить кредиты и получать бонусы",
  ...
  "settings.aboutCypher.title": "О Cypher CLI",

  "session.messages.empty": "Начните разговор, введя сообщение ниже.",
  "session.messages.welcome":
    "Cypher CLI — это AI-помощник для программирования. Попросите его создать функции, исправить ошибки или объяснить вашу кодовую базу.",
  ...
  "settings.aboutCypher.status.connected": "Подключено",
  "settings.aboutCypher.status.connecting": "Подключение...",
  "settings.aboutCypher.status.disconnected": "Отключено",
  "settings.aboutCypher.status.error": "Ошибка",
  "settings.aboutCypher.cliServer": "CLI-сервер",
  "settings.aboutCypher.status.label": "Статус:",
  "settings.aboutCypher.port.label": "Порт:",
  "settings.aboutCypher.versionInfo": "Информация о версии",
  "settings.aboutCypher.version.label": "Версия:",
  "settings.aboutCypher.extensionName": "Расширение Cypher CLI",
  "settings.aboutCypher.community": "Сообщество и поддержка",
  "settings.aboutCypher.feedback.prefix": "Если у вас есть вопросы или отзывы, создайте issue на",
  "settings.aboutCypher.feedback.or": "или",
  "settings.aboutCypher.support.prefix": "По вопросам оплаты или аккаунта обращайтесь в службу поддержки по адресу",
  "settings.aboutCypher.resetSettings.title": "Сброс настроек",
  ...
  "settings.aboutCypher.resetSettings.button": "Сбросить все настройки",
  "settings.aboutCypher.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutCypher.settingsTransfer.title": "Перенос настроек",
  ...
  "settings.aboutCypher.exportSettings": "Экспорт",
  "settings.aboutCypher.importSettings": "Импорт",
  "settings.aboutCypher.importSettings.invalidJson": "Недопустимый файл JSON. Выберите корректный файл настроек.",
  "settings.aboutCypher.importSettings.invalidConfig": "Файл не содержит допустимых настроек Cypher.",
  "settings.aboutCypher.importSettings.tooLarge": "Файл слишком большой. Файлы настроек должны быть менее 1 MB.",
  "settings.aboutCypher.importSettings.newerVersion":
    "Этот файл был экспортирован из более новой версии Cypher. Некоторые настройки могут быть проигнорированы.",
  "settings.aboutCypher.importSettings.success":
    "Настройки импортированы. Просмотрите изменения выше и нажмите «Сохранить».",

  "settings.aboutCypher.telemetry.title": "Телеметрия",
  ...
  "settings.aboutCypher.telemetry.openSettings": "Открыть настройки телеметрии",
  ...
  "settings.language.description": "Выберите язык интерфейса Cypher CLI. «Авто» использует язык отображения VS Code.",
  ...
  "settings.experimental.speechToText.description":
    "Включите голосовой ввод в полях запросов, используя вашу учетную запись Cypher через Cypher Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Включите провайдер Cypher и выполните вход, чтобы использовать Speech to Text. В настоящее время Speech to Text поддерживается только с Cypher Gateway.",
  "settings.models.speechToTextModel.title": "Модель речи в текст",
  "settings.models.speechToTextModel.description": "Выберите модель транскрипции Cypher Gateway для голосового ввода.",
  ...
  "settings.experimental.remote.description":
    "Включите управление Remote сеансами через Cypher Cloud. Это также повлияет на CLI на этом компьютере.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Загружать инструкции CLAUDE.md и навыки из каталога конфигурации Claude Code в сессии. Включите эту опцию, если хотите, чтобы Cypher использовал ваши инструкции и навыки Claude Code. Требуется перезапуск.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP-серверы не настроены. Добавьте MCP-серверы в cypher.jsonc или попросите агента добавить их.",
  ...
  "settings.sandboxing.enabled.description":
    "Выполнять команды оболочки агента в песочнице на уровне ОС, которая ограничивает запись в каталоги состояния проекта и Cypher",
  ...
  "settings.display.fontSize.description": "Настройте размер шрифта webview UI для Cypher независимо от VS Code.",
  ...
  "settings.aboutCypher.legacyMigration.title": "Миграция с устаревшей версии",
  "settings.aboutCypher.legacyMigration.description":
    "Перенос настроек из предыдущей установки Cypher CLI, включая API-ключи провайдеров и модель по умолчанию.",
  "settings.aboutCypher.rooImport.description": "Импорт истории переписки из установки Roo Code.",
  "settings.aboutCypher.rooImport.button": "Импортировать сеансы из Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Что нового в Cypher CLI",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Одно компактное и эффективное ядро для всех продуктов Cypher. Знакомый опыт независимо от выбранного способа работы.",
  ...
  "diffViewer.source.session.tooltip":
    "Файлы, изменённые Cypher в текущей сессии, на основе снимков по ходу. Сбрасывается при начале новой сессии.",
