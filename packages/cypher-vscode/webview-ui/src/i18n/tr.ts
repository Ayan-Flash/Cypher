export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Anaconda Desktop'ı bu makineye kurun, ardından buraya dönün. Cypher kurulumu sizin için çalıştırmaz.",
  ...
  "provider.anaconda.state.signedOut": "Cypher'yu bağlamadan önce Anaconda Desktop'ı açın ve oturum açın.",
  "provider.anaconda.state.unauthorized":
    "Cypher Anaconda Desktop'a erişemedi. Desktop'ı açın, tekrar oturum açın ve gerekirse yeniden başlatın.",
  ...
  "provider.anaconda.state.ready":
    "Cypher sağlıklı bir yerel metin üretme sunucusu buldu ve mevcut bağlantı ayarlarını içe aktarabilir.",
  ...
  "provider.anaconda.toast.refreshed.description": "Etkin yerel sunucu ve modeller Cypher'da güncel.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Cypher mevcut yetenekleri denetleyemedi.",
  "agentRequirements.error.mcpStatusFailed": "Cypher MCP sunucu durumunu denetleyemedi.",
  "agentRequirements.error.scopeMismatch": "Bu ajan gereksinimi denetimi artık etkin değil.",
  "agentRequirements.error.requestFailed": "Cypher ajan gereksinimlerini denetleyemedi.",
  ...
  "dialog.model.unpaid.freeModels.title": "Cypher tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Cypher'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.prefix": "Hesabınızı bağlamak ve Cypher'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Cypher'da {{provider}} modellerini kullanın.",
  ...
  "prompt.action.sandbox.enabled": "Sandbox etkin. Agent shell komutları proje ve Cypher dizinleriyle sınırlıdır.",
  "prompt.action.sandbox.disabled":
    "Sandbox devre dışı. Agent shell komut yazma işlemlerini proje ve Cypher dizinleriyle sınırlamak için tıklayın.",
  ...
  "prompt.action.sandbox.description.enabled": "Yazma işlemleri proje ve Cypher dizinleriyle sınırlıdır.",
  ...
  "speechToText.tooltip.start": "Cypher Gateway ile sesli girişi başlatın",
  ...
  "speechToText.error.loginRequired": "Sesli girişi kullanmak için Cypher'ya giriş yapın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Cypher sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Cypher'nun yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Cypher ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Cypher henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Cypher ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Cypher Masaüstü",
  ...
  "settings.general.row.language.description": "Cypher'nun görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Cypher'nun cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Cypher'nun temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Cypher başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Cypher'nun en son sürümünü kullanıyorsunuz.",
  ...
  "settings.providers.betaNotice":
    "Şu anda yalnızca Cypher Gateway sağlayıcısı ayarlar arayüzünde yapılandırılabilir. Diğer sağlayıcılar için destek beta döneminde yakında gelecek. Bu arada CLI veya yapılandırma dosyası ile sağlayıcıları yapılandırabilirsiniz. Cypher'yu açık tutmaya kararlıyız, kilitlenme yok.",
  ...
  "settings.config.title": "{{scope}} Cypher yapılandırma dosyasını aç",
  "settings.config.placeholder":
    "Yapılandırma dosyaları sırayla birleştirilir; yüklendi olarak işaretlenen dosyalar şu anda ayarları etkiler.",
  "settings.config.noWorkspace": "Yerel Cypher yapılandırma dosyasını düzenlemek için bir çalışma alanı klasörü açın.",
  "settings.config.openFailed": "{{scope}} Cypher yapılandırma dosyası açılamadı: {{message}}",
  "settings.config.source.xdg": "XDG küresel yapılandırma",
  "settings.config.source.homeCypher": "Home .cypher yapılandırması",
  "settings.config.source.homeCyphercode": "Home .cypher yapılandırması",
  "settings.config.source.homeOpencode": "Home .opencode yapılandırması",
  "settings.config.source.envFile": "CYPHER_CONFIG ortam dosyası",
  "settings.config.source.envDir": "CYPHER_CONFIG_DIR",
  "settings.config.source.envContent": "Satır içi ortam yapılandırması",
  "settings.config.source.projectCypher": "Proje .cypher yapılandırması",
  "settings.config.source.projectRoot": "Proje kök yapılandırması",
  "settings.config.source.projectCyphercode": "Eski .cypher yapılandırması",
  ...
  "workStyle.onboarding.welcome": "Cypher'ya hoş geldiniz",
  ...
  "workStyle.choice.human-in-the-loop.description": "Cypher çalışırken duraklar ve planını size gösterir.",
  ...
  "session.cloud.import.placeholder": "Oturum kimliği, URL veya cypher import komutu",
  ...
  "deviceAuth.title": "Cypher CLI'a giriş yap",
  ...
  "profile.action.login": "Cypher CLI ile giriş yap",
  ...
  "profile.pass.subscribe": "Kredi eklemek ve bonus kazanmak için Cypher Pass edinin",
  ...
  "settings.aboutCypher.title": "Cypher CLI Hakkında",

  "session.messages.empty": "Aşağıya bir mesaj yazarak sohbete başlayın.",
  "session.messages.welcome":
    "Cypher CLI bir yapay zeka kodlama asistanıdır. Özellik geliştirmesini, hata düzeltmesini veya kod tabanınızı açıklamasını isteyin.",
  ...
  "settings.aboutCypher.status.connected": "Bağlı",
  "settings.aboutCypher.status.connecting": "Bağlanıyor...",
  "settings.aboutCypher.status.disconnected": "Bağlantı Kesildi",
  "settings.aboutCypher.status.error": "Hata",
  "settings.aboutCypher.cliServer": "CLI Sunucusu",
  "settings.aboutCypher.status.label": "Durum:",
  "settings.aboutCypher.port.label": "Port:",
  "settings.aboutCypher.versionInfo": "Sürüm Bilgisi",
  "settings.aboutCypher.version.label": "Sürüm:",
  "settings.aboutCypher.extensionName": "Cypher CLI Uzantısı",
  "settings.aboutCypher.community": "Topluluk ve Destek",
  "settings.aboutCypher.feedback.prefix":
    "Herhangi bir sorunuz veya geri bildiriminiz varsa, lütfen şu adreste bir sorun açın:",
  "settings.aboutCypher.feedback.or": "veya",
  "settings.aboutCypher.support.prefix": "Faturalama veya hesap soruları için Müşteri Desteği ile iletişime geçin:",
  "settings.aboutCypher.resetSettings.title": "Ayarları Sıfırla",
  ...
  "settings.aboutCypher.resetSettings.button": "Tüm Ayarları Sıfırla",
  "settings.aboutCypher.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutCypher.settingsTransfer.title": "Ayar Aktarımı",
  ...
  "settings.aboutCypher.exportSettings": "Dışa Aktar",
  "settings.aboutCypher.importSettings": "İçe Aktar",
  "settings.aboutCypher.importSettings.invalidJson": "Geçersiz JSON dosyası. Lütfen geçerli bir ayar dosyası seçin.",
  "settings.aboutCypher.importSettings.invalidConfig": "Dosya geçerli Cypher ayarları içermiyor.",
  "settings.aboutCypher.importSettings.tooLarge": "Dosya çok büyük. Ayar dosyaları 1 MB altında olmalıdır.",
  "settings.aboutCypher.importSettings.newerVersion":
    "Bu dosya Cypher'nun daha yeni bir sürümünden dışa aktarılmış. Bazı ayarlar göz ardı edilebilir.",
  ...
  "settings.aboutCypher.telemetry.openSettings": "Telemetri Ayarlarını Aç",
  ...
  "settings.language.description":
    '"Otomatik" VS Code görüntüleme dilinizi kullanır. Cypher CLI arayüzü için dil seçin.',
  ...
  "settings.experimental.speechToText.description":
    "Cypher Gateway üzerinden Cypher hesabınızı kullanarak komut alanlarında sesli girişi etkinleştirin.",
  "settings.models.speechToText.disabledDescription":
    "Speech to Text kullanmak için Cypher sağlayıcısını etkinleştirin ve giriş yapın. Speech to Text şu anda yalnızca Cypher Gateway ile desteklenmektedir.",
  "settings.models.speechToTextModel.title": "Sesten metne modeli",
  "settings.models.speechToTextModel.description": "Sesli giriş için Cypher Gateway transkripsiyon modelini seçin.",
  ...
  "settings.experimental.remote.description":
    "Cypher Cloud üzerinden oturumların Remote kontrolünü etkinleştirin. Bu, bu makinedeki CLI'leri de etkileyecektir.",
  ...
  "settings.sandboxing.enabled.description":
    "Agent shell komutlarını, proje ve Cypher durum dizinlerine yazmaları kısıtlanan işletim sistemi düzeyinde bir sandbox içinde çalıştırın",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code yapılandırma dizininizdeki CLAUDE.md talimatlarını ve becerilerini oturumlara yükleyin. Cypher'nun Claude Code talimatlarınızı ve becerilerinizi kullanmasını istiyorsanız bunu etkinleştirin. Yeniden başlatma gerektirir.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Yapılandırılmış MCP sunucusu yok. cypher.jsonc dosyasına MCP sunucuları ekleyin veya ajanın eklemesini isteyin.",
  ...
  "settings.display.fontSize.description": "Cypher webview UI yazı tipi boyutunu VS Code'dan bağımsız olarak ayarlayın.",
  ...
  "settings.models.hidePromptTraining.description":
    "Sağlayıcıları istemlerinizi eğitim için kullanabilecek Cypher Gateway modellerini gizleyin.",
  ...
  "settings.aboutCypher.legacyMigration.title": "Eski Sürüm Taşıma",
  "settings.aboutCypher.legacyMigration.description":
    "Sağlayıcı API anahtarları ve varsayılan model dahil olmak üzere Cypher CLI'un önceki yüklemesinden ayarları taşıyın.",
  "settings.aboutCypher.rooImport.description": "Bir Roo Code yüklemesinden konuşma geçmişini içe aktarın.",
  "settings.aboutCypher.rooImport.button": "Roo Code'dan Oturumları İçe Aktar",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Cypher CLI'daki Yenilikler",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Her Cypher ürününde küçük ve verimli bir çekirdek. Nasıl çalışmayı tercih ederseniz edin, tanıdık bir deneyim.",
  ...
  "settings.indexing.cypherModel.title": "Cypher model önayarı",
  "settings.indexing.cypherModel.description": "Desteklenen bir Cypher-hosted embeddings modeli seçin.",
  "settings.indexing.cypherSignIn.title": "Cypher oturumu açmak gerekiyor",
  "settings.indexing.cypherSignIn.description": "Hosted embeddings kullanmak için Cypher'da oturum açın.",
  ...
  "diffViewer.source.session.tooltip":
    "Geçerli oturum sırasında Cypher tarafından değiştirilen dosyalar, tur başı anlık görüntülere dayanır. Yeni bir oturum başlatıldığında sıfırlanır.",
