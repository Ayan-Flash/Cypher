export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "ติดตั้ง Anaconda Desktop บนเครื่องนี้ แล้วกลับมาที่นี่ Cypher จะไม่เรียกใช้ตัวติดตั้งให้คุณ",
  ...
  "provider.anaconda.state.signedOut": "เปิด Anaconda Desktop และลงชื่อเข้าใช้ก่อนเชื่อมต่อ Cypher",
  "provider.anaconda.state.unauthorized":
    "Cypher ไม่สามารถเข้าถึง Anaconda Desktop ได้ เปิด Desktop ลงชื่อเข้าใช้อีกครั้ง และรีสตาร์ทหากจำเป็น",
  ...
  "provider.anaconda.state.ready":
    "Cypher พบเซิร์ฟเวอร์สร้างข้อความในเครื่องที่พร้อมใช้งาน และสามารถนำเข้าการตั้งค่าการเชื่อมต่อปัจจุบันได้",
  ...
  "provider.anaconda.toast.refreshed.description": "เซิร์ฟเวอร์ในเครื่องและโมเดลที่ใช้งานอยู่เป็นปัจจุบันใน Cypher แล้ว",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Cypher ไม่สามารถตรวจสอบสกิลที่มีอยู่ได้",
  "agentRequirements.error.mcpStatusFailed": "Cypher ไม่สามารถตรวจสอบสถานะเซิร์ฟเวอร์ MCP ได้",
  "agentRequirements.error.scopeMismatch": "การตรวจสอบข้อกำหนดของเอเจนต์นี้ไม่ทำงานอีกต่อไป",
  "agentRequirements.error.requestFailed": "Cypher ไม่สามารถตรวจสอบข้อกำหนดของเอเจนต์ได้",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Cypher",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Cypher",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Cypher",
  ...
  "provider.connect.oauth.auto.visit.suffix": " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Cypher",
  ...
  "prompt.action.sandbox.enabled":
    "เปิดใช้งาน sandbox แล้ว คำสั่ง shell ของ agent ถูกจำกัดไว้ที่โฟลเดอร์โปรเจ็กต์และ Cypher",
  "prompt.action.sandbox.disabled":
    "ปิดใช้งาน sandbox อยู่ คลิกเพื่อจำกัดการเขียนคำสั่ง shell ของ agent ไว้ที่โฟลเดอร์โปรเจ็กต์และ Cypher",
  ...
  "prompt.action.sandbox.description.enabled": "เขียนได้เฉพาะในโฟลเดอร์โปรเจ็กต์และ Cypher",
  ...
  "speechToText.tooltip.start": "เริ่มการป้อนข้อมูลด้วยเสียงด้วย Cypher Gateway",
  ...
  "speechToText.error.loginRequired": "ลงชื่อเข้าใช้ Cypher เพื่อใช้การป้อนข้อมูลด้วยเสียง",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Cypher ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Cypher ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Cypher",
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Cypher ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "Cypher รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Cypher",
  "settings.general.row.appearance.title": "รูปลักษณ์",
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ Cypher มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ Cypher มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Cypher เปิดตัว",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้ Cypher เวอร์ชันล่าสุด",
  ...
  "settings.indexing.cypherModel.title": "พรีเซ็ตโมเดล Cypher",
  "settings.indexing.cypherModel.description": "เลือกโมเดลการฝังที่ Cypher โฮสต์และรองรับ",
  "settings.indexing.cypherSignIn.title": "ต้องลงชื่อเข้าใช้ Cypher",
  "settings.indexing.cypherSignIn.description": "ลงชื่อเข้าใช้ Cypher เพื่อใช้การฝังแบบโฮสต์",
  ...
  "settings.providers.betaNotice":
    "ปัจจุบันสามารถตั้งค่าได้เฉพาะผู้ให้บริการ Cypher Gateway ในหน้าการตั้งค่าเท่านั้น การรองรับการตั้งค่าผู้ให้บริการรายอื่นจะพร้อมใช้งานในเร็วๆ นี้ในช่วงเบต้า ในระหว่างนี้คุณสามารถตั้งค่าผู้ให้บริการผ่าน CLI หรือไฟล์คอนฟิกได้ เรามุ่งมั่นที่จะรักษาให้ Cypher เปิดกว้างและไม่มีการผูกมัด",
  ...
  "settings.models.hidePromptTraining.description": "ซ่อนโมเดล Cypher Gateway ที่ผู้ให้บริการอาจใช้พรอมต์ของคุณในการฝึก",
  ...
  "settings.config.title": "เปิดไฟล์การตั้งค่า Cypher ({{scope}})",
  "settings.config.placeholder":
    "ไฟล์การตั้งค่าจะถูกผสานตามลำดับ ไฟล์ที่ถูกทำเครื่องหมายว่าโหลดแล้วจะมีผลกับการตั้งค่าในปัจจุบัน",
  "settings.config.noWorkspace": "เปิดโฟลเดอร์พื้นที่ทำงานเพื่อแก้ไขไฟล์การตั้งค่า Cypher ภายใน",
  "settings.config.openFailed": "ไม่สามารถเปิดไฟล์การตั้งค่า Cypher ({{scope}}): {{message}}",
  "settings.config.source.xdg": "การตั้งค่า XDG ทั่วโลก",
  "settings.config.source.homeCypher": "การตั้งค่า .cypher ของ Home",
  "settings.config.source.homeCyphercode": "การตั้งค่า .cypher ของ Home",
  "settings.config.source.homeOpencode": "การตั้งค่า .opencode ของ Home",
  "settings.config.source.envFile": "ไฟล์สภาพแวดล้อม CYPHER_CONFIG",
  "settings.config.source.envDir": "CYPHER_CONFIG_DIR",
  "settings.config.source.envContent": "การตั้งค่าสภาพแวดล้อมแบบอินไลน์",
  "settings.config.source.projectCypher": "การตั้งค่า .cypher ของโปรเจกต์",
  "settings.config.source.projectRoot": "การตั้งค่ารูทของโปรเจกต์",
  "settings.config.source.projectCyphercode": "การตั้งค่า .cypher แบบเก่า",
  ...
  "workStyle.onboarding.welcome": "ยินดีต้อนรับสู่ Cypher",
  ...
  "workStyle.choice.human-in-the-loop.description": "Cypher จะหยุดและแสดงแผนให้คุณเห็นระหว่างการทำงาน",
  ...
  "session.cloud.import.placeholder": "ID เซสชัน, URL หรือคำสั่ง cypher import",
  ...
  "deviceAuth.title": "เข้าสู่ระบบ Cypher CLI",
  ...
  "profile.action.login": "เข้าสู่ระบบด้วย Cypher CLI",
  ...
  "profile.pass.subscribe": "รับ Cypher Pass เพื่อเพิ่มเครดิตและรับโบนัส",
  ...
  "settings.aboutCypher.title": "เกี่ยวกับ Cypher CLI",

  "session.messages.empty": "เริ่มการสนทนาโดยพิมพ์ข้อความด้านล่าง",
  "session.messages.welcome": "Cypher CLI เป็นผู้ช่วยเขียนโค้ด AI ขอให้สร้างฟีเจอร์ แก้ไขบัก หรืออธิบายโค้ดเบสของคุณ",
  ...
  "settings.aboutCypher.status.connected": "เชื่อมต่อแล้ว",
  "settings.aboutCypher.status.connecting": "กำลังเชื่อมต่อ...",
  "settings.aboutCypher.status.disconnected": "ตัดการเชื่อมต่อ",
  "settings.aboutCypher.status.error": "ข้อผิดพลาด",
  "settings.aboutCypher.cliServer": "เซิร์ฟเวอร์ CLI",
  "settings.aboutCypher.status.label": "สถานะ:",
  "settings.aboutCypher.port.label": "พอร์ต:",
  "settings.aboutCypher.versionInfo": "ข้อมูลเวอร์ชัน",
  "settings.aboutCypher.version.label": "เวอร์ชัน:",
  "settings.aboutCypher.extensionName": "ส่วนขยาย Cypher CLI",
  "settings.aboutCypher.community": "ชุมชนและการสนับสนุน",
  "settings.aboutCypher.feedback.prefix": "หากคุณมีคำถามหรือข้อเสนอแนะ สามารถเปิด issue ได้ที่",
  "settings.aboutCypher.feedback.or": "หรือ",
  "settings.aboutCypher.support.prefix": "สำหรับคำถามเกี่ยวกับการเรียกเก็บเงินหรือบัญชี ติดต่อฝ่ายสนับสนุนลูกค้าที่",
  "settings.aboutCypher.resetSettings.title": "รีเซ็ตการตั้งค่า",
  ...
  "settings.aboutCypher.resetSettings.button": "รีเซ็ตการตั้งค่าทั้งหมด",
  "settings.aboutCypher.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutCypher.settingsTransfer.title": "ถ่ายโอนการตั้งค่า",
  "settings.aboutCypher.settingsTransfer.description":
    "ส่งออกหรือนำเข้าการตั้งค่าเพื่อถ่ายโอนระหว่างอินสแตนซ์ VS Code",
  "settings.aboutCypher.exportSettings": "ส่งออก",
  "settings.aboutCypher.importSettings": "นำเข้า",
  "settings.aboutCypher.importSettings.invalidJson": "ไฟล์ JSON ไม่ถูกต้อง กรุณาเลือกไฟล์การตั้งค่าที่ถูกต้อง",
  "settings.aboutCypher.importSettings.invalidConfig": "ไฟล์ไม่มีการตั้งค่า Cypher ที่ถูกต้อง",
  "settings.aboutCypher.importSettings.tooLarge": "ไฟล์มีขนาดใหญ่เกินไป ไฟล์การตั้งค่าต้องมีขนาดไม่เกิน 1 MB",
  "settings.aboutCypher.importSettings.newerVersion":
    "ไฟล์นี้ถูกส่งออกจาก Cypher เวอร์ชันใหม่กว่า การตั้งค่าบางรายการอาจถูกข้ามไป",
  "settings.aboutCypher.importSettings.success": "นำเข้าการตั้งค่าแล้ว ตรวจสอบการเปลี่ยนแปลงด้านบน จากนั้นคลิกบันทึก",

  "settings.aboutCypher.telemetry.title": "Telemetry",
  ...
  "settings.aboutCypher.telemetry.openSettings": "เปิดการตั้งค่า Telemetry",
  ...
  "settings.language.description": 'เลือกภาษาสำหรับ UI ของ Cypher CLI "อัตโนมัติ" จะใช้ภาษาการแสดงผลของ VS Code',
  ...
  "settings.experimental.speechToText.description":
    "เปิดใช้งานการป้อนข้อมูลด้วยเสียงในช่องพรอมต์โดยใช้บัญชี Cypher ของคุณผ่าน Cypher Gateway",
  "settings.models.speechToText.disabledDescription":
    "เปิดใช้งานและลงชื่อเข้าใช้ผู้ให้บริการ Cypher เพื่อใช้ Speech to Text ปัจจุบัน Speech to Text รองรับเฉพาะกับ Cypher Gateway เท่านั้น",
  "settings.models.speechToTextModel.title": "โมเดลแปลงเสียงเป็นข้อความ",
  "settings.models.speechToTextModel.description": "เลือกโมเดลการถอดเสียง Cypher Gateway สำหรับการป้อนข้อมูลด้วยเสียง",
  ...
  "settings.experimental.remote.description":
    "เปิดใช้งานการควบคุม Remote ของเซสชันผ่าน Cypher Cloud ซึ่งจะส่งผลต่อ CLI บนเครื่องนี้ด้วย",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "โหลดคำแนะนำและทักษะจาก CLAUDE.md ในไดเรกทอรีการกำหนดค่า Claude Code ของคุณลงในเซสชัน เปิดใช้งานตัวเลือกนี้หากคุณต้องการให้ Cypher ใช้คำแนะนำและทักษะจาก Claude Code ของคุณ จำเป็นต้องรีสตาร์ท",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "ไม่ได้กำหนดค่าเซิร์ฟเวอร์ MCP เพิ่มเซิร์ฟเวอร์ MCP ใน cypher.jsonc หรือขอให้เอเจนต์เพิ่มให้คุณ",
  ...
  "settings.sandboxing.enabled.description":
    "เรียกใช้คำสั่ง shell ของ agent ใน sandbox ระดับระบบปฏิบัติการที่จำกัดการเขียนไปยังโฟลเดอร์สถานะของโปรเจ็กต์และ Cypher",
  ...
  "settings.display.fontSize.description": "ปรับขนาดฟอนต์ webview UI ของ Cypher แยกเป็นอิสระจาก VS Code.",
  ...
  "settings.aboutCypher.legacyMigration.title": "การย้ายข้อมูลจากเวอร์ชันดั้งเดิม",
  "settings.aboutCypher.legacyMigration.description":
    "ย้ายการตั้งค่าจากการติดตั้ง Cypher CLI ก่อนหน้านี้ รวมถึงคีย์ API ของผู้ให้บริการและโมเดลเริ่มต้น",
  "settings.aboutCypher.rooImport.description": "นำเข้าประวัติการสนทนาจากการติดตั้ง Roo Code",
  "settings.aboutCypher.rooImport.button": "นำเข้าเซสชันจาก Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "มีอะไรใหม่ใน Cypher CLI",
  ...
  "migration.whatsNew.features.foundation.detail":
    "แกนหลักขนาดเล็กและมีประสิทธิภาพเดียวกันในทุกผลิตภัณฑ์ Cypher ประสบการณ์ที่คุ้นเคยไม่ว่าคุณจะเลือกทำงานอย่างไร",
  ...
  "diffViewer.source.session.tooltip":
    "ไฟล์ที่ Cypher แก้ไขในช่วงเซสชันปัจจุบัน โดยอิงจากสแน็ปช็อตต่อเทิร์น จะรีเซ็ตเมื่อเริ่มเซสชันใหม่",
