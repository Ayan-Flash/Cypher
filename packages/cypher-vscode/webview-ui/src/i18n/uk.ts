export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Встановіть Anaconda Desktop на цьому комп'ютері, а потім поверніться сюди. Cypher не запускає інсталятор за вас.",
  ...
  "provider.anaconda.state.signedOut": "Відкрийте Anaconda Desktop та увійдіть перед підключенням Cypher.",
  "provider.anaconda.state.unauthorized":
    "Cypher не вдалося отримати доступ до Anaconda Desktop. Відкрийте Desktop, увійдіть знову та перезапустіть його за потреби.",
  ...
  "provider.anaconda.state.ready":
    "Cypher знайшов справний локальний сервер генерації тексту та може імпортувати його поточні налаштування підключення.",
  ...
  "provider.anaconda.toast.refreshed.description": "Активний локальний сервер та моделі актуальні в Cypher.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Cypher не зміг перевірити доступні навички.",
  "agentRequirements.error.mcpStatusFailed": "Cypher не зміг перевірити стан сервера MCP.",
  "agentRequirements.error.scopeMismatch": "Ця перевірка вимог агента більше не активна.",
  "agentRequirements.error.requestFailed": "Cypher не зміг перевірити вимоги агента.",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Cypher",
  ...
  "provider.connect.apiKey.description":
    "Введіть свій API-ключ {{provider}}, щоб підключити акаунт {{provider}} і використовувати моделі {{provider}} в Cypher.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " щоб отримати код авторизації для підключення акаунта та використання моделей {{provider}} у Cypher.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " та введіть код нижче, щоб підключити акаунт і використовувати моделі {{provider}} у Cypher.",
  ...
  "prompt.action.sandbox.enabled": "Пісочницю увімкнено. Команди оболонки агента обмежені каталогами проєкту та Cypher.",
  "prompt.action.sandbox.disabled":
    "Пісочницю вимкнено. Натисніть, щоб обмежити запис команд оболонки агента каталогами проєкту та Cypher.",
  ...
  "prompt.action.sandbox.description.enabled": "Запис дозволено лише в каталогах проєкту та Cypher.",
  ...
  "speechToText.tooltip.start": "Почати голосове введення з Cypher Gateway",
  ...
  "speechToText.error.loginRequired": "Увійдіть до Cypher, щоб використовувати голосове введення.",
  ...
  "dialog.server.description": "Змінити, до якого сервера Cypher підключається цей додаток.",
  ...
  "toast.update.description": "Нова версія Cypher ({{version}}) готова до встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Cypher",
  ...
  "error.chain.mcpFailed": 'MCP-сервер "{{name}}" зазнав помилки. Примітка: Cypher поки не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Cypher включає безкоштовні моделі, тому ви можете почати відразу.",
  ...
  "settings.general.row.language.description": "Змінити мову відображення Cypher",
  "settings.general.row.appearance.title": "Вигляд",
  "settings.general.row.appearance.description": "Налаштувати вигляд Cypher на вашому пристрої",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштувати тему Cypher.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти оновлення при запуску Cypher",
  ...
  "settings.updates.toast.latest.description": "У вас встановлена остання версія Cypher.",
  ...
  "settings.providers.betaNotice":
    "Наразі в інтерфейсі налаштувань можна налаштувати лише провайдера Cypher Gateway. Підтримка інших провайдерів з'явиться в бета-версії найближчим часом. Тим часом ви можете налаштовувати провайдерів через CLI або файл конфігурації. Cypher залишається відкритим — без прив'язки.",
  ...
  "settings.config.title": "Відкрити файл конфігурації Cypher ({{scope}})",
  "settings.config.placeholder":
    "Файли конфігурації об'єднуються по порядку; файли, позначені як завантажені, наразі впливають на налаштування.",
  "settings.config.noWorkspace": "Відкрийте папку робочої області, щоб відредагувати локальний файл конфігурації Cypher.",
  "settings.config.openFailed": "Не вдалося відкрити файл конфігурації Cypher ({{scope}}): {{message}}",
  "settings.config.source.xdg": "Глобальна конфігурація XDG",
  "settings.config.source.homeCypher": "Конфігурація .cypher (Home)",
  "settings.config.source.homeCyphercode": "Конфігурація .cypher (Home)",
  "settings.config.source.homeOpencode": "Конфігурація .opencode (Home)",
  "settings.config.source.envFile": "Файл середовища CYPHER_CONFIG",
  "settings.config.source.envDir": "CYPHER_CONFIG_DIR",
  "settings.config.source.envContent": "Вбудована конфігурація середовища",
  "settings.config.source.projectCypher": "Конфігурація .cypher проєкту",
  "settings.config.source.projectRoot": "Коренева конфігурація проєкту",
  "settings.config.source.projectCyphercode": "Застаріла конфігурація .cypher",
  ...
  "workStyle.onboarding.welcome": "Ласкаво просимо до Cypher",
  ...
  "workStyle.choice.human-in-the-loop.description": "Cypher призупиняється та показує свій план у процесі роботи.",
  ...
  "session.cloud.import.placeholder": "Ідентифікатор сесії, URL або команда cypher import",
  ...
  "deviceAuth.title": "Увійти до Cypher CLI",
  ...
  "profile.action.login": "Увійти через Cypher CLI",
  ...
  "profile.pass.subscribe": "Отримайте Cypher Pass, щоб додати кредити та заробляти бонуси",
  ...
  "settings.aboutCypher.title": "Про Cypher CLI",

  "session.messages.empty": "Напишіть повідомлення нижче, щоб розпочати чат.",
  "session.messages.welcome":
    "Cypher CLI — це асистент з кодування на базі ШІ. Попросіть його розробити функцію, виправити помилку або пояснити вашу кодову базу.",
  ...
  "settings.aboutCypher.status.connected": "Підключено",
  "settings.aboutCypher.status.connecting": "Підключення...",
  "settings.aboutCypher.status.disconnected": "Відключено",
  "settings.aboutCypher.status.error": "Помилка",
  "settings.aboutCypher.cliServer": "CLI-сервер",
  "settings.aboutCypher.status.label": "Статус:",
  "settings.aboutCypher.port.label": "Порт:",
  "settings.aboutCypher.versionInfo": "Інформація про версію",
  "settings.aboutCypher.version.label": "Версія:",
  "settings.aboutCypher.extensionName": "Розширення Cypher CLI",
  "settings.aboutCypher.community": "Спільнота і підтримка",
  "settings.aboutCypher.feedback.prefix": "Якщо у вас є питання або відгуки, будь ласка, відкрийте тікет на:",
  "settings.aboutCypher.feedback.or": "або",
  "settings.aboutCypher.support.prefix": "З питань виставлення рахунків або акаунту зверніться до служби підтримки:",
  "settings.aboutCypher.resetSettings.title": "Скидання налаштувань",
  ...
  "settings.aboutCypher.resetSettings.button": "Скинути всі налаштування",
  "settings.aboutCypher.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutCypher.settingsTransfer.title": "Перенесення налаштувань",
  ...
  "settings.aboutCypher.exportSettings": "Експортувати",
  "settings.aboutCypher.importSettings": "Імпортувати",
  "settings.aboutCypher.importSettings.invalidJson":
    "Недійсний файл JSON. Будь ласка, виберіть дійсний файл налаштувань.",
  "settings.aboutCypher.importSettings.invalidConfig": "Файл не містить дійсних налаштувань Cypher.",
  "settings.aboutCypher.importSettings.tooLarge": "Файл занадто великий. Файли налаштувань мають бути менше 1 МБ.",
  "settings.aboutCypher.importSettings.newerVersion":
    "Цей файл було експортовано з новішої версії Cypher. Деякі налаштування можуть бути проігноровані.",
  "settings.aboutCypher.importSettings.success":
    "Налаштування імпортовано. Перегляньте зміни вище, потім натисніть Зберегти.",

  "settings.aboutCypher.telemetry.title": "Телеметрія",
  ...
  "settings.aboutCypher.telemetry.openSettings": "Відкрити налаштування телеметрії",
  ...
  "settings.language.description":
    '"Автоматично" використовує мову відображення VS Code. Виберіть мову для інтерфейсу Cypher CLI.',
  ...
  "settings.experimental.speechToText.description":
    "Увімкніть голосове введення в полях запитів, використовуючи ваш обліковий запис Cypher через Cypher Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Увімкніть провайдер Cypher та виконайте вхід, щоб використовувати Speech to Text. Наразі Speech to Text підтримується лише з Cypher Gateway.",
  "settings.models.speechToTextModel.title": "Модель мовлення в текст",
  "settings.models.speechToTextModel.description": "Виберіть модель транскрипції Cypher Gateway для голосового введення.",
  ...
  "settings.experimental.remote.description":
    "Увімкніть керування Remote сеансами через Cypher Cloud. Це також вплине на CLI на цьому комп'ютері.",
  ...
  "settings.sandboxing.enabled.description":
    "Виконувати команди оболонки агента в пісочниці на рівні ОС, яка обмежує запис до каталогів стану проєкту та Cypher",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Завантажувати інструкції та навички CLAUDE.md з вашого каталогу конфігурації Claude Code у сесії. Увімкніть це, якщо ви хочете, щоб Cypher використовував ваші інструкції та навички Claude Code. Потребує перезапуску.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP-серверів не налаштовано. Додайте MCP-сервери до cypher.jsonc або попросіть агента додати їх.",
  ...
  "settings.display.fontSize.description": "Налаштуйте розмір шрифту webview UI для Cypher незалежно від VS Code.",
  ...
  "settings.models.hidePromptTraining.description":
    "Приховувати моделі Cypher Gateway, постачальники яких можуть використовувати ваші запити для навчання.",
  ...
  "settings.aboutCypher.legacyMigration.title": "Перенесення зі старої версії",
  "settings.aboutCypher.legacyMigration.description":
    "Перенести налаштування з попередньої версії Cypher CLI, включаючи API-ключі провайдерів та стандартну модель.",
  "settings.aboutCypher.rooImport.description": "Імпортувати історію розмов з інсталяції Roo Code.",
  "settings.aboutCypher.rooImport.button": "Імпортувати сесії з Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Що нового в Cypher CLI",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Малий та ефективний ядерний модуль у кожному продукті Cypher. Знайомий досвід незалежно від того, як ви вважаєте за краще працювати.",
  ...
  "settings.indexing.cypherModel.title": "Пресет моделі Cypher",
  "settings.indexing.cypherModel.description": "Виберіть підтримувану модель Cypher-hosted embeddings.",
  "settings.indexing.cypherSignIn.title": "Потрібен вхід у Cypher",
  "settings.indexing.cypherSignIn.description": "Увійдіть у Cypher, щоб використовувати hosted embeddings.",
  ...
  "diffViewer.source.session.tooltip":
    "Файли, змінені Cypher під час поточної сесії, на основі знімків по ходу. Скидається при старті нової сесії.",
