export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installez Anaconda Desktop sur cette machine, puis revenez ici. Cypher n’exécute pas l’installateur à votre place.",
  ...
  "provider.anaconda.state.signedOut": "Ouvrez Anaconda Desktop et connectez-vous avant de connecter Cypher.",
  "provider.anaconda.state.unauthorized":
    "Cypher n’a pas pu accéder à Anaconda Desktop. Ouvrez Desktop, reconnectez-vous et redémarrez-le si nécessaire.",
  ...
  "provider.anaconda.state.ready":
    "Cypher a trouvé un serveur local sain de génération de texte et peut importer ses paramètres de connexion actuels.",
  ...
  "provider.anaconda.toast.refreshed.description": "Le serveur local actif et les modèles sont à jour dans Cypher.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Cypher n’a pas pu vérifier les compétences disponibles.",
  "agentRequirements.error.mcpStatusFailed": "Cypher n’a pas pu vérifier l’état du serveur MCP.",
  "agentRequirements.error.scopeMismatch": "Cette vérification des prérequis de l’agent n’est plus active.",
  "agentRequirements.error.requestFailed": "Cypher n’a pas pu vérifier les prérequis de l’agent.",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Cypher",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Cypher.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Cypher.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Cypher.",
  ...
  "prompt.action.sandbox.enabled":
    "Le sandbox est activé. Les commandes shell de l'agent sont limitées aux répertoires du projet et de Cypher.",
  "prompt.action.sandbox.disabled":
    "Le sandbox est désactivé. Cliquez pour limiter les écritures des commandes shell de l'agent aux répertoires du projet et de Cypher.",
  ...
  "prompt.action.sandbox.description.enabled": "Les écritures sont limitées aux répertoires du projet et de Cypher.",
  ...
  "speechToText.tooltip.start": "Démarrer la saisie vocale avec Cypher Gateway",
  ...
  "speechToText.error.loginRequired": "Connectez-vous à Cypher pour utiliser la saisie vocale.",
  ...
  "dialog.server.description": "Changez le serveur Cypher auquel cette application se connecte.",
  ...
  "toast.update.description": "Une nouvelle version d'Cypher ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Cypher",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Cypher ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "Cypher inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Cypher",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Cypher sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Cypher.",
  ...
  "settings.indexing.cypherModel.title": "Préréglage de modèle Cypher",
  "settings.indexing.cypherModel.description": "Choisissez un modèle d'embedding hébergé par Cypher pris en charge.",
  "settings.indexing.cypherSignIn.title": "Connexion à Cypher requise",
  "settings.indexing.cypherSignIn.description": "Connectez-vous à Cypher pour utiliser les embeddings hébergés.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Cypher",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Cypher.",
  ...
  "settings.providers.betaNotice":
    "Actuellement, seul le fournisseur Cypher Gateway peut être configuré dans l'interface des paramètres. La prise en charge de la configuration d'autres fournisseurs sera bientôt disponible pendant la période bêta. En attendant, vous pouvez configurer les fournisseurs à l'aide de la CLI ou du fichier de configuration. Nous nous engageons à maintenir Cypher ouvert, sans enfermement propriétaire.",
  ...
  "settings.models.hidePromptTraining.description":
    "Masquez les modèles Cypher Gateway dont les fournisseurs peuvent utiliser vos prompts à des fins d'entraînement.",
  ...
  "settings.config.title": "Ouvrir le fichier de configuration Cypher {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Ouvrez un dossier d'espace de travail pour modifier le fichier de configuration Cypher local.",
  "settings.config.openFailed": "Échec de l'ouverture du fichier de configuration Cypher {{scope}} : {{message}}",
  "settings.config.source.xdg": "Configuration globale XDG",
  "settings.config.source.homeCypher": "Configuration .cypher de Home",
  "settings.config.source.homeCyphercode": "Configuration .cypher de Home",
  "settings.config.source.homeOpencode": "Configuration .opencode de Home",
  "settings.config.source.envFile": "Fichier d'environnement CYPHER_CONFIG",
  "settings.config.source.envDir": "CYPHER_CONFIG_DIR",
  "settings.config.source.envContent": "Configuration d'environnement en ligne",
  "settings.config.source.projectCypher": "Configuration .cypher du projet",
  "settings.config.source.projectRoot": "Configuration racine du projet",
  "settings.config.source.projectCyphercode": "Configuration obsolète .cypher",
  ...
  "workStyle.onboarding.welcome": "Bienvenue dans Cypher",
  ...
  "workStyle.choice.human-in-the-loop.description":
    "Cypher s'interrompt et vous présente son plan au fil de son travail.",
  ...
  "session.cloud.import.placeholder": "ID de session, URL ou commande cypher import",
  ...
  "deviceAuth.title": "Se connecter à Cypher CLI",
  ...
  "profile.action.login": "Se connecter avec Cypher CLI",
  ...
  "profile.pass.subscribe": "Obtenez Cypher Pass pour ajouter des crédits et gagner des bonus",
  ...
  "settings.aboutCypher.title": "À propos de Cypher CLI",

  "session.messages.empty": "Commencez une conversation en tapant un message ci-dessous.",
  "session.messages.welcome":
    "Cypher CLI est un assistant de programmation IA. Demandez-lui de créer des fonctionnalités, corriger des bugs ou expliquer votre code.",
  ...
  "settings.aboutCypher.status.connected": "Connecté",
  "settings.aboutCypher.status.connecting": "Connexion en cours...",
  "settings.aboutCypher.status.disconnected": "Déconnecté",
  "settings.aboutCypher.status.error": "Erreur",
  "settings.aboutCypher.cliServer": "Serveur CLI",
  "settings.aboutCypher.status.label": "Statut :",
  "settings.aboutCypher.port.label": "Port :",
  "settings.aboutCypher.versionInfo": "Informations de version",
  "settings.aboutCypher.version.label": "Version :",
  "settings.aboutCypher.extensionName": "Extension Cypher CLI",
  "settings.aboutCypher.community": "Communauté et support",
  "settings.aboutCypher.feedback.prefix":
    "Si vous avez des questions ou des commentaires, n'hésitez pas à ouvrir un ticket sur",
  "settings.aboutCypher.feedback.or": "ou",
  "settings.aboutCypher.support.prefix":
    "Pour les questions de facturation ou de compte, contactez le support client à",
  "settings.aboutCypher.resetSettings.title": "Réinitialiser les paramètres",
  ...
  "settings.aboutCypher.resetSettings.button": "Réinitialiser tous les paramètres",
  "settings.aboutCypher.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutCypher.settingsTransfer.title": "Transfert des paramètres",
  ...
  "settings.aboutCypher.exportSettings": "Exporter",
  "settings.aboutCypher.importSettings": "Importer",
  ...
  "settings.aboutCypher.importSettings.invalidConfig": "Le fichier ne contient pas de paramètres Cypher valides.",
  ...
  "settings.aboutCypher.importSettings.newerVersion":
    "Ce fichier a été exporté depuis une version plus récente de Cypher. Certains paramètres pourraient être ignorés.",
  ...
  "settings.aboutCypher.telemetry.title": "Télémétrie",
  ...
  "settings.aboutCypher.telemetry.openSettings": "Ouvrir les paramètres de télémétrie",
  ...
  "settings.language.description":
    "Choisissez la langue de l'interface de Cypher CLI. \"Auto\" utilise la langue d'affichage de VS Code.",
  ...
  "settings.experimental.speechToText.description":
    "Activez la saisie vocale dans les champs de prompt en utilisant votre compte Cypher via Cypher Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Activez et connectez-vous au fournisseur Cypher pour utiliser Speech to Text. Speech to Text n'est actuellement pris en charge qu'avec Cypher Gateway.",
  "settings.models.speechToTextModel.title": "Modèle de transcription vocale",
  "settings.models.speechToTextModel.description":
    "Choisissez le modèle de transcription Cypher Gateway pour la saisie vocale.",
  ...
  "settings.experimental.remote.description":
    "Activez le contrôle Remote des sessions via Cypher Cloud. Cela affectera également les CLI sur cette machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Charge les instructions et les compétences de CLAUDE.md depuis votre répertoire de configuration Claude Code dans les sessions. Activez cette option si vous souhaitez que Cypher utilise vos instructions et compétences Claude Code. Nécessite un redémarrage.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Aucun serveur MCP configuré. Ajoutez des serveurs MCP dans cypher.jsonc ou demandez à l'agent de les ajouter.",
  ...
  "settings.sandboxing.enabled.description":
    "Exécuter les commandes shell de l'agent dans un sandbox au niveau du système d'exploitation qui restreint les écritures aux répertoires d'état du projet et de Cypher",
  ...
  "settings.display.fontSize.description":
    "Ajustez la taille de la police de la webview UI de Cypher indépendamment de VS Code.",
  ...
  "settings.aboutCypher.legacyMigration.title": "Migration de l'ancienne version",
  "settings.aboutCypher.legacyMigration.description":
    "Migrer les paramètres d'une précédente installation de Cypher CLI, y compris les clés d'API des fournisseurs et le modèle par défaut.",
  "settings.aboutCypher.rooImport.description":
    "Importer l'historique des conversations depuis une installation de Roo Code.",
  "settings.aboutCypher.rooImport.button": "Importer les sessions depuis Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nouveautés de Cypher CLI",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un noyau petit et efficace partagé par tous les produits Cypher. Une expérience familière quelle que soit votre façon de travailler.",
  ...
  "diffViewer.source.session.tooltip":
    "Fichiers modifiés par Cypher pendant la session actuelle, basé sur des snapshots par tour. Réinitialisé lors du démarrage d'une nouvelle session.",
