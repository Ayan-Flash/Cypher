...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installieren Sie Anaconda Desktop auf diesem Computer und kehren Sie dann hierher zurück. Cypher führt das Installationsprogramm nicht für Sie aus.",
  ...
  "provider.anaconda.state.signedOut": "Öffnen Sie Anaconda Desktop und melden Sie sich an, bevor Sie Cypher verbinden.",
  "provider.anaconda.state.unauthorized":
    "Cypher konnte nicht auf Anaconda Desktop zugreifen. Öffnen Sie Desktop, melden Sie sich erneut an und starten Sie es bei Bedarf neu.",
  ...
  "provider.anaconda.state.ready":
    "Cypher hat einen funktionsfähigen lokalen Textgenerierungsserver gefunden und kann dessen aktuelle Verbindungseinstellungen importieren.",
  ...
  "provider.anaconda.toast.refreshed.description":
    "Der aktive lokale Server und die Modelle sind in Cypher auf dem neuesten Stand.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Cypher konnte die verfügbaren Skills nicht prüfen.",
  "agentRequirements.error.mcpStatusFailed": "Cypher konnte den MCP-Serverstatus nicht prüfen.",
  "agentRequirements.error.scopeMismatch": "Diese Prüfung der Agentenanforderungen ist nicht mehr aktiv.",
  "agentRequirements.error.requestFailed": "Cypher konnte die Agentenanforderungen nicht prüfen.",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Cypher",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Cypher zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Cypher zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Cypher zu nutzen.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox ist aktiviert. Shell-Befehle des Agenten sind auf die Projekt- und Cypher-Verzeichnisse beschränkt.",
  "prompt.action.sandbox.disabled":
    "Sandbox ist deaktiviert. Klicken, um Schreibvorgänge der Shell-Befehle des Agenten auf die Projekt- und Cypher-Verzeichnisse zu beschränken.",
  ...
  "prompt.action.sandbox.description.enabled":
    "Schreibvorgänge sind auf die Projekt- und Cypher-Verzeichnisse beschränkt.",
  ...
  "speechToText.tooltip.start": "Spracheingabe mit Cypher Gateway starten",
  ...
  "speechToText.error.loginRequired": "Melden Sie sich bei Cypher an, um die Spracheingabe zu verwenden.",
  ...
  "dialog.server.description": "Wechseln Sie den Cypher-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Cypher ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Cypher-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Cypher unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Cypher enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Cypher ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Cypher auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Cypher anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Cypher automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Cypher.",
  ...
  "settings.indexing.cypherModel.title": "Cypher-Modellvoreinstellung",
  "settings.indexing.cypherModel.description": "Wählen Sie ein unterstütztes von Cypher gehostetes Embedding-Modell.",
  "settings.indexing.cypherSignIn.title": "Cypher-Anmeldung erforderlich",
  "settings.indexing.cypherSignIn.description": "Melden Sie sich bei Cypher an, um gehostete Embeddings zu verwenden.",
  ...
  "settings.models.hidePromptTraining.description":
    "Blendet Cypher-Gateway-Modelle aus, deren Anbieter Ihre Prompts möglicherweise zum Training verwenden.",
  ...
  "settings.config.title": "{{scope}} Cypher-Konfigurationsdatei öffnen",
  ...
  "settings.config.noWorkspace":
    "Öffnen Sie einen Arbeitsbereichsordner, um die lokale Cypher-Konfigurationsdatei zu bearbeiten.",
  "settings.config.openFailed": "Fehler beim Öffnen der {{scope}} Cypher-Konfigurationsdatei: {{message}}",
  "settings.config.source.xdg": "Globale XDG-Konfiguration",
  "settings.config.source.homeCypher": "Home .cypher-Konfiguration",
  "settings.config.source.homeCyphercode": "Home .cypher-Konfiguration",
  "settings.config.source.homeOpencode": "Home .opencode-Konfiguration",
  "settings.config.source.envFile": "CYPHER_CONFIG Umgebungsdatei",
  "settings.config.source.envDir": "CYPHER_CONFIG_DIR",
  "settings.config.source.envContent": "Inline-Umgebungskonfiguration",
  "settings.config.source.projectCypher": "Projekt .cypher-Konfiguration",
  "settings.config.source.projectRoot": "Projektstamm-Konfiguration",
  "settings.config.source.projectCyphercode": "Veraltete .cypher-Konfiguration",
  ...
  "workStyle.onboarding.welcome": "Willkommen bei Cypher",
  ...
  "workStyle.choice.human-in-the-loop.description": "Cypher pausiert und zeigt dir während der Arbeit seinen Plan.",
  ...
  "session.cloud.import.placeholder": "Sitzungs-ID, URL oder cypher import-Befehl",
  ...
  "deviceAuth.title": "Bei Cypher CLI anmelden",
  ...
  "profile.action.login": "Mit Cypher CLI anmelden",
  ...
  "profile.pass.subscribe": "Hol dir Cypher Pass, um Guthaben hinzuzufügen und Boni zu verdienen",
  ...
  "settings.aboutCypher.title": "Über Cypher CLI",

  "session.messages.empty": "Starten Sie eine Unterhaltung, indem Sie unten eine Nachricht eingeben.",
  "session.messages.welcome":
    "Cypher CLI ist ein KI-Programmierassistent. Bitten Sie ihn, Funktionen zu erstellen, Fehler zu beheben oder Ihre Codebasis zu erklären.",
  ...
  "settings.aboutCypher.status.connected": "Verbunden",
  "settings.aboutCypher.status.connecting": "Verbindung wird hergestellt...",
  "settings.aboutCypher.status.disconnected": "Getrennt",
  "settings.aboutCypher.status.error": "Fehler",
  "settings.aboutCypher.cliServer": "CLI-Server",
  "settings.aboutCypher.status.label": "Status:",
  "settings.aboutCypher.port.label": "Port:",
  "settings.aboutCypher.versionInfo": "Versionsinformationen",
  "settings.aboutCypher.version.label": "Version:",
  "settings.aboutCypher.extensionName": "Cypher CLI Erweiterung",
  "settings.aboutCypher.community": "Community & Support",
  "settings.aboutCypher.feedback.prefix": "Bei Fragen oder Feedback können Sie ein Issue eröffnen auf",
  "settings.aboutCypher.feedback.or": "oder",
  "settings.aboutCypher.support.prefix":
    "Bei Abrechnungs- oder Kontofragen wenden Sie sich an den Kundensupport unter",
  "settings.aboutCypher.resetSettings.title": "Einstellungen zurücksetzen",
  ...
  "settings.aboutCypher.resetSettings.button": "Alle Einstellungen zurücksetzen",
  "settings.aboutCypher.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutCypher.settingsTransfer.title": "Einstellungen übertragen",
  ...
  "settings.aboutCypher.exportSettings": "Exportieren",
  "settings.aboutCypher.importSettings": "Importieren",
  "settings.aboutCypher.importSettings.invalidJson":
    "Ungültige JSON-Datei. Bitte wählen Sie eine gültige Einstellungsdatei aus.",
  "settings.aboutCypher.importSettings.invalidConfig": "Die Datei enthält keine gültigen Cypher-Einstellungen.",
  ...
  "settings.aboutCypher.importSettings.newerVersion":
    "Diese Datei wurde mit einer neueren Version von Cypher exportiert. Einige Einstellungen werden möglicherweise ignoriert.",
  ...
  "settings.aboutCypher.telemetry.openSettings": "Telemetrie-Einstellungen öffnen",
  ...
  "settings.language.description":
    'Wählen Sie die Sprache für die Cypher CLI Oberfläche. „Auto" verwendet die VS Code Anzeigesprache.',
  ...
  "settings.experimental.speechToText.description":
    "Aktivieren Sie die Spracheingabe in Prompt-Feldern mit Ihrem Cypher-Konto über Cypher Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Aktivieren Sie den Cypher-Anbieter und melden Sie sich an, um Speech to Text zu verwenden. Speech to Text wird derzeit nur mit Cypher Gateway unterstützt.",
  "settings.models.speechToTextModel.title": "Sprache-zu-Text-Modell",
  "settings.models.speechToTextModel.description":
    "Wählen Sie das Cypher Gateway-Transkriptionsmodell für die Spracheingabe.",
  ...
  "settings.experimental.remote.description":
    "Aktivieren Sie die Remote-Steuerung von Sitzungen über Cypher Cloud. Dies betrifft auch CLIs auf diesem Computer.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Lädt CLAUDE.md-Anweisungen und Skills aus Ihrem Claude Code-Konfigurationsverzeichnis in Sitzungen. Aktivieren Sie dies, wenn Cypher Ihre Claude Code-Anweisungen und Skills verwenden soll. Neustart erforderlich.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Keine MCP-Server konfiguriert. Fügen Sie MCP-Server in cypher.jsonc hinzu oder bitten Sie den Agenten, sie hinzuzufügen.",
  ...
  "settings.sandboxing.enabled.description":
    "Shell-Befehle des Agenten in einer Sandbox auf Betriebssystemebene ausführen, die Schreibvorgänge auf die Projekt- und Cypher-Statusverzeichnisse beschränkt",
  ...
  "settings.display.fontSize.description": "Passen Sie die Schriftgröße der Cypher webview UI unabhängig von VS Code an.",
  ...
  "settings.aboutCypher.legacyMigration.title": "Legacy-Migration",
  "settings.aboutCypher.legacyMigration.description":
    "Migrieren Sie Einstellungen von einer früheren Installation von Cypher CLI, einschließlich Anbieter-API-Schlüsseln und dem Standardmodell.",
  "settings.aboutCypher.rooImport.description":
    "Importieren Sie den Konversationsverlauf von einer Installation von Roo Code.",
  "settings.aboutCypher.rooImport.button": "Sitzungen aus Roo Code importieren",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Neuigkeiten in Cypher CLI",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Ein kleiner, effizienter Kern über alle Cypher-Produkte hinweg. Ein vertrautes Erlebnis, egal wie Sie arbeiten.",
  ...
  "diffViewer.source.session.tooltip":
    "Von Cypher während der aktuellen Sitzung geänderte Dateien, basierend auf Snapshots pro Runde. Wird beim Start einer neuen Sitzung zurückgesetzt.",
