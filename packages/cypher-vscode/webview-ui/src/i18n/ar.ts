export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "ثبّت Anaconda Desktop على هذا الجهاز، ثم عُد إلى هنا. لا يقوم Cypher بتشغيل المثبّت نيابةً عنك.",
  ...
  "provider.anaconda.state.signedOut": "افتح Anaconda Desktop وسجّل الدخول قبل توصيل Cypher.",
  "provider.anaconda.state.unauthorized":
    "تعذّر على Cypher الوصول إلى Anaconda Desktop. افتح Desktop، وسجّل الدخول مرة أخرى، وأعد تشغيله إذا لزم الأمر.",
  ...
  "provider.anaconda.state.ready":
    "عثر Cypher على خادم محلي سليم لتوليد النصوص ويمكنه استيراد إعدادات الاتصال الحالية الخاصة به.",
  ...
  "provider.anaconda.toast.refreshed.description": "الخادم المحلي النشط والنماذج محدّثة في Cypher.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "تعذر على Cypher فحص المهارات المتاحة.",
  "agentRequirements.error.mcpStatusFailed": "تعذر على Cypher فحص حالة خادم MCP.",
  "agentRequirements.error.scopeMismatch": "لم يعد فحص متطلبات هذا الوكيل نشطًا.",
  "agentRequirements.error.requestFailed": "تعذر على Cypher فحص متطلبات الوكيل.",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Cypher",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Cypher.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Cypher.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Cypher.",
  ...
  "prompt.action.sandbox.enabled": "sandbox مُفعّل. أوامر shell الخاصة بالوكيل مقتصرة على مجلدات المشروع و Cypher.",
  "prompt.action.sandbox.disabled":
    "sandbox مُعطّل. انقر لتقييد كتابة أوامر shell الخاصة بالوكيل على مجلدات المشروع و Cypher.",
  ...
  "prompt.action.sandbox.description.enabled": "تقتصر عمليات الكتابة على مجلدات المشروع و Cypher.",
  ...
  "speechToText.tooltip.start": "بدء الإدخال الصوتي باستخدام Cypher Gateway",
  ...
  "speechToText.error.loginRequired": "قم بتسجيل الدخول إلى Cypher لاستخدام الإدخال الصوتي.",
  ...
  "dialog.server.description": "تبديل خادم Cypher الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من Cypher ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Cypher",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Cypher لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Cypher نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Cypher",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Cypher على جهازك",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Cypher.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Cypher",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Cypher.",
  ...
  "settings.providers.betaNotice":
    "حالياً، يمكن إعداد مزود Cypher Gateway فقط في واجهة الإعدادات. سيتوفر دعم إعداد المزودين الآخرين قريباً خلال الفترة التجريبية. في غضون ذلك، يمكنك إعداد المزودين باستخدام CLI أو ملف التكوين. نحن ملتزمون بإبقاء Cypher مفتوحاً، دون تقييد.",
  ...
  "settings.models.hidePromptTraining.description":
    "إخفاء نماذج Cypher Gateway التي قد يستخدم مزودوها مطالباتك لأغراض التدريب.",
  ...
  "settings.config.title": "فتح ملف تكوين Cypher {{scope}}",
  "settings.config.placeholder": "يتم دمج ملفات التكوين بالترتيب؛ الملفات المحددة كمحملة تؤثر حاليًا على الإعدادات.",
  "settings.config.noWorkspace": "افتح مجلد مساحة عمل لتحرير ملف تكوين Cypher المحلي.",
  "settings.config.openFailed": "فشل فتح ملف تكوين Cypher {{scope}}: {{message}}",
  "settings.config.source.xdg": "تكوين XDG العالمي",
  "settings.config.source.homeCypher": "تكوين .cypher في Home",
  "settings.config.source.homeCyphercode": "تكوين .cypher في Home",
  "settings.config.source.homeOpencode": "تكوين .opencode في Home",
  "settings.config.source.envFile": "ملف بيئة CYPHER_CONFIG",
  "settings.config.source.envDir": "CYPHER_CONFIG_DIR",
  "settings.config.source.envContent": "تكوين البيئة المضمن",
  "settings.config.source.projectCypher": "تكوين .cypher للمشروع",
  "settings.config.source.projectRoot": "تكوين جذر المشروع",
  "settings.config.source.projectCyphercode": "تكوين .cypher القديم",
  ...
  "workStyle.onboarding.welcome": "مرحبًا بك في Cypher",
  ...
  "workStyle.choice.human-in-the-loop.description": "يتوقف Cypher مؤقتًا ويعرض لك خطته أثناء العمل.",
  ...
  "session.cloud.import.placeholder": "معرّف الجلسة أو الرابط أو أمر cypher import",
  ...
  "deviceAuth.title": "تسجيل الدخول إلى Cypher CLI",
  ...
  "profile.action.login": "تسجيل الدخول باستخدام Cypher CLI",
  ...
  "profile.pass.subscribe": "احصل على Cypher Pass لإضافة رصيد وكسب مكافآت",
  ...
  "settings.indexing.cypherModel.title": "إعداد مسبق لنموذج Cypher",
  "settings.indexing.cypherModel.description": "اختر نموذج تضمين مدعومًا ومستضافًا بواسطة Cypher.",
  "settings.indexing.cypherSignIn.title": "تسجيل الدخول إلى Cypher مطلوب",
  "settings.indexing.cypherSignIn.description": "سجّل الدخول إلى Cypher لاستخدام التضمينات المستضافة.",
  ...
  "settings.aboutCypher.title": "حول Cypher CLI",

  "session.messages.empty": "ابدأ محادثة بكتابة رسالة أدناه.",
  "session.messages.welcome":
    "Cypher CLI هو مساعد ترميز بالذكاء الاصطناعي. اطلب منه بناء ميزات أو إصلاح أخطاء أو شرح قاعدة الشيفرة.",
  ...
  "settings.aboutCypher.status.connected": "متصل",
  "settings.aboutCypher.status.connecting": "جارٍ الاتصال...",
  "settings.aboutCypher.status.disconnected": "غير متصل",
  "settings.aboutCypher.status.error": "خطأ",
  "settings.aboutCypher.cliServer": "خادم CLI",
  "settings.aboutCypher.status.label": "الحالة:",
  "settings.aboutCypher.port.label": "المنفذ:",
  "settings.aboutCypher.versionInfo": "معلومات الإصدار",
  "settings.aboutCypher.version.label": "الإصدار:",
  "settings.aboutCypher.extensionName": "إضافة Cypher CLI",
  "settings.aboutCypher.community": "المجتمع والدعم",
  "settings.aboutCypher.feedback.prefix": "إذا كان لديك أي أسئلة أو ملاحظات، لا تتردد في فتح مشكلة على",
  "settings.aboutCypher.feedback.or": "أو",
  "settings.aboutCypher.support.prefix": "لأسئلة الفوترة أو الحساب، تواصل مع دعم العملاء على",
  "settings.aboutCypher.resetSettings.title": "إعادة تعيين الإعدادات",
  ...
  "settings.aboutCypher.resetSettings.button": "إعادة تعيين جميع الإعدادات",
  "settings.aboutCypher.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutCypher.settingsTransfer.title": "نقل الإعدادات",
  "settings.aboutCypher.settingsTransfer.description": "تصدير أو استيراد إعداداتك لنقلها بين نُسخ VS Code.",
  "settings.aboutCypher.exportSettings": "تصدير",
  "settings.aboutCypher.importSettings": "استيراد",
  "settings.aboutCypher.importSettings.invalidJson": "ملف JSON غير صالح. يرجى اختيار ملف إعدادات صالح.",
  "settings.aboutCypher.importSettings.invalidConfig": "الملف لا يحتوي على إعدادات Cypher صالحة.",
  "settings.aboutCypher.importSettings.tooLarge": "الملف كبير جدًا. يجب أن تكون ملفات الإعدادات أقل من 1 MB.",
  "settings.aboutCypher.importSettings.newerVersion":
    "تم تصدير هذا الملف من إصدار أحدث من Cypher. قد يتم تجاهل بعض الإعدادات.",
  "settings.aboutCypher.importSettings.success": "تم استيراد الإعدادات. راجع التغييرات أعلاه، ثم انقر على حفظ.",
  ...
  "settings.aboutCypher.telemetry.openSettings": "فتح إعدادات Telemetry",
  ...
  "settings.language.description": 'اختر اللغة لواجهة Cypher CLI. "تلقائي" يستخدم لغة عرض VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "تمكين الإدخال الصوتي في حقول المطالبة باستخدام حساب Cypher الخاص بك من خلال Cypher Gateway.",
  "settings.models.speechToText.disabledDescription":
    "قم بتمكين وتسجيل الدخول إلى مزود Cypher لاستخدام Speech to Text. ميزة Speech to Text مدعومة حاليًا فقط مع Cypher Gateway.",
  "settings.models.speechToTextModel.title": "نموذج تحويل الصوت إلى نص",
  "settings.models.speechToTextModel.description": "اختر نموذج نسخ Cypher Gateway للإدخال الصوتي.",
  ...
  "settings.experimental.remote.description":
    "قم بتمكين التحكم Remote في الجلسات عبر Cypher Cloud. سيؤثر هذا أيضًا على واجهات سطر الأوامر (CLIs) على هذا الجهاز.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "تحميل تعليمات ومهارات CLAUDE.md من مجلد إعدادات Claude Code إلى الجلسات. قم بتمكين هذا الخيار إذا كنت ترغب في أن يستخدم Cypher مهارات وتعليمات Claude Code الخاصة بك. يتطلب إعادة التشغيل.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "لم يتم تهيئة خوادم MCP. أضف خوادم MCP في cypher.jsonc، أو اطلب من الوكيل إضافتها لك.",
  ...
  "settings.sandboxing.enabled.description":
    "تشغيل أوامر shell الخاصة بالوكيل داخل sandbox على مستوى نظام التشغيل يقيّد الكتابة على مجلدات حالة المشروع و Cypher",
  ...
  "settings.display.fontSize.description": "اضبط حجم خط webview UI الخاص بـ Cypher بشكل مستقل عن VS Code.",
  ...
  "settings.aboutCypher.legacyMigration.title": "ترحيل الإصدار القديم",
  "settings.aboutCypher.legacyMigration.description":
    "ترحيل الإعدادات من تثبيت سابق لـ Cypher CLI، بما في ذلك مفاتيح API لمقدمي الخدمة والنموذج الافتراضي.",
  "settings.aboutCypher.rooImport.description": "استيراد سجل المحادثات من تثبيت Roo Code.",
  "settings.aboutCypher.rooImport.button": "استيراد الجلسات من Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "ما الجديد في Cypher CLI",
  ...
  "migration.whatsNew.features.foundation.detail":
    "نواة صغيرة وفعالة واحدة عبر كل منتجات Cypher. تجربة مألوفة بغض النظر عن طريقة عملك.",
  ...
  "diffViewer.source.session.tooltip":
    "الملفات التي غيّرها Cypher خلال الجلسة الحالية، بناءً على لقطات لكل دور. يُعاد ضبطها عند بدء جلسة جديدة.",
