export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Instale o Anaconda Desktop nesta máquina e depois volte aqui. O Cypher não executa o instalador para você.",
  ...
  "provider.anaconda.state.signedOut": "Abra o Anaconda Desktop e faça login antes de conectar o Cypher.",
  "provider.anaconda.state.unauthorized":
    "O Cypher não conseguiu acessar o Anaconda Desktop. Abra o Desktop, faça login novamente e reinicie-o se necessário.",
  ...
  "provider.anaconda.state.ready":
    "O Cypher encontrou um servidor local saudável de geração de texto e pode importar suas configurações de conexão atuais.",
  ...
  "provider.anaconda.toast.refreshed.description": "O servidor local ativo e os modelos estão atualizados no Cypher.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "O Cypher não conseguiu verificar as skills disponíveis.",
  "agentRequirements.error.mcpStatusFailed": "O Cypher não conseguiu verificar o status do servidor MCP.",
  "agentRequirements.error.scopeMismatch": "Esta verificação de requisitos do agente não está mais ativa.",
  "agentRequirements.error.requestFailed": "O Cypher não conseguiu verificar os requisitos do agente.",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Cypher",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Cypher.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Cypher.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Cypher.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox ativado. Os comandos shell do agente estão limitados aos diretórios do projeto e do Cypher.",
  "prompt.action.sandbox.disabled":
    "Sandbox desativado. Clique para limitar as escritas dos comandos shell do agente aos diretórios do projeto e do Cypher.",
  ...
  "prompt.action.sandbox.description.enabled":
    "As operações de escrita são limitadas aos diretórios do projeto e do Cypher.",
  ...
  "speechToText.tooltip.start": "Iniciar entrada de voz com o Cypher Gateway",
  ...
  "speechToText.error.loginRequired": "Faça login no Cypher para usar a entrada de voz.",
  ...
  "dialog.server.description": "Trocar para qual servidor Cypher este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Cypher ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Cypher",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Cypher ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Cypher inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Cypher",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Cypher aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Cypher é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Cypher iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Cypher.",
  ...
  "settings.providers.betaNotice":
    "Atualmente, apenas o provedor Cypher Gateway pode ser configurado na interface de configurações. O suporte para a configuração de outros provedores estará disponível em breve durante o período beta. Enquanto isso, você pode configurar provedores usando a CLI ou o arquivo de configuração. Estamos comprometidos em manter o Cypher aberto, sem lock-in.",
  ...
  "settings.models.hidePromptTraining.description":
    "Oculte os modelos do Cypher Gateway cujos provedores podem usar seus prompts para treinamento.",
  ...
  "settings.config.title": "Abrir arquivo de configuração {{scope}} do Cypher",
  ...
  "settings.config.noWorkspace":
    "Abra uma pasta de espaço de trabalho para editar o arquivo de configuração local do Cypher.",
  "settings.config.openFailed": "Falha ao abrir o arquivo de configuração {{scope}} do Cypher: {{message}}",
  "settings.config.source.xdg": "Configuração global do XDG",
  "settings.config.source.homeCypher": "Configuração .cypher da Home",
  "settings.config.source.homeCyphercode": "Configuração .cypher da Home",
  "settings.config.source.homeOpencode": "Configuração .opencode da Home",
  "settings.config.source.envFile": "Arquivo de ambiente CYPHER_CONFIG",
  "settings.config.source.envDir": "CYPHER_CONFIG_DIR",
  "settings.config.source.envContent": "Configuração de ambiente embutida",
  "settings.config.source.projectCypher": "Configuração .cypher do projeto",
  "settings.config.source.projectRoot": "Configuração raiz do projeto",
  "settings.config.source.projectCyphercode": "Configuração .cypher legada",
  ...
  "workStyle.onboarding.welcome": "Boas-vindas ao Cypher",
  ...
  "workStyle.choice.human-in-the-loop.description": "O Cypher pausa e mostra o plano enquanto trabalha.",
  ...
  "session.cloud.import.placeholder": "ID da sessão, URL ou comando cypher import",
  ...
  "deviceAuth.title": "Entrar no Cypher CLI",
  ...
  "profile.action.login": "Entrar com Cypher CLI",
  ...
  "profile.pass.subscribe": "Obtenha o Cypher Pass para adicionar créditos e ganhar bônus",
  ...
  "settings.indexing.cypherModel.title": "Predefinição de modelo do Cypher",
  "settings.indexing.cypherModel.description": "Escolha um modelo de embedding hospedado pelo Cypher compatível.",
  "settings.indexing.cypherSignIn.title": "Login no Cypher necessário",
  "settings.indexing.cypherSignIn.description": "Entre no Cypher para usar embeddings hospedados.",
  ...
  "settings.aboutCypher.title": "Sobre o Cypher CLI",

  "session.messages.empty": "Inicie uma conversa digitando uma mensagem abaixo.",
  "session.messages.welcome":
    "Cypher CLI é um assistente de programação com IA. Peça para criar funcionalidades, corrigir bugs ou explicar sua base de código.",
  ...
  "settings.aboutCypher.status.error": "Erro",
  "settings.aboutCypher.cliServer": "Servidor CLI",
  "settings.aboutCypher.status.label": "Status:",
  "settings.aboutCypher.port.label": "Porta:",
  "settings.aboutCypher.versionInfo": "Informações da Versão",
  "settings.aboutCypher.version.label": "Versão:",
  "settings.aboutCypher.extensionName": "Extensão Cypher CLI",
  "settings.aboutCypher.community": "Comunidade e Suporte",
  "settings.aboutCypher.feedback.prefix": "Se você tiver perguntas ou feedback, abra uma issue no",
  ...
  "settings.aboutCypher.resetSettings.title": "Redefinir Configurações",
  ...
  "settings.aboutCypher.resetSettings.button": "Redefinir Todas as Configurações",
  "settings.aboutCypher.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutCypher.settingsTransfer.title": "Transferência de configurações",
  ...
  "settings.aboutCypher.importSettings.invalidConfig": "O arquivo não contém configurações válidas do Cypher.",
  ...
  "settings.aboutCypher.importSettings.newerVersion":
    "Este arquivo foi exportado de uma versão mais recente do Cypher. Algumas configurações podem ser ignoradas.",
  ...
  "settings.aboutCypher.telemetry.openSettings": "Abrir Configurações de Telemetria",
  ...
  "settings.language.description":
    'Escolha o idioma da interface do Cypher CLI. "Auto" usa o idioma de exibição do VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "Ative a entrada de voz nos campos de prompt usando sua conta do Cypher por meio do Cypher Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Ative e faça login no provedor Cypher para usar o Speech to Text. Atualmente, o Speech to Text é compatível apenas com o Cypher Gateway.",
  "settings.models.speechToTextModel.title": "Modelo de fala para texto",
  "settings.models.speechToTextModel.description":
    "Escolha o modelo de transcrição do Cypher Gateway para entrada de voz.",
  ...
  "settings.experimental.remote.description":
    "Habilite o controle Remote de sessões via Cypher Cloud. Isso também afetará as CLIs nesta máquina.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carrega as instruções e skills do CLAUDE.md a partir do seu diretório de configuração do Claude Code para as sessões. Ative esta opção se deseja que o Cypher utilize suas instruções e skills do Claude Code. Requer reinicialização.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nenhum servidor MCP configurado. Adicione servidores MCP em cypher.jsonc ou peça ao agente para adicioná-los.",
  ...
  "settings.sandboxing.enabled.description":
    "Executar os comandos shell do agente dentro de um sandbox a nível de sistema operacional que restringe escritas aos diretórios de estado do projeto e do Cypher",
  ...
  "settings.display.fontSize.description":
    "Ajuste o tamanho da fonte da webview UI do Cypher independentemente do VS Code.",
  ...
  "settings.aboutCypher.legacyMigration.title": "Migração Legada",
  "settings.aboutCypher.legacyMigration.description":
    "Migre as configurações de uma instalação anterior do Cypher CLI, incluindo chaves de API de provedor e modelo padrão.",
  "settings.aboutCypher.rooImport.description": "Importe o histórico de conversas de uma instalação do Roo Code.",
  "settings.aboutCypher.rooImport.button": "Importar sessões do Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "O Que Há de Novo no Cypher CLI",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Um núcleo pequeno e eficiente em todos os produtos Cypher. Uma experiência familiar independentemente de como você escolha trabalhar.",
  ...
  "diffViewer.source.session.tooltip":
    "Arquivos modificados pelo Cypher durante a sessão atual, com base em snapshots por turno. Reinicia ao começar uma nova sessão.",
