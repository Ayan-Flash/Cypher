export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installa Anaconda Desktop su questo computer, poi torna qui. Cypher non esegue il programma di installazione per te.",
  ...
  "provider.anaconda.state.signedOut": "Apri Anaconda Desktop e accedi prima di connettere Cypher.",
  "provider.anaconda.state.unauthorized":
    "Cypher non è riuscito ad accedere ad Anaconda Desktop. Apri Desktop, accedi di nuovo e riavvialo se necessario.",
  ...
  "provider.anaconda.state.ready":
    "Cypher ha trovato un server locale di generazione del testo integro e può importare le sue attuali impostazioni di connessione.",
  ...
  "provider.anaconda.toast.refreshed.description": "Il server locale attivo e i modelli sono aggiornati in Cypher.",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Cypher",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la tua API key {{provider}} per connettere l'account e usare i modelli {{provider}} in Cypher.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere l'account e usare i modelli {{provider}} in Cypher.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere l'account e usare i modelli {{provider}} in Cypher.",
  ...
  "dialog.server.description": "Cambia il server Cypher a cui si connette questa app.",
  ...
  "toast.update.description": "Una nuova versione di Cypher ({{version}}) è disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Cypher",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" non riuscito. Nota: Cypher non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Cypher include modelli gratuiti, così puoi iniziare subito.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione di Cypher",
  "settings.general.row.appearance.title": "Aspetto",
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Cypher sul tuo dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Cypher.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti quando Cypher si avvia",
  ...
  "settings.updates.toast.latest.description": "Stai usando la versione più recente di Cypher.",
  ...
  "settings.providers.betaNotice":
    "Al momento solo il provider Cypher Gateway può essere configurato dall'interfaccia delle impostazioni. Il supporto per altri provider arriverà durante il periodo beta. Nel frattempo puoi configurare i provider con la CLI o il file di configurazione. Ci impegniamo a mantenere Cypher aperto, senza lock-in.",
  ...
  "settings.config.title": "Apri file config Cypher {{scope}}",
  "settings.config.placeholder":
    "I file config vengono uniti in ordine; i file marcati come caricati influenzano attualmente le impostazioni.",
  "settings.config.noWorkspace": "Apri una cartella workspace per modificare il file config Cypher locale.",
  "settings.config.openFailed": "Apertura file config Cypher {{scope}} non riuscita: {{message}}",
  "settings.config.source.xdg": "Config globale XDG",
  "settings.config.source.homeCypher": "Config home .cypher",
  "settings.config.source.homeCyphercode": "Config home .cypher",
  "settings.config.source.homeOpencode": "Config home .opencode",
  "settings.config.source.envFile": "File ambiente CYPHER_CONFIG",
  "settings.config.source.envDir": "CYPHER_CONFIG_DIR",
  "settings.config.source.envContent": "Config ambiente inline",
  "settings.config.source.projectCypher": "Config progetto .cypher",
  "settings.config.source.projectRoot": "Config root progetto",
  "settings.config.source.projectCyphercode": "Config legacy progetto .cypher",
  ...
  "workStyle.onboarding.welcome": "Ti diamo il benvenuto in Cypher",
  ...
  "workStyle.choice.human-in-the-loop.description": "Cypher si mette in pausa e ti mostra il suo piano mentre lavora.",
  ...
  "session.cloud.import.placeholder": "ID sessione, URL o comando cypher import",
  ...
  "deviceAuth.title": "Accedi a Cypher CLI",
  ...
  "profile.action.login": "Accedi con Cypher CLI",
  ...
  "profile.pass.subscribe": "Ottieni Cypher Pass per aggiungere crediti e guadagnare bonus",
  ...
  "settings.aboutCypher.title": "Informazioni su Cypher CLI",
  "session.messages.empty": "Avvia una conversazione scrivendo un messaggio qui sotto.",
  "session.messages.welcome":
    "Cypher CLI è un assistente AI per il coding. Chiedigli di creare feature, correggere bug o spiegare il codebase.",
  ...
  "settings.aboutCypher.status.connected": "Connesso",
  "settings.aboutCypher.status.connecting": "Connessione...",
  "settings.aboutCypher.status.disconnected": "Disconnesso",
  "settings.aboutCypher.status.error": "Errore",
  "settings.aboutCypher.cliServer": "Server CLI",
  "settings.aboutCypher.status.label": "Stato:",
  "settings.aboutCypher.port.label": "Porta:",
  "settings.aboutCypher.versionInfo": "Informazioni versione",
  "settings.aboutCypher.version.label": "Versione:",
  "settings.aboutCypher.extensionName": "Estensione Cypher CLI",
  "settings.aboutCypher.community": "Community e supporto",
  "settings.aboutCypher.feedback.prefix": "Per domande o feedback, apri pure una issue su",
  "settings.aboutCypher.feedback.or": "oppure",
  "settings.aboutCypher.support.prefix": "Per domande su fatturazione o account, contatta il supporto clienti a",
  "settings.aboutCypher.resetSettings.title": "Ripristina impostazioni",
  ...
  "settings.aboutCypher.resetSettings.button": "Ripristina tutte le impostazioni",
  "settings.aboutCypher.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutCypher.settingsTransfer.title": "Trasferimento impostazioni",
  "settings.aboutCypher.settingsTransfer.description":
    "Esporta o importa le impostazioni per trasferirle tra istanze VS Code.",
  "settings.aboutCypher.exportSettings": "Esporta",
  "settings.aboutCypher.importSettings": "Importa",
  "settings.aboutCypher.importSettings.invalidJson": "File JSON non valido. Seleziona un file impostazioni valido.",
  "settings.aboutCypher.importSettings.invalidConfig": "Il file non contiene impostazioni Cypher valide.",
  "settings.aboutCypher.importSettings.tooLarge": "File troppo grande. I file impostazioni devono essere sotto 1 MB.",
  "settings.aboutCypher.importSettings.newerVersion":
    "Questo file è stato esportato da una versione più recente di Cypher. Alcune impostazioni potrebbero essere ignorate.",
  "settings.aboutCypher.importSettings.success":
    "Impostazioni importate. Controlla le modifiche sopra, poi fai clic su Salva.",
  "settings.aboutCypher.telemetry.title": "Telemetria",
  ...
  "settings.aboutCypher.telemetry.openSettings": "Apri impostazioni telemetria",
  ...
  "settings.language.description": 'Scegli la lingua dell\'interfaccia Cypher CLI. "Auto" usa la lingua di VS Code.',
  ...
  "settings.experimental.remote.description":
    "Abilita controllo remoto delle sessioni tramite Cypher Cloud. Influenzerà anche le CLI su questa macchina.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox abilitata. I comandi shell dell'agente sono limitati alle directory del progetto e di Cypher.",
  "prompt.action.sandbox.disabled":
    "Sandbox disabilitata. Fai clic per limitare le scritture dei comandi shell dell'agente alle directory del progetto e di Cypher.",
  ...
  "prompt.action.sandbox.description.enabled": "Le scritture sono limitate alle directory del progetto e di Cypher.",
  ...
  "settings.sandboxing.enabled.description":
    "Esegui i comandi shell dell'agente all'interno di un sandbox a livello di sistema operativo che limita le scritture alle directory di stato del progetto e di Cypher",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carica istruzioni CLAUDE.md e skill dalla directory di configurazione Claude Code nelle sessioni. Abilitalo se vuoi che Cypher usi istruzioni e skill di Claude Code. Richiede riavvio.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nessun server MCP configurato. Aggiungi server MCP in cypher.jsonc, o chiedi all'agente di aggiungerli per te.",
  ...
  "settings.display.fontSize.description":
    "Regola la dimensione del font della webview Cypher indipendentemente da VS Code.",
  ...
  "settings.aboutCypher.legacyMigration.title": "Migrazione legacy",
  "settings.aboutCypher.legacyMigration.description":
    "Migra le impostazioni da una precedente installazione di Cypher CLI, incluse API key dei provider e modello predefinito.",
  "settings.aboutCypher.rooImport.description":
    "Importa la cronologia delle conversazioni da una installazione di Roo Code.",
  "settings.aboutCypher.rooImport.button": "Importa sessioni da Roo Code",
  "migration.whatsNew.title": "Novità in Cypher CLI",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un core piccolo ed efficiente per ogni prodotto Cypher. Un'esperienza familiare comunque tu scelga di lavorare.",
  ...
  "diffViewer.source.session.tooltip":
    "File modificati da Cypher durante la sessione corrente, basati su snapshot per turno. Si resetta quando inizi una nuova sessione.",
  ...
  "settings.experimental.speechToText.description":
    "Abilita input vocale nei campi prompt usando il tuo account Cypher tramite Cypher Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Abilita e accedi al provider Cypher per usare Da voce a testo. Da voce a testo è attualmente supportato solo tramite Cypher Gateway.",
  "settings.models.speechToTextModel.title": "Modello Da voce a testo",
  "settings.models.speechToTextModel.description": "Scegli il modello di trascrizione Cypher Gateway per l'input vocale.",
  ...
  "settings.models.hidePromptTraining.description":
    "Nascondi i modelli Cypher Gateway i cui provider potrebbero usare i tuoi prompt per l'addestramento.",
  ...
  "settings.indexing.cypherModel.title": "Preset modello Cypher",
  "settings.indexing.cypherModel.description": "Scegli un modello embedding ospitato da Cypher.",
  "settings.indexing.cypherSignIn.title": "Accesso Cypher richiesto",
  "settings.indexing.cypherSignIn.description": "Accedi a Cypher per usare gli embedding ospitati.",
  ...
  "agentRequirements.error.discoveryFailed": "Cypher non ha potuto controllare le skill disponibili.",
  "agentRequirements.error.mcpStatusFailed": "Cypher non ha potuto controllare lo stato del server MCP.",
  "agentRequirements.error.scopeMismatch": "Questo controllo dei requisiti dell’agente non è più attivo.",
  "agentRequirements.error.requestFailed": "Cypher non ha potuto controllare i requisiti dell’agente.",
  ...
  "speechToText.tooltip.start": "Avvia input vocale con Cypher Gateway",
  ...
  "speechToText.error.loginRequired": "Accedi a Cypher per usare l'input vocale.",
