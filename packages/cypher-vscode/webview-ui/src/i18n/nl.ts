export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installeer Anaconda Desktop op deze machine en kom hier dan terug. Cypher voert het installatieprogramma niet voor je uit.",
  ...
  "provider.anaconda.state.signedOut": "Open Anaconda Desktop en meld je aan voordat je Cypher verbindt.",
  "provider.anaconda.state.unauthorized":
    "Cypher kon geen toegang krijgen tot Anaconda Desktop. Open Desktop, meld je opnieuw aan en herstart het indien nodig.",
  ...
  "provider.anaconda.state.ready":
    "Cypher heeft een gezonde lokale tekstgeneratieserver gevonden en kan de huidige verbindingsinstellingen importeren.",
  ...
  "provider.anaconda.toast.refreshed.description": "De actieve lokale server en modellen zijn up-to-date in Cypher.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Cypher kon de beschikbare skills niet controleren.",
  "agentRequirements.error.mcpStatusFailed": "Cypher kon de MCP-serverstatus niet controleren.",
  "agentRequirements.error.scopeMismatch": "Deze controle van agentvereisten is niet meer actief.",
  "agentRequirements.error.requestFailed": "Cypher kon de agentvereisten niet controleren.",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen aangeboden door Cypher",
  ...
  "provider.connect.apiKey.description":
    "Voer uw {{provider}} API-sleutel in om uw account te verbinden en {{provider}} modellen te gebruiken in Cypher.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om uw autorisatiecode op te halen waarmee u uw account kunt verbinden en {{provider}} modellen kunt gebruiken in Cypher.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om uw account te verbinden en {{provider}} modellen te gebruiken in Cypher.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox is ingeschakeld. Shell-opdrachten van de agent zijn beperkt tot de project- en Cypher-mappen.",
  "prompt.action.sandbox.disabled":
    "Sandbox is uitgeschakeld. Klik om schrijfbewerkingen van shell-opdrachten van de agent te beperken tot de project- en Cypher-mappen.",
  ...
  "prompt.action.sandbox.description.enabled": "Schrijfbewerkingen zijn beperkt tot de project- en Cypher-mappen.",
  ...
  "speechToText.tooltip.start": "Spraakinvoer starten met Cypher Gateway",
  ...
  "speechToText.error.loginRequired": "Meld u aan bij Cypher om spraakinvoer te gebruiken.",
  ...
  "dialog.server.description": "Wissel met welke Cypher-server deze app verbinding maakt.",
  ...
  "toast.update.description": "Een nieuwe versie van Cypher ({{version}}) is nu beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Meld deze fout alsjeblieft aan het Cypher team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op, Cypher ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Cypher bevat gratis modellen, zodat je meteen kunt beginnen.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Cypher",
  "settings.general.row.appearance.title": "Uiterlijk",
  "settings.general.row.appearance.description": "Pas aan hoe Cypher eruitziet op je apparaat",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Cypher aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Cypher start",
  ...
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Cypher.",
  ...
  "settings.providers.betaNotice":
    "Momenteel kan alleen de Cypher Gateway-provider worden geconfigureerd in de instellingeninterface. Ondersteuning voor het configureren van andere providers komt binnenkort tijdens de bèta-periode. In de tussentijd kun je providers configureren met behulp van de CLI of het configuratiebestand. We zijn toegewijd om Cypher open te houden, geen lock-in.",
  ...
  "settings.config.title": "Open {{scope}} Cypher-configuratiebestand",
  ...
  "settings.config.noWorkspace": "Open een werkruimtemap om het lokale Cypher-configuratiebestand te bewerken.",
  "settings.config.openFailed": "Kan {{scope}} Cypher-configuratiebestand niet openen: {{message}}",
  "settings.config.source.xdg": "XDG globale configuratie",
  "settings.config.source.homeCypher": "Home .cypher-configuratie",
  "settings.config.source.homeCyphercode": "Home .cypher-configuratie",
  "settings.config.source.homeOpencode": "Home .opencode-configuratie",
  "settings.config.source.envFile": "CYPHER_CONFIG omgevingsbestand",
  "settings.config.source.envDir": "CYPHER_CONFIG_DIR",
  "settings.config.source.envContent": "Inline omgevingsconfiguratie",
  "settings.config.source.projectCypher": "Project .cypher-configuratie",
  "settings.config.source.projectRoot": "Project root configuratie",
  "settings.config.source.projectCyphercode": "Verouderde .cypher-configuratie",
  ...
  "workStyle.onboarding.welcome": "Welkom bij Cypher",
  ...
  "workStyle.choice.human-in-the-loop.description": "Cypher pauzeert en toont tijdens het werk zijn plan.",
  ...
  "session.cloud.import.placeholder": "Sessie-ID, URL, of cypher import commando",
  ...
  "deviceAuth.title": "Meld je aan bij Cypher CLI",
  ...
  "profile.action.login": "Inloggen met Cypher CLI",
  ...
  "profile.pass.subscribe": "Schaf Cypher Pass aan om tegoed toe te voegen en bonussen te verdienen",
  ...
  "settings.aboutCypher.title": "Over Cypher CLI",

  "session.messages.empty": "Start een gesprek door hieronder een bericht te typen.",
  "session.messages.welcome":
    "Cypher CLI is een AI-codeerassistent. Vraag het om features te bouwen, bugs op te lossen of je codebase uit te leggen.",
  ...
  "settings.aboutCypher.status.connected": "Verbonden",
  "settings.aboutCypher.status.connecting": "Verbinden...",
  "settings.aboutCypher.status.disconnected": "Verbinding verbroken",
  "settings.aboutCypher.status.error": "Fout",
  "settings.aboutCypher.cliServer": "CLI Server",
  "settings.aboutCypher.status.label": "Status:",
  "settings.aboutCypher.port.label": "Poort:",
  "settings.aboutCypher.versionInfo": "Versie-informatie",
  "settings.aboutCypher.version.label": "Versie:",
  "settings.aboutCypher.extensionName": "Cypher CLI Extensie",
  "settings.aboutCypher.community": "Community & Ondersteuning",
  "settings.aboutCypher.feedback.prefix": "Als je vragen of feedback hebt, voel je vrij om een issue aan te maken op",
  "settings.aboutCypher.feedback.or": "of",
  "settings.aboutCypher.support.prefix":
    "Voor vragen over facturering of je account, neem contact op met Klantenservice op",
  "settings.aboutCypher.resetSettings.title": "Instellingen resetten",
  ...
  "settings.aboutCypher.resetSettings.button": "Alle instellingen resetten",
  "settings.aboutCypher.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutCypher.settingsTransfer.title": "Instellingen overdragen",
  ...
  "settings.aboutCypher.exportSettings": "Exporteren",
  "settings.aboutCypher.importSettings": "Importeren",
  "settings.aboutCypher.importSettings.invalidJson":
    "Ongeldig JSON-bestand. Selecteer een geldig instellingenbestand.",
  "settings.aboutCypher.importSettings.invalidConfig": "Het bestand bevat geen geldige Cypher-instellingen.",
  ...
  "settings.aboutCypher.importSettings.newerVersion":
    "Dit bestand is geëxporteerd vanuit een nieuwere versie van Cypher. Sommige instellingen worden mogelijk genegeerd.",
  ...
  "settings.aboutCypher.telemetry.title": "Telemetrie",
  ...
  "settings.aboutCypher.telemetry.openSettings": "Telemetrie-instellingen openen",
  ...
  "settings.language.description": 'Kies de taal voor de Cypher CLI UI. "Auto" gebruikt je VS Code schermtaal.',
  ...
  "settings.experimental.speechToText.description":
    "Schakel spraakinvoer in promptvelden in met uw Cypher-account via Cypher Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Schakel de Cypher-provider in en meld u aan om Speech to Text te gebruiken. Speech to Text wordt momenteel alleen ondersteund met Cypher Gateway.",
  "settings.models.speechToTextModel.title": "Spraak-naar-tekst-model",
  "settings.models.speechToTextModel.description": "Kies het Cypher Gateway-transcriptiemodel voor spraakinvoer.",
  ...
  "settings.experimental.remote.description":
    "Schakel Remote-bediening van sessies in via Cypher Cloud. Dit heeft ook invloed op CLI's op deze machine.",
  ...
  "settings.sandboxing.enabled.description":
    "Shell-opdrachten van de agent uitvoeren in een sandbox op besturingssysteemniveau die schrijfbewerkingen beperkt tot de project- en Cypher-statusmappen",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Laad CLAUDE.md instructies en vaardigheden uit je Claude Code configuratiemap in sessies. Schakel dit in als je wilt dat Cypher je Claude Code instructies en vaardigheden gebruikt. Herstart vereist.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Geen MCP-servers geconfigureerd. Voeg MCP-servers toe in cypher.jsonc of vraag de agent om ze toe te voegen.",
  ...
  "settings.display.fontSize.description": "Pas de lettergrootte van de Cypher webview UI onafhankelijk van VS Code aan.",
  ...
  "settings.models.hidePromptTraining.description":
    "Verberg Cypher Gateway-modellen waarvan providers je prompts mogelijk voor training gebruiken.",
  ...
  "settings.aboutCypher.legacyMigration.title": "Legacy Migratie",
  "settings.aboutCypher.legacyMigration.description":
    "Migreer instellingen van een eerdere installatie van Cypher CLI, inclusief provider API-sleutels en standaard model.",
  "settings.aboutCypher.rooImport.description": "Importeer gespreksgeschiedenis van een Roo Code installatie.",
  "settings.aboutCypher.rooImport.button": "Sessies importeren uit Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Wat is er Nieuw in Cypher CLI",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Één kleine, efficiënte kern voor elk Cypher-product. Een vertrouwde ervaring, hoe je ook wilt werken.",
  ...
  "settings.indexing.cypherModel.title": "Cypher-model voorinstelling",
  "settings.indexing.cypherModel.description": "Kies een ondersteund Cypher-hosted embeddings model.",
  "settings.indexing.cypherSignIn.title": "Cypher-aanmelding vereist",
  "settings.indexing.cypherSignIn.description": "Log in op Cypher om hosted embeddings te gebruiken.",
  ...
  "diffViewer.source.session.tooltip":
    "Bestanden die door Cypher tijdens de huidige sessie zijn gewijzigd, gebaseerd op snapshots per beurt. Wordt gereset bij het starten van een nieuwe sessie.",
