export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Install Anaconda Desktop on this machine, then return here. Cypher does not run the installer for you.",
  ...
  "provider.anaconda.state.signedOut": "Open Anaconda Desktop and sign in before connecting Cypher.",
  "provider.anaconda.state.unauthorized":
    "Cypher could not access Anaconda Desktop. Open Desktop, sign in again, and restart it if needed.",
  ...
  "provider.anaconda.state.ready":
    "Cypher found a healthy local text-generation server and can import its current connection settings.",
  ...
  "provider.anaconda.toast.refreshed.description": "The active local server and models are up to date in Cypher.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Cypher could not check the available skills.",
  "agentRequirements.error.mcpStatusFailed": "Cypher could not check MCP server status.",
  "agentRequirements.error.scopeMismatch": "This agent requirement check is no longer active.",
  "agentRequirements.error.requestFailed": "Cypher could not check the agent requirements.",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Cypher",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Cypher.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Cypher.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Cypher.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox is enabled. Agent shell commands are confined to the project and Cypher directories.",
  "prompt.action.sandbox.disabled":
    "Sandbox is disabled. Click to confine agent shell command writes to the project and Cypher directories.",
  ...
  "prompt.action.sandbox.description.enabled": "Writes are limited to the project and Cypher directories.",
  ...
  "speechToText.tooltip.start": "Start voice input with Cypher Gateway",
  ...
  "speechToText.error.loginRequired": "Sign in to Cypher to use speech input.",
  ...
  "dialog.server.description": "Switch which Cypher server this app connects to.",
  ...
  "toast.update.description": "A new version of Cypher ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Cypher team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Cypher does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Cypher includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for Cypher",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Cypher looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Cypher is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Cypher launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Cypher.",
  ...
  "settings.providers.betaNotice":
    "Currently only the Cypher Gateway provider can be configured in the settings interface. Support for configuring other providers is coming soon during the beta period. In the interim you can configure providers using the CLI or config file. We're committed to keeping Cypher open, no lock-in.",
  ...
  "settings.config.title": "Open {{scope}} Cypher config file",
  "settings.config.placeholder": "Config files are merged in order; files marked loaded currently affect settings.",
  "settings.config.noWorkspace": "Open a workspace folder to edit the local Cypher config file.",
  "settings.config.openFailed": "Failed to open {{scope}} Cypher config file: {{message}}",
  "settings.config.source.xdg": "XDG global config",
  "settings.config.source.homeCypher": "Home .cypher config",
  "settings.config.source.homeCyphercode": "Home .cypher config",
  "settings.config.source.homeOpencode": "Home .opencode config",
  "settings.config.source.envFile": "CYPHER_CONFIG environment file",
  "settings.config.source.envDir": "CYPHER_CONFIG_DIR",
  "settings.config.source.envContent": "Inline environment config",
  "settings.config.source.projectCypher": "Project .cypher config",
  "settings.config.source.projectRoot": "Project root config",
  "settings.config.source.projectCyphercode": "Legacy .cypher config",
  ...
  "workStyle.onboarding.welcome": "Welcome to Cypher",
  ...
  "workStyle.choice.human-in-the-loop.description": "Cypher pauses and shows you its plan as it works.",
  ...
  "session.cloud.import.placeholder": "Session ID, URL, or cypher import command",
  ...
  "deviceAuth.title": "Sign in to Cypher CLI",
  ...
  "profile.action.login": "Login with Cypher CLI",
  ...
  "profile.pass.subscribe": "Get Cypher Pass to add credits and earn bonuses",
  ...
  "settings.indexing.cypherModel.title": "Cypher model preset",
  "settings.indexing.cypherModel.description": "Choose a supported Cypher-hosted embedding model.",
  "settings.indexing.cypherSignIn.title": "Cypher sign-in required",
  "settings.indexing.cypherSignIn.description": "Sign in to Cypher to use hosted embeddings.",
  ...
  "settings.aboutCypher.title": "About Cypher CLI",
  ...
  "settings.aboutCypher.status.connected": "Connected",
  "settings.aboutCypher.status.connecting": "Connecting...",
  "settings.aboutCypher.status.disconnected": "Disconnected",
  ...
  "settings.aboutCypher.versionInfo": "Version Information",
  "settings.aboutCypher.version.label": "Version:",
  "settings.aboutCypher.extensionName": "Cypher CLI Extension",
  "settings.aboutCypher.community": "Community & Support",
  "settings.aboutCypher.feedback.prefix": "If you have any questions or feedback, feel free to open an issue on",
  "settings.aboutCypher.feedback.or": "or",
  "settings.aboutCypher.support.prefix": "For billing or account questions, contact Customer Support at",
  "settings.aboutCypher.resetSettings.title": "Reset Settings",
  ...
  "settings.aboutCypher.resetSettings.button": "Reset All Settings",
  "settings.aboutCypher.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutCypher.settingsTransfer.title": "Settings Transfer",
  ...
  "settings.aboutCypher.exportSettings": "Export",
  "settings.aboutCypher.importSettings": "Import",
  "settings.aboutCypher.importSettings.invalidJson": "Invalid JSON file. Please select a valid settings file.",
  "settings.aboutCypher.importSettings.invalidConfig": "File does not contain valid Cypher settings.",
  "settings.aboutCypher.importSettings.tooLarge": "File is too large. Settings files must be under 1 MB.",
  "settings.aboutCypher.importSettings.newerVersion":
    "This file was exported from a newer version of Cypher. Some settings may be ignored.",
  "settings.aboutCypher.importSettings.success": "Settings imported. Review the changes above, then click Save.",
  ...
  "settings.aboutCypher.telemetry.openSettings": "Open Telemetry Settings",
  ...
  "settings.language.description":
    'Choose the language for the Cypher CLI UI. "Auto" uses your VS Code display language.',
  ...
  "settings.experimental.speechToText.description":
    "Enable voice input in prompt fields using your Cypher account through Cypher Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Enable and sign in to the Cypher provider to use Speech to Text. Speech to Text is currently only supported through Cypher Gateway.",
  "settings.models.speechToTextModel.title": "Speech to Text Model",
  "settings.models.speechToTextModel.description": "Choose the Cypher Gateway transcription model for voice input.",
  ...
  "settings.sandboxing.enabled.description":
    "Run agent shell commands inside an OS-level sandbox that restricts writes to the project and Cypher state directories",
  ...
  "settings.experimental.remote.description":
    "Enable remote control of sessions via Cypher Cloud. This will also affect CLIs on this machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Load CLAUDE.md instructions and skills from your Claude Code configuration directory into sessions. Enable this if you want Cypher to use your Claude Code instructions and skills. Requires restart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "No MCP servers configured. Add MCP servers in cypher.jsonc, or ask the agent to add them for you.",
  ...
  "settings.display.fontSize.description": "Adjust the Cypher webview UI font size independently from VS Code.",
  ...
  "settings.models.hidePromptTraining.description":
    "Hide Cypher Gateway models whose providers may use your prompts for training.",
  ...
  "settings.aboutCypher.legacyMigration.description":
    "Migrate settings from a previous installation of Cypher CLI, including provider API keys and default model.",
  "settings.aboutCypher.rooImport.description": "Import conversation history from a Roo Code installation.",
  "settings.aboutCypher.rooImport.button": "Import Sessions from Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "What's New in Cypher CLI",
  ...
  "migration.whatsNew.features.foundation.detail":
    "One small, efficient core across every Cypher product. A familiar experience however you choose to work.",
  ...
  "diffViewer.source.session.tooltip":
    "Files changed by Cypher during the current session, based on per-turn snapshots. Resets when you start a new session.",
