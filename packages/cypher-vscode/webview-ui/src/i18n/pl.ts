export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Zainstaluj Anaconda Desktop na tym komputerze, a następnie wróć tutaj. Cypher nie uruchamia instalatora za Ciebie.",
  ...
  "provider.anaconda.state.signedOut": "Otwórz Anaconda Desktop i zaloguj się przed połączeniem Cypher.",
  "provider.anaconda.state.unauthorized":
    "Cypher nie mógł uzyskać dostępu do Anaconda Desktop. Otwórz Desktop, zaloguj się ponownie i w razie potrzeby uruchom ją ponownie.",
  ...
  "provider.anaconda.state.ready":
    "Cypher znalazł sprawny lokalny serwer generowania tekstu i może zaimportować jego bieżące ustawienia połączenia.",
  ...
  "provider.anaconda.toast.refreshed.description": "Aktywny serwer lokalny i modele są aktualne w Cypher.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Cypher nie mógł sprawdzić dostępnych umiejętności.",
  "agentRequirements.error.mcpStatusFailed": "Cypher nie mógł sprawdzić stanu serwera MCP.",
  "agentRequirements.error.scopeMismatch": "To sprawdzenie wymagań agenta nie jest już aktywne.",
  "agentRequirements.error.requestFailed": "Cypher nie mógł sprawdzić wymagań agenta.",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Cypher",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Cypher.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Cypher.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Cypher.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox jest włączony. Polecenia shell agenta są ograniczone do katalogów projektu i Cypher.",
  "prompt.action.sandbox.disabled":
    "Sandbox jest wyłączony. Kliknij, aby ograniczyć zapisy poleceń shell agenta do katalogów projektu i Cypher.",
  ...
  "prompt.action.sandbox.description.enabled": "Zapisy są ograniczone do katalogów projektu i Cypher.",
  ...
  "speechToText.tooltip.start": "Rozpocznij wprowadzanie głosowe z Cypher Gateway",
  ...
  "speechToText.error.loginRequired": "Zaloguj się do Cypher, aby korzystać z wprowadzania głosowego.",
  ...
  "dialog.server.description": "Przełącz serwer Cypher, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Cypher ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Cypher",
  ...
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, Cypher nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "sidebar.gettingStarted.line1": "Cypher zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Cypher",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Cypher na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Cypher.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Cypher",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Cypher.",
  ...
  "settings.providers.betaNotice":
    "Obecnie w interfejsie ustawień można skonfigurować tylko dostawcę Cypher Gateway. Obsługa konfiguracji innych dostawców pojawi się wkrótce w fazie beta. W międzyczasie możesz konfigurować dostawców za pomocą CLI lub pliku konfiguracyjnego. Zależy nam na zachowaniu otwartości Cypher, bez lock-inu.",
  ...
  "settings.models.hidePromptTraining.description":
    "Ukryj modele Cypher Gateway, których dostawcy mogą używać Twoich promptów do trenowania.",
  ...
  "settings.config.title": "Otwórz plik konfiguracyjny Cypher ({{scope}})",
  "settings.config.placeholder":
    "Pliki konfiguracyjne są scalane po kolei; pliki oznaczone jako wczytane mają obecnie wpływ na ustawienia.",
  "settings.config.noWorkspace": "Otwórz folder obszaru roboczego, aby edytować lokalny plik konfiguracyjny Cypher.",
  "settings.config.openFailed": "Nie udało się otworzyć pliku konfiguracyjnego Cypher ({{scope}}): {{message}}",
  "settings.config.source.xdg": "Globalna konfiguracja XDG",
  "settings.config.source.homeCypher": "Konfiguracja .cypher (Home)",
  "settings.config.source.homeCyphercode": "Konfiguracja .cypher (Home)",
  "settings.config.source.homeOpencode": "Konfiguracja .opencode (Home)",
  "settings.config.source.envFile": "Plik środowiskowy CYPHER_CONFIG",
  "settings.config.source.envDir": "CYPHER_CONFIG_DIR",
  "settings.config.source.envContent": "Wbudowana konfiguracja środowiska",
  "settings.config.source.projectCypher": "Konfiguracja .cypher projektu",
  "settings.config.source.projectRoot": "Konfiguracja główna projektu",
  "settings.config.source.projectCyphercode": "Przestarzała konfiguracja .cypher",
  ...
  "workStyle.onboarding.welcome": "Witamy w Cypher",
  ...
  "workStyle.choice.human-in-the-loop.description": "Cypher wstrzymuje pracę i pokazuje swój plan w trakcie działania.",
  ...
  "session.cloud.import.placeholder": "ID sesji, URL lub polecenie cypher import",
  ...
  "deviceAuth.title": "Zaloguj się do Cypher CLI",
  ...
  "profile.action.login": "Zaloguj się przez Cypher CLI",
  ...
  "profile.pass.subscribe": "Zdobądź Cypher Pass, aby dodać środki i zdobywać bonusy",
  ...
  "settings.aboutCypher.title": "O Cypher CLI",

  "session.messages.empty": "Rozpocznij rozmowę, wpisując wiadomość poniżej.",
  "session.messages.welcome":
    "Cypher CLI to asystent programowania AI. Poproś go o tworzenie funkcji, naprawę błędów lub wyjaśnienie bazy kodu.",
  ...
  "settings.aboutCypher.status.connected": "Połączono",
  "settings.aboutCypher.status.connecting": "Łączenie...",
  "settings.aboutCypher.status.disconnected": "Rozłączono",
  "settings.aboutCypher.status.error": "Błąd",
  "settings.aboutCypher.cliServer": "Serwer CLI",
  "settings.aboutCypher.status.label": "Status:",
  "settings.aboutCypher.port.label": "Port:",
  "settings.aboutCypher.versionInfo": "Informacje o wersji",
  "settings.aboutCypher.version.label": "Wersja:",
  "settings.aboutCypher.extensionName": "Rozszerzenie Cypher CLI",
  "settings.aboutCypher.community": "Społeczność i wsparcie",
  "settings.aboutCypher.feedback.prefix": "Jeśli masz pytania lub uwagi, śmiało otwórz zgłoszenie na",
  "settings.aboutCypher.feedback.or": "lub",
  "settings.aboutCypher.support.prefix":
    "W sprawach rozliczeń lub konta skontaktuj się z obsługą klienta pod adresem",
  "settings.aboutCypher.resetSettings.title": "Resetuj ustawienia",
  ...
  "settings.aboutCypher.resetSettings.button": "Resetuj wszystkie ustawienia",
  "settings.aboutCypher.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutCypher.settingsTransfer.title": "Przenoszenie ustawień",
  ...
  "settings.aboutCypher.exportSettings": "Eksportuj",
  "settings.aboutCypher.importSettings": "Importuj",
  "settings.aboutCypher.importSettings.invalidJson": "Nieprawidłowy plik JSON. Wybierz prawidłowy plik ustawień.",
  "settings.aboutCypher.importSettings.invalidConfig": "Plik nie zawiera prawidłowych ustawień Cypher.",
  "settings.aboutCypher.importSettings.tooLarge": "Plik jest za duży. Pliki ustawień muszą mieć mniej niż 1 MB.",
  "settings.aboutCypher.importSettings.newerVersion":
    "Ten plik został wyeksportowany z nowszej wersji Cypher. Niektóre ustawienia mogą zostać zignorowane.",
  ...
  "settings.aboutCypher.telemetry.openSettings": "Otwórz ustawienia telemetrii",
  ...
  "settings.language.description": 'Wybierz język interfejsu Cypher CLI. „Auto" używa języka wyświetlania VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "Włącz wprowadzanie głosowe w polach promptów przy użyciu konta Cypher za pośrednictwem Cypher Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Włącz i zaloguj się do dostawcy Cypher, aby korzystać ze Speech to Text. Speech to Text jest obecnie obsługiwane tylko z Cypher Gateway.",
  "settings.models.speechToTextModel.title": "Model mowy na tekst",
  "settings.models.speechToTextModel.description":
    "Wybierz model transkrypcji Cypher Gateway dla wprowadzania głosowego.",
  ...
  "settings.experimental.remote.description":
    "Włącz sterowanie Remote sesjami za pośrednictwem Cypher Cloud. Wpłynie to również na CLI na tej maszynie.",
  ...
  "settings.indexing.cypherModel.title": "Preset modelu Cypher",
  "settings.indexing.cypherModel.description": "Wybierz obsługiwany model osadzania hostowany przez Cypher.",
  "settings.indexing.cypherSignIn.title": "Wymagane logowanie do Cypher",
  "settings.indexing.cypherSignIn.description": "Zaloguj się do Cypher, aby używać hostowanych osadzeń.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Wczytuje instrukcje CLAUDE.md oraz umiejętności z katalogu konfiguracyjnego Claude Code do sesji. Włącz tę opcję, jeśli chcesz, aby Cypher korzystał z Twoich instrukcji i umiejętności Claude Code. Wymaga ponownego uruchomienia.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Brak skonfigurowanych serwerów MCP. Dodaj serwery MCP w cypher.jsonc lub poproś agenta o ich dodanie.",
  ...
  "settings.sandboxing.enabled.description":
    "Uruchamiaj polecenia shell agenta w sandboxie na poziomie systemu operacyjnego, który ogranicza zapisy do katalogów stanu projektu i Cypher",
  ...
  "settings.display.fontSize.description": "Dostosuj rozmiar czcionki webview UI Cypher niezależnie od VS Code.",
  ...
  "settings.aboutCypher.legacyMigration.title": "Migracja starszej wersji",
  "settings.aboutCypher.legacyMigration.description":
    "Migruj ustawienia z poprzedniej instalacji Cypher CLI, w tym klucze API dostawców i domyślny model.",
  "settings.aboutCypher.rooImport.description": "Importuj historię rozmów z instalacji Roo Code.",
  "settings.aboutCypher.rooImport.button": "Importuj sesje z Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Co nowego w Cypher CLI",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno małe, wydajne jądro we wszystkich produktach Cypher. Znajome doświadczenie niezależnie od sposobu pracy.",
  ...
  "diffViewer.source.session.tooltip":
    "Pliki zmienione przez Cypher w trakcie bieżącej sesji, na podstawie snapshotów na turę. Resetowane przy rozpoczęciu nowej sesji.",
