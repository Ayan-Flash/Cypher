...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installer Anaconda Desktop på denne maskinen, og kom deretter tilbake hit. Cypher kjører ikke installasjonsprogrammet for deg.",
  ...
  "provider.anaconda.state.signedOut": "Åpne Anaconda Desktop og logg inn før du kobler til Cypher.",
  "provider.anaconda.state.unauthorized":
    "Cypher fikk ikke tilgang til Anaconda Desktop. Åpne Desktop, logg inn på nytt, og start det på nytt om nødvendig.",
  ...
  "provider.anaconda.state.ready":
    "Cypher fant en sunn lokal tekstgenereringsserver og kan importere de gjeldende tilkoblingsinnstillingene.",
  ...
  "provider.anaconda.toast.refreshed.description": "Den aktive lokale serveren og modellene er oppdatert i Cypher.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Cypher kunne ikke sjekke tilgjengelige skills.",
  "agentRequirements.error.mcpStatusFailed": "Cypher kunne ikke sjekke MCP-serverstatus.",
  "agentRequirements.error.scopeMismatch": "Denne sjekken av agentkrav er ikke lenger aktiv.",
  "agentRequirements.error.requestFailed": "Cypher kunne ikke sjekke agentkravene.",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Cypher",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Cypher.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Cypher.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Cypher.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox er aktivert. Shell-kommandoer for agenten er begrenset til prosjekt- og Cypher-mappene.",
  "prompt.action.sandbox.disabled":
    "Sandbox er deaktivert. Klikk for å begrense skriving av shell-kommandoer for agenten til prosjekt- og Cypher-mappene.",
  ...
  "prompt.action.sandbox.description.enabled": "Skrivetilgang er begrenset til prosjekt- og Cypher-mappene.",
  ...
  "speechToText.tooltip.start": "Start taleinndata med Cypher Gateway",
  ...
  "speechToText.error.loginRequired": "Logg på Cypher for å bruke taleinndata.",
  ...
  "dialog.server.description": "Bytt hvilken Cypher-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Cypher ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Cypher-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Cypher ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Cypher inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Cypher",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Cypher ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Cypher er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Cypher starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Cypher.",
  ...
  "settings.providers.betaNotice":
    "For øyeblikket kan kun Cypher Gateway-leverandøren konfigureres i innstillingsgrensesnittet. Støtte for konfigurering av andre leverandører kommer snart i løpet av betaperioden. I mellomtiden kan du konfigurere leverandører via CLI eller konfigurasjonsfilen. Vi er forpliktet til å holde Cypher åpent, ingen lock-in.",
  ...
  "settings.models.hidePromptTraining.description":
    "Skjul Cypher Gateway-modeller der leverandørene kan bruke ledetekstene dine til trening.",
  ...
  "settings.config.title": "Åpne {{scope}} Cypher-konfigurasjonsfil",
  "settings.config.placeholder":
    "Konfigurasjonsfiler slås sammen i rekkefølge; filer merket som lastet påvirker for øyeblikket innstillingene.",
  "settings.config.noWorkspace": "Åpne en arbeidsområdemappe for å redigere den lokale Cypher-konfigurasjonsfilen.",
  "settings.config.openFailed": "Klarte ikke å åpne {{scope}} Cypher-konfigurasjonsfil: {{message}}",
  "settings.config.source.xdg": "XDG global konfigurasjon",
  "settings.config.source.homeCypher": "Home .cypher-konfigurasjon",
  "settings.config.source.homeCyphercode": "Home .cypher-konfigurasjon",
  "settings.config.source.homeOpencode": "Home .opencode-konfigurasjon",
  "settings.config.source.envFile": "CYPHER_CONFIG miljøfil",
  "settings.config.source.envDir": "CYPHER_CONFIG_DIR",
  "settings.config.source.envContent": "Innebygd miljøkonfigurasjon",
  "settings.config.source.projectCypher": "Prosjekt .cypher-konfigurasjon",
  "settings.config.source.projectRoot": "Prosjektets rotkonfigurasjon",
  "settings.config.source.projectCyphercode": "Eldre .cypher-konfigurasjon",
  ...
  "workStyle.onboarding.welcome": "Velkommen til Cypher",
  ...
  "workStyle.choice.human-in-the-loop.description": "Cypher tar pause og viser deg planen sin mens den arbeider.",
  ...
  "session.cloud.import.placeholder": "Økt-ID, URL eller cypher import-kommando",
  ...
  "deviceAuth.title": "Logg inn på Cypher CLI",
  ...
  "profile.action.login": "Logg inn med Cypher CLI",
  ...
  "profile.pass.subscribe": "Få Cypher Pass for å legge til kreditt og tjene bonuser",
  ...
  "settings.aboutCypher.title": "Om Cypher CLI",

  "session.messages.empty": "Start en samtale ved å skrive en melding nedenfor.",
  "session.messages.welcome":
    "Cypher CLI er en AI-kodingsassistent. Be den om å bygge funksjoner, fikse feil eller forklare kodebasen din.",
  ...
  "settings.aboutCypher.status.connected": "Tilkoblet",
  "settings.aboutCypher.status.connecting": "Kobler til...",
  "settings.aboutCypher.status.disconnected": "Frakoblet",
  "settings.aboutCypher.status.error": "Feil",
  "settings.aboutCypher.cliServer": "CLI-server",
  "settings.aboutCypher.status.label": "Status:",
  "settings.aboutCypher.port.label": "Port:",
  "settings.aboutCypher.versionInfo": "Versjonsinformasjon",
  "settings.aboutCypher.version.label": "Versjon:",
  "settings.aboutCypher.extensionName": "Cypher CLI-utvidelse",
  "settings.aboutCypher.community": "Fellesskap og støtte",
  "settings.aboutCypher.feedback.prefix": "Hvis du har spørsmål eller tilbakemeldinger, åpne gjerne en issue på",
  "settings.aboutCypher.feedback.or": "eller",
  "settings.aboutCypher.support.prefix": "For fakturerings- eller kontospørsmål, kontakt kundestøtte på",
  "settings.aboutCypher.resetSettings.title": "Tilbakestill innstillinger",
  ...
  "settings.aboutCypher.resetSettings.button": "Tilbakestill alle innstillinger",
  "settings.aboutCypher.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutCypher.settingsTransfer.title": "Overføring av innstillinger",
  ...
  "settings.aboutCypher.exportSettings": "Eksporter",
  "settings.aboutCypher.importSettings": "Importer",
  "settings.aboutCypher.importSettings.invalidJson": "Ugyldig JSON-fil. Vennligst velg en gyldig innstillingsfil.",
  "settings.aboutCypher.importSettings.invalidConfig": "Filen inneholder ikke gyldige Cypher-innstillinger.",
  "settings.aboutCypher.importSettings.tooLarge": "Filen er for stor. Innstillingsfiler må være under 1 MB.",
  "settings.aboutCypher.importSettings.newerVersion":
    "Denne filen ble eksportert fra en nyere versjon av Cypher. Noen innstillinger kan bli ignorert.",
  ...
  "settings.aboutCypher.telemetry.title": "Telemetri",
  ...
  "settings.aboutCypher.telemetry.openSettings": "Åpne innstillinger for telemetri",
  ...
  "settings.language.description": 'Velg språket for Cypher CLI-grensesnittet. "Auto" bruker VS Codes visningsspråk.',
  ...
  "settings.experimental.speechToText.description":
    "Aktiver taleinndata i prompt-felt ved å bruke din Cypher-konto gjennom Cypher Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Aktiver og logg på Cypher-leverandøren for å bruke Speech to Text. Speech to Text støttes for øyeblikket bare med Cypher Gateway.",
  "settings.models.speechToTextModel.title": "Tale-til-tekst-modell",
  "settings.models.speechToTextModel.description": "Velg Cypher Gateway-transkripsjonsmodellen for taleinndata.",
  ...
  "settings.experimental.remote.description":
    "Aktiver Remote-kontroll av økter via Cypher Cloud. Dette vil også påvirke CLI-er på denne maskinen.",
  ...
  "settings.indexing.cypherModel.title": "Cypher-modellforhåndsvalg",
  "settings.indexing.cypherModel.description": "Velg en støttet Cypher-hostet embedding-modell.",
  "settings.indexing.cypherSignIn.title": "Cypher-pålogging kreves",
  "settings.indexing.cypherSignIn.description": "Logg inn på Cypher for å bruke hostede embeddings.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Last inn CLAUDE.md-instruksjoner og ferdigheter fra Claude Code-konfigurasjonsmappen din i økter. Aktiver dette hvis du vil at Cypher skal bruke dine Claude Code-instruksjoner og ferdigheter. Krever omstart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Ingen MCP-servere konfigurert. Legg til MCP-servere i cypher.jsonc, eller be agenten om å legge dem til.",
  ...
  "settings.sandboxing.enabled.description":
    "Kjør shell-kommandoer for agenten i en sandbox på operativsystemnivå som begrenser skriving til prosjekt- og Cypher-tilstandsmapper",
  ...
  "settings.display.fontSize.description": "Juster skriftstørrelsen for Cypher webview UI uavhengig av VS Code.",
  ...
  "settings.aboutCypher.legacyMigration.title": "Migrering fra eldre versjon",
  "settings.aboutCypher.legacyMigration.description":
    "Migrer innstillinger fra en tidligere installasjon av Cypher CLI, inkludert API-nøkler for leverandører og standardmodell.",
  "settings.aboutCypher.rooImport.description": "Importer samtalehistorikk fra en installasjon av Roo Code.",
  "settings.aboutCypher.rooImport.button": "Importer økter fra Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Hva er nytt i Cypher CLI",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én liten, effektiv kjerne på tvers av alle Cypher-produkter. En kjent opplevelse uansett hvordan du velger å jobbe.",
  ...
  "diffViewer.source.session.tooltip":
    "Filer endret av Cypher i løpet av gjeldende økt, basert på øyeblikksbilder per tur. Tilbakestilles når du starter en ny økt.",
