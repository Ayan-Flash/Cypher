export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "このマシンに Anaconda Desktop をインストールしてから、ここに戻ってください。Cypher はインストーラーを実行しません。",
  ...
  "provider.anaconda.state.signedOut": "Cypher を接続する前に、Anaconda Desktop を開いてサインインしてください。",
  "provider.anaconda.state.unauthorized":
    "Cypher は Anaconda Desktop にアクセスできませんでした。Desktop を開いて再度サインインし、必要に応じて再起動してください。",
  ...
  "provider.anaconda.state.ready":
    "Cypher は正常なローカルのテキスト生成サーバーを見つけ、現在の接続設定をインポートできます。",
  ...
  "provider.anaconda.toast.refreshed.description": "アクティブなローカルサーバーとモデルが Cypher で最新になりました。",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Cypher は利用可能なスキルを確認できませんでした。",
  "agentRequirements.error.mcpStatusFailed": "Cypher は MCP サーバーの状態を確認できませんでした。",
  "agentRequirements.error.scopeMismatch": "このエージェント要件の確認はもう有効ではありません。",
  "agentRequirements.error.requestFailed": "Cypher はエージェント要件を確認できませんでした。",
  ...
  "dialog.model.unpaid.freeModels.title": "Cypherが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Cypherで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してCypherで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Cypherで{{provider}}モデルを使用してください。",
  ...
  "prompt.action.sandbox.enabled":
    "サンドボックスが有効です。エージェントのシェルコマンドは、プロジェクトおよびCypherディレクトリに制限されています。",
  "prompt.action.sandbox.disabled":
    "サンドボックスが無効です。クリックしてエージェントのシェルコマンドの書き込みをプロジェクトおよびCypherディレクトリに制限します。",
  ...
  "prompt.action.sandbox.description.enabled": "書き込みはプロジェクトおよびCypherディレクトリ内に制限されます。",
  ...
  "speechToText.tooltip.start": "Cypher Gatewayで音声入力を開始",
  ...
  "speechToText.error.loginRequired": "音声入力を使用するにはCypherにサインインしてください。",
  ...
  "dialog.server.description": "このアプリが接続するCypherサーバーを切り替えます。",
  ...
  "toast.update.description": "Cypherの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをCypherチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: CypherはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Cypherには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.general.row.language.description": "Cypherの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのCypherの表示をカスタマイズします",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Cypherのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Cypher の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Cypher は最新バージョンです。",
  ...
  "settings.indexing.cypherModel.title": "Cypherモデルプリセット",
  "settings.indexing.cypherModel.description": "サポートされているCypherホスト型埋め込みモデルを選択します。",
  "settings.indexing.cypherSignIn.title": "Cypherへのサインインが必要です",
  "settings.indexing.cypherSignIn.description": "ホスト型埋め込みを使用するにはCypherにサインインしてください。",
  ...
  "settings.providers.betaNotice":
    "現在、設定画面で設定できるのはCypher Gatewayプロバイダーのみです。他のプロバイダーの設定については、ベータ期間中にまもなく対応予定です。それまでの間は、CLIまたは設定ファイルを使用してプロバイダーを設定できます。私たちはCypherをオープンに保ち、ロックインのない状態を維持することをお約束します。",
  ...
  "settings.models.hidePromptTraining.description":
    "プロバイダーがプロンプトを学習に使用する可能性のある Cypher Gateway モデルを非表示にします。",
  ...
  "settings.config.title": "{{scope}}のCypher構成ファイルを開く",
  "settings.config.placeholder":
    "構成ファイルは順番にマージされます。読み込み済みとしてマークされているファイルが現在設定に影響しています。",
  "settings.config.noWorkspace": "ローカルのCypher構成ファイルを編集するには、ワークスペースフォルダーを開いてください。",
  "settings.config.openFailed": "{{scope}}のCypher構成ファイルを開けませんでした: {{message}}",
  "settings.config.source.xdg": "XDGグローバル構成",
  "settings.config.source.homeCypher": "Homeの.cypher構成",
  "settings.config.source.homeCyphercode": "Homeの.cypher構成",
  "settings.config.source.homeOpencode": "Homeの.opencode構成",
  "settings.config.source.envFile": "CYPHER_CONFIG環境ファイル",
  "settings.config.source.envDir": "CYPHER_CONFIG_DIR",
  "settings.config.source.envContent": "インライン環境構成",
  "settings.config.source.projectCypher": "プロジェクトの.cypher構成",
  "settings.config.source.projectRoot": "プロジェクトルート構成",
  "settings.config.source.projectCyphercode": "旧.cypher構成",
  ...
  "workStyle.onboarding.welcome": "Cypherへようこそ",
  ...
  "workStyle.choice.human-in-the-loop.description": "Cypherは作業中に一時停止し、計画を表示します。",
  ...
  "session.cloud.import.placeholder": "セッションID、URL、またはcypher importコマンド",
  ...
  "deviceAuth.title": "Cypher CLIにサインイン",
  ...
  "settings.aboutCypher.title": "Cypher CLIについて",

  "session.messages.empty": "下にメッセージを入力して会話を始めましょう。",
  "session.messages.welcome":
    "Cypher CLIはAIコーディングアシスタントです。機能の構築、バグの修正、コードベースの説明を依頼できます。",
  ...
  "settings.aboutCypher.status.connected": "接続済み",
  "settings.aboutCypher.status.connecting": "接続中...",
  "settings.aboutCypher.status.disconnected": "切断",
  "settings.aboutCypher.status.error": "エラー",
  "settings.aboutCypher.cliServer": "CLIサーバー",
  "settings.aboutCypher.status.label": "ステータス：",
  "settings.aboutCypher.port.label": "ポート：",
  "settings.aboutCypher.versionInfo": "バージョン情報",
  "settings.aboutCypher.version.label": "バージョン：",
  "settings.aboutCypher.extensionName": "Cypher CLI拡張機能",
  "settings.aboutCypher.community": "コミュニティとサポート",
  "settings.aboutCypher.feedback.prefix": "ご質問やフィードバックがありましたら、お気軽にissueを作成してください",
  "settings.aboutCypher.feedback.or": "または",
  "settings.aboutCypher.support.prefix":
    "請求やアカウントに関するご質問は、カスタマーサポートまでお問い合わせください",
  "settings.aboutCypher.resetSettings.title": "設定をリセット",
  ...
  "settings.aboutCypher.resetSettings.button": "すべての設定をリセット",
  "settings.aboutCypher.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutCypher.settingsTransfer.title": "設定の移行",
  "settings.aboutCypher.settingsTransfer.description":
    "VS Code インスタンス間で設定を転送するには、エクスポートまたはインポートしてください。",
  "settings.aboutCypher.exportSettings": "エクスポート",
  "settings.aboutCypher.importSettings": "インポート",
  "settings.aboutCypher.importSettings.invalidJson":
    "無効な JSON ファイルです。有効な設定ファイルを選択してください。",
  "settings.aboutCypher.importSettings.invalidConfig": "ファイルに有効な Cypher の設定が含まれていません。",
  "settings.aboutCypher.importSettings.tooLarge": "ファイルが大きすぎます。設定ファイルは 1 MB 以下にしてください。",
  "settings.aboutCypher.importSettings.newerVersion":
    "このファイルはより新しいバージョンの Cypher からエクスポートされたものです。一部の設定が無視される場合があります。",
  "settings.aboutCypher.importSettings.success":
    "設定をインポートしました。上記の変更内容を確認してから、保存をクリックしてください。",

  "settings.aboutCypher.telemetry.title": "テレメトリ",
  ...
  "settings.aboutCypher.telemetry.openSettings": "テレメトリ設定を開く",
  ...
  "settings.language.description": "Cypher CLI UIの言語を選択します。「自動」はVS Codeの表示言語を使用します。",
  ...
  "settings.experimental.speechToText.description":
    "Cypher Gateway経由でCypherアカウントを使用して、プロンプトフィールドでの音声入力を有効にします。",
  "settings.models.speechToText.disabledDescription":
    "Speech to Text を使用するには、Cypher プロバイダーを有効にしてサインインしてください。現在、Speech to Text は Cypher Gateway でのみサポートされています。",
  "settings.models.speechToTextModel.title": "音声認識モデル",
  "settings.models.speechToTextModel.description": "音声入力に使用するCypher Gateway文字起こしモデルを選択します。",
  ...
  "settings.experimental.remote.description":
    "Cypher Cloud 経由でのセッションの Remote コントロールを有効にします。これはこのマシンの CLI にも影響します。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code の設定ディレクトリから CLAUDE.md のインストラクションとスキルをセッションに読み込みます。Cypher に Claude Code のインストラクションとスキルを使用させる場合は、これを有効にしてください。再起動が必要です。",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCPサーバーが設定されていません。cypher.jsoncでMCPサーバーを追加するか、エージェントに追加を依頼してください。",
  ...
  "settings.sandboxing.enabled.description":
    "エージェントのシェルコマンドを、プロジェクトおよびCypherの状態ディレクトリへの書き込みを制限するOSレベルのサンドボックス内で実行",
  ...
  "settings.display.fontSize.description": "VS Code とは独立して Cypher webview UI のフォントサイズを調整します。",
  ...
  "settings.aboutCypher.legacyMigration.title": "レガシー移行",
  "settings.aboutCypher.legacyMigration.description":
    "プロバイダーのAPIキーやデフォルトモデルなど、以前にインストールしたCypher CLIから設定を移行します。",
  "settings.aboutCypher.rooImport.description": "インストールしたRoo Codeから会話履歴を移行します。",
  "settings.aboutCypher.rooImport.button": "Roo Codeからセッションをインポート",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Cypher CLIの新機能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "すべてのCypher製品で共有される小さく効率的なコア。どのような作業スタイルでも馴染みのある体験を提供します。",
  ...
  "diffViewer.source.session.tooltip":
    "現在のセッション中に Cypher が変更したファイル。ターンごとのスナップショットに基づきます。新しいセッションを開始するとリセットされます。",
