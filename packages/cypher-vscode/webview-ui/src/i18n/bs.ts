export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Instalirajte Anaconda Desktop na ovom računaru, zatim se vratite ovdje. Cypher ne pokreće instalacijski program umjesto vas.",
  ...
  "provider.anaconda.state.unauthorized":
    "Cypher nije mogao pristupiti Anaconda Desktopu. Otvorite Desktop, ponovo se prijavite i ponovo ga pokrenite ako je potrebno.",
  ...
  "provider.anaconda.state.ready":
    "Cypher je pronašao ispravan lokalni server za generisanje teksta i može uvesti njegove trenutne postavke veze.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Cypher nije mogao provjeriti dostupne vještine.",
  "agentRequirements.error.mcpStatusFailed": "Cypher nije mogao provjeriti status MCP servera.",
  "agentRequirements.error.scopeMismatch": "Ova provjera zahtjeva agenta više nije aktivna.",
  "agentRequirements.error.requestFailed": "Cypher nije mogao provjeriti zahtjeve agenta.",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Cypher",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Cypher-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Cypher-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Cypher-u.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox je omogućen. Shell komande agenta su ograničene na direktorije projekta i Cypher.",
  "prompt.action.sandbox.disabled":
    "Sandbox je onemogućen. Kliknite da ograničite pisanje shell komandi agenta na direktorije projekta i Cypher.",
  ...
  "prompt.action.sandbox.description.enabled": "Pisanje je ograničeno na direktorije projekta i Cypher.",
  ...
  "speechToText.tooltip.start": "Započni glasovni unos sa Cypher Gateway",
  ...
  "speechToText.error.loginRequired": "Prijavite se na Cypher da koristite glasovni unos.",
  ...
  "dialog.server.description": "Promijeni na koji se Cypher server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Cypher-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Cypher timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Cypher još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Cypher uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Cypher-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Cypher izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Cypher-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Cypher pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Cypher-a.",
  ...
  "settings.indexing.cypherModel.title": "Preset Cypher modela",
  "settings.indexing.cypherModel.description": "Odaberite podržani model embeddinga hostovan na Cypher.",
  "settings.indexing.cypherSignIn.title": "Potrebna je prijava na Cypher",
  "settings.indexing.cypherSignIn.description": "Prijavite se na Cypher za korištenje hostovanih embeddinga.",
  ...
  "settings.providers.betaNotice":
    "Trenutno se samo Cypher Gateway provajder može konfigurisati u interfejsu za postavke. Podrška za konfigurisanje drugih provajdera stiže uskoro tokom beta perioda. U međuvremenu, provajdere možete konfigurisati koristeći CLI ili konfiguracijsku datoteku. Posvećeni smo tome da Cypher ostane otvoren, bez vezivanja.",
  ...
  "settings.models.hidePromptTraining.description":
    "Sakrij Cypher Gateway modele čiji pružaoci mogu koristiti vaše promptove za treniranje.",
  ...
  "settings.config.title": "Otvori {{scope}} Cypher konfiguracijsku datoteku",
  "settings.config.placeholder":
    "Konfiguracijske datoteke se spajaju po redu; datoteke označene kao učitane trenutno utiču na postavke.",
  "settings.config.noWorkspace": "Otvorite fasciklu radnog prostora da uredite lokalnu Cypher konfiguracijsku datoteku.",
  "settings.config.openFailed": "Nije uspjelo otvaranje {{scope}} Cypher konfiguracijske datoteke: {{message}}",
  "settings.config.source.xdg": "XDG globalna konfiguracija",
  "settings.config.source.homeCypher": "Home .cypher konfiguracija",
  "settings.config.source.homeCyphercode": "Home .cypher konfiguracija",
  "settings.config.source.homeOpencode": "Home .opencode konfiguracija",
  "settings.config.source.envFile": "CYPHER_CONFIG datoteka okruženja",
  "settings.config.source.envDir": "CYPHER_CONFIG_DIR",
  "settings.config.source.envContent": "Ugrađena konfiguracija okruženja",
  "settings.config.source.projectCypher": "Projektna .cypher konfiguracija",
  "settings.config.source.projectRoot": "Konfiguracija korijena projekta",
  "settings.config.source.projectCyphercode": "Zastarjela .cypher konfiguracija",
  ...
  "workStyle.onboarding.welcome": "Dobro došli u Cypher",
  ...
  "workStyle.choice.human-in-the-loop.description": "Cypher zastaje i prikazuje vam svoj plan tokom rada.",
  ...
  "session.cloud.import.placeholder": "ID sesije, URL ili cypher import naredba",
  ...
  "deviceAuth.title": "Prijavite se u Cypher CLI",
  ...
  "profile.action.login": "Prijavite se putem Cypher CLI",
  ...
  "profile.pass.subscribe": "Nabavite Cypher Pass da dodate kredite i zaradite bonuse",
  ...
  "settings.aboutCypher.title": "O Cypher CLI-u",

  "session.messages.empty": "Započnite razgovor unosom poruke ispod.",
  "session.messages.welcome":
    "Cypher CLI je AI asistent za programiranje. Zatražite da gradi funkcionalnosti, ispravlja greške ili objasni vašu bazu koda.",
  ...
  "settings.aboutCypher.status.connected": "Povezano",
  "settings.aboutCypher.status.connecting": "Povezivanje...",
  "settings.aboutCypher.status.disconnected": "Odspojeno",
  "settings.aboutCypher.status.error": "Greška",
  "settings.aboutCypher.cliServer": "CLI server",
  "settings.aboutCypher.status.label": "Status:",
  "settings.aboutCypher.port.label": "Port:",
  "settings.aboutCypher.versionInfo": "Informacije o verziji",
  "settings.aboutCypher.version.label": "Verzija:",
  "settings.aboutCypher.extensionName": "Cypher CLI ekstenzija",
  "settings.aboutCypher.community": "Zajednica i podrška",
  "settings.aboutCypher.feedback.prefix": "Ako imate pitanja ili povratne informacije, slobodno otvorite issue na",
  "settings.aboutCypher.feedback.or": "ili",
  "settings.aboutCypher.support.prefix": "Za pitanja o naplati ili računu, kontaktirajte korisničku podršku na",
  "settings.aboutCypher.resetSettings.title": "Resetovanje postavki",
  ...
  "settings.aboutCypher.resetSettings.button": "Resetuj sve postavke",
  "settings.aboutCypher.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutCypher.settingsTransfer.title": "Prijenos postavki",
  "settings.aboutCypher.settingsTransfer.description":
    "Izvezite ili uvezite postavke za prijenos između VS Code instanci.",
  "settings.aboutCypher.exportSettings": "Izvezi",
  "settings.aboutCypher.importSettings": "Uvezi",
  "settings.aboutCypher.importSettings.invalidJson": "Nevažeći JSON fajl. Odaberite važeći fajl s postavkama.",
  "settings.aboutCypher.importSettings.invalidConfig": "Fajl ne sadrži važeće Cypher postavke.",
  "settings.aboutCypher.importSettings.tooLarge": "Fajl je prevelik. Fajlovi s postavkama moraju biti manji od 1 MB.",
  "settings.aboutCypher.importSettings.newerVersion":
    "Ovaj fajl je izvezen iz novije verzije Cypher-a. Neke postavke mogu biti zanemarene.",
  "settings.aboutCypher.importSettings.success":
    "Postavke su uvezene. Pregledajte promjene iznad, a zatim kliknite Sačuvaj.",

  "settings.aboutCypher.telemetry.title": "Telemetrija",
  ...
  "settings.aboutCypher.telemetry.openSettings": "Otvori postavke telemetrije",
  ...
  "settings.language.description": 'Odaberite jezik za Cypher CLI sučelje. "Auto" koristi jezik prikaza VS Code-a.',
  ...
  "settings.experimental.speechToText.description":
    "Omogućite glasovni unos u poljima za promptove koristeći vaš Cypher račun preko Cypher Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Omogućite i prijavite se na Cypher provajder da biste koristili Speech to Text. Speech to Text je trenutno podržan samo uz Cypher Gateway.",
  "settings.models.speechToTextModel.title": "Model govora u tekst",
  "settings.models.speechToTextModel.description": "Odaberite Cypher Gateway model za transkripciju za glasovni unos.",
  ...
  "settings.experimental.remote.description":
    "Omogućite Remote kontrolu sesija putem Cypher Cloud. Ovo će također utjecati na CLI-jeve na ovoj mašini.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Učitajte CLAUDE.md instrukcije i vještine iz vašeg Claude Code konfiguracijskog direktorija u sesije. Omogućite ovo ako želite da Cypher koristi vaše Claude Code instrukcije i vještine. Zahtijeva ponovno pokretanje.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nema konfiguriranih MCP servera. Dodajte MCP servere u cypher.jsonc ili zamolite agenta da ih doda.",
  ...
  "settings.sandboxing.enabled.description":
    "Pokrenite shell komande agenta unutar sandboxa na nivou operativnog sistema koji ograničava pisanje na direktorije stanja projekta i Cypher",
  ...
  "settings.display.fontSize.description": "Prilagodite veličinu fonta za Cypher webview UI nezavisno od VS Code-a.",
  ...
  "settings.aboutCypher.legacyMigration.title": "Migracija sa prethodne verzije",
  "settings.aboutCypher.legacyMigration.description":
    "Migrirajte postavke iz prethodne instalacije Cypher CLI, uključujući API ključeve provajdera i podrazumijevani model.",
  "settings.aboutCypher.rooImport.description": "Uvezite historiju razgovora iz instalacije Roo Code.",
  "settings.aboutCypher.rooImport.button": "Uvezi sesije iz Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Šta je novo u Cypher CLI",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno malo, efikasno jezgro kroz sve Cypher proizvode. Poznato iskustvo bez obzira na to kako odaberete raditi.",
  ...
  "diffViewer.source.session.tooltip":
    "Datoteke koje je Cypher promijenio tokom trenutne sesije, na osnovu snapshota po koraku. Resetuje se kada pokrenete novu sesiju.",
