export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Instala Anaconda Desktop en este equipo y luego vuelve aquí. Cypher no ejecuta el instalador por ti.",
  ...
  "provider.anaconda.state.signedOut": "Abre Anaconda Desktop e inicia sesión antes de conectar Cypher.",
  "provider.anaconda.state.unauthorized":
    "Cypher no pudo acceder a Anaconda Desktop. Abre Desktop, inicia sesión de nuevo y reinícialo si es necesario.",
  ...
  "provider.anaconda.state.ready":
    "Cypher encontró un servidor local de generación de texto en buen estado y puede importar su configuración de conexión actual.",
  ...
  "provider.anaconda.toast.refreshed.description": "El servidor local activo y los modelos están actualizados en Cypher.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Cypher no pudo comprobar las habilidades disponibles.",
  "agentRequirements.error.mcpStatusFailed": "Cypher no pudo comprobar el estado del servidor MCP.",
  "agentRequirements.error.scopeMismatch": "Esta comprobación de requisitos del agente ya no está activa.",
  "agentRequirements.error.requestFailed": "Cypher no pudo comprobar los requisitos del agente.",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Cypher",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Cypher.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Cypher.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Cypher.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox activado. Los comandos de shell del agente están limitados a los directorios del proyecto y de Cypher.",
  "prompt.action.sandbox.disabled":
    "Sandbox desactivado. Haz clic para limitar las escrituras de los comandos de shell del agente a los directorios del proyecto y de Cypher.",
  ...
  "prompt.action.sandbox.description.enabled": "Las escrituras se limitan a los directorios del proyecto y de Cypher.",
  ...
  "speechToText.tooltip.start": "Iniciar entrada de voz con Cypher Gateway",
  ...
  "speechToText.error.loginRequired": "Inicia sesión en Cypher para usar la entrada de voz.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Cypher se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Cypher ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Cypher",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Cypher no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Cypher incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "app.name.desktop": "Cypher Desktop",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Cypher",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Cypher en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Cypher.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Cypher",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Cypher.",
  ...
  "settings.indexing.cypherModel.title": "Preajuste de modelo de Cypher",
  "settings.indexing.cypherModel.description": "Elige un modelo de embeddings alojado por Cypher compatible.",
  "settings.indexing.cypherSignIn.title": "Se requiere iniciar sesión en Cypher",
  "settings.indexing.cypherSignIn.description": "Inicia sesión en Cypher para usar embeddings alojados.",
  ...
  "settings.providers.betaNotice":
    "Actualmente, solo el proveedor Cypher Gateway se puede configurar en la interfaz de ajustes. El soporte para configurar otros proveedores llegará pronto durante el período beta. Mientras tanto, puedes configurar proveedores usando la CLI o el archivo de configuración. Estamos comprometidos a mantener Cypher abierto, sin ataduras.",
  ...
  "settings.models.hidePromptTraining.description":
    "Oculta los modelos de Cypher Gateway cuyos proveedores pueden usar tus prompts para entrenamiento.",
  ...
  "settings.config.title": "Abrir archivo de configuración Cypher {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Abre una carpeta de espacio de trabajo para editar el archivo de configuración Cypher local.",
  "settings.config.openFailed": "Error al abrir el archivo de configuración Cypher {{scope}}: {{message}}",
  "settings.config.source.xdg": "Configuración global XDG",
  "settings.config.source.homeCypher": "Configuración .cypher de Home",
  "settings.config.source.homeCyphercode": "Configuración .cypher de Home",
  "settings.config.source.homeOpencode": "Configuración .opencode de Home",
  "settings.config.source.envFile": "Archivo de entorno CYPHER_CONFIG",
  "settings.config.source.envDir": "CYPHER_CONFIG_DIR",
  "settings.config.source.envContent": "Configuración de entorno en línea",
  "settings.config.source.projectCypher": "Configuración .cypher del proyecto",
  "settings.config.source.projectRoot": "Configuración raíz del proyecto",
  "settings.config.source.projectCyphercode": "Configuración heredada .cypher",
  ...
  "workStyle.onboarding.welcome": "Te damos la bienvenida a Cypher",
  ...
  "workStyle.choice.human-in-the-loop.description": "Cypher se detiene y te muestra su plan mientras trabaja.",
  ...
  "session.cloud.import.placeholder": "ID de sesión, URL o comando cypher import",
  ...
  "deviceAuth.title": "Iniciar sesión en Cypher CLI",
  ...
  "profile.action.login": "Iniciar sesión con Cypher CLI",
  ...
  "profile.pass.subscribe": "Obtén Cypher Pass para añadir créditos y ganar bonificaciones",
  ...
  "settings.aboutCypher.title": "Acerca de Cypher CLI",

  "session.messages.empty": "Inicia una conversación escribiendo un mensaje a continuación.",
  "session.messages.welcome":
    "Cypher CLI es un asistente de programación con IA. Pídele que cree funcionalidades, corrija errores o explique tu código.",
  ...
  "settings.aboutCypher.status.connected": "Conectado",
  "settings.aboutCypher.status.connecting": "Conectando...",
  "settings.aboutCypher.status.disconnected": "Desconectado",
  "settings.aboutCypher.status.error": "Error",
  "settings.aboutCypher.cliServer": "Servidor CLI",
  "settings.aboutCypher.status.label": "Estado:",
  "settings.aboutCypher.port.label": "Puerto:",
  "settings.aboutCypher.versionInfo": "Información de versión",
  "settings.aboutCypher.version.label": "Versión:",
  "settings.aboutCypher.extensionName": "Extensión Cypher CLI",
  "settings.aboutCypher.community": "Comunidad y soporte",
  "settings.aboutCypher.feedback.prefix": "Si tienes preguntas o comentarios, abre un issue en",
  "settings.aboutCypher.feedback.or": "o",
  "settings.aboutCypher.support.prefix": "Para preguntas de facturación o cuenta, contacta al Soporte al Cliente en",
  "settings.aboutCypher.resetSettings.title": "Restablecer configuración",
  "settings.aboutCypher.resetSettings.description":
  ...
  "settings.aboutCypher.resetSettings.button": "Restablecer toda la configuración",
  "settings.aboutCypher.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutCypher.settingsTransfer.title": "Transferencia de ajustes",
  "settings.aboutCypher.settingsTransfer.description":
    "Exporta o importa tus ajustes para transferirlos entre instancias de VS Code.",
  "settings.aboutCypher.exportSettings": "Exportar",
  "settings.aboutCypher.importSettings": "Importar",
  "settings.aboutCypher.importSettings.invalidJson":
    "Archivo JSON no válido. Seleccione un archivo de ajustes válido.",
  "settings.aboutCypher.importSettings.invalidConfig": "El archivo no contiene ajustes válidos de Cypher.",
  "settings.aboutCypher.importSettings.tooLarge":
    "El archivo es demasiado grande. Los archivos de ajustes deben ser menores de 1 MB.",
  "settings.aboutCypher.importSettings.newerVersion":
    "Este archivo fue exportado desde una versión más reciente de Cypher. Algunos ajustes podrían ignorarse.",
  "settings.aboutCypher.importSettings.success":
    "Ajustes importados. Revise los cambios anteriores y luego haga clic en Guardar.",

  "settings.aboutCypher.telemetry.title": "Telemetría",
  "settings.aboutCypher.telemetry.description":
  ...
  "settings.aboutCypher.telemetry.openSettings": "Abrir configuración de telemetría",
  ...
  "settings.language.description":
    'Elige el idioma de la interfaz de Cypher CLI. "Auto" utiliza el idioma de visualización de VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "Habilita la entrada de voz en los campos de prompt usando tu cuenta de Cypher a través de Cypher Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Habilita e inicia sesión en el proveedor Cypher para usar Speech to Text. Actualmente, Speech to Text solo es compatible con Cypher Gateway.",
  "settings.models.speechToTextModel.title": "Modelo de voz a texto",
  "settings.models.speechToTextModel.description":
    "Elige el modelo de transcripción de Cypher Gateway para la entrada de voz.",
  ...
  "settings.experimental.remote.description":
    "Habilite el control Remote de las sesiones a través de Cypher Cloud. Esto también afectará a las CLI de este equipo.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carga las instrucciones y habilidades de CLAUDE.md desde tu directorio de configuración de Claude Code en las sesiones. Activa esta opción si quieres que Cypher utilice tus instrucciones y habilidades de Claude Code. Requiere reiniciar.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "No hay servidores MCP configurados. Añada servidores MCP en cypher.jsonc o pida al agente que los añada.",
  ...
  "settings.sandboxing.enabled.description":
    "Ejecutar los comandos de shell del agente dentro de un sandbox a nivel de sistema operativo que restringe las escrituras a los directorios de estado del proyecto y de Cypher",
  ...
  "settings.display.fontSize.description":
    "Ajusta el tamaño de fuente de la webview UI de Cypher de forma independiente a VS Code.",
  ...
  "settings.aboutCypher.legacyMigration.title": "Migración heredada",
  "settings.aboutCypher.legacyMigration.description":
    "Migra la configuración de una instalación anterior de Cypher CLI, incluyendo las claves API de proveedores y el modelo predeterminado.",
  "settings.aboutCypher.rooImport.description":
    "Importa el historial de conversaciones de una instalación de Roo Code.",
  "settings.aboutCypher.rooImport.button": "Importar sesiones desde Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Novedades en Cypher CLI",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un núcleo pequeño y eficiente en todos los productos Cypher. Una experiencia familiar sin importar cómo elijas trabajar.",
  ...
  "diffViewer.source.session.tooltip":
    "Archivos modificados por Cypher durante la sesión actual, basado en snapshots por turno. Se reinicia al empezar una nueva sesión.",
