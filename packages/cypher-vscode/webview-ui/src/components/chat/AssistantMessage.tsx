...
import { Part, PART_MAPPING, ToolRegistry } from "@cypher/cypher-ui/message-part"
import type { MessageFeedbackControls } from "@cypher/cypher-ui/message-part"
...
import { useData } from "@cypher/cypher-ui/context/data"
...
function isRenderable(part: SDKPart): boolean {
  if (part.type === "tool") {
    ...
    if (UPSTREAM_SUPPRESSED_TOOLS.has(tool)) {
      // Show completed todo parts only when cypher-ui provides a visible renderer.
