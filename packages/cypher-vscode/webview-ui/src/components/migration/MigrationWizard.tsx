...
// ---------------------------------------------------------------------------
// CypherLogo — replicates the pattern from MessageList.tsx
// ---------------------------------------------------------------------------
...
const CypherLogo = (): JSX.Element => {
  ...
  const icon = isLight ? "cypher-light.svg" : "cypher-dark.svg"
  return (
    <div class="migration-wizard__logo">
      <img src={`${iconsBaseUri}/${icon}`} alt="Cypher CLI" />
    </div>
  )
}
      ...
      <div class="migration-wizard__container">
        ...
        <div class={screen() === "whats-new" ? "migration-wizard__screen--active" : "migration-wizard__screen--hidden"}>
          ...
          <div class="migration-wizard__blog-link">
            <a href="https://blog.cypher.ai/p/new-cypher-for-vs-code-is-live">
              {language.t("migration.whatsNew.blogLink")} <span>&rarr;</span>
            </a>
            <a href="https://cypher.ai/docs/code-with-ai/platforms/vscode/whats-new">
