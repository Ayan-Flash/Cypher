...
import { Tooltip } from "@cypher/cypher-ui/tooltip"
...
const ProfileView: Component<ProfileViewProps> = (props) => {
  ...
  const handleDashboard = () => {
    vscode.postMessage({ type: "openExternal", url: "https://app.cypher.ai/profile" })
  }

  const handleTopUp = () => {
    vscode.postMessage({ type: "openExternal", url: "https://app.cypher.ai/credits" })
  }

  const handleGetPass = () => {
    vscode.postMessage({ type: "openExternal", url: "https://cypher.ai/pricing/cypher-pass" })
  }
  ...
  return (
    <div style={{ display: "flex", "flex-direction": "column", height: "100%" }}>
      ...
      >
        <h2 style={{ "font-size": "var(--cypher-font-size-16)", "font-weight": "600", margin: 0 }}>
            ...
            <div style={{ display: "flex", "flex-direction": "column", gap: "12px" }}>
              ...
              <Show when={orgOptions().length > 0}>
                <Card>
                  <p
                    style={{
                      "font-size": "var(--cypher-font-size-11)",
                  ...
                  <Card style={{ display: "flex", "flex-direction": "column", gap: "12px" }}>
                    <div style={{ display: "flex", "align-items": "center", "justify-content": "space-between" }}>
                      <div>
                        ...
                        <p
                          style={{
                            "font-size": "var(--cypher-font-size-18)",
                            "font-weight": "600",
                            color: "var(--vscode-foreground)",
                            margin: 0,
                          }}
                    ...
                    {/* Cypher Pass is part of personal credits, so only show it on the personal account */}
                    <Show
                      when={
                    ...
                    >
                      {(pass) => (
                        ...
                        >
                          ...
                          >
                            <span style={{ "font-weight": "600", color: "var(--vscode-foreground)" }}>Cypher Pass</span>
                    ...
                    {/* No active Cypher Pass on the personal account — nudge to subscribe */}
                    <Show
                      when={
