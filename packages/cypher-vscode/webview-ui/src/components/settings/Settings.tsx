...
import { Tabs } from "@cypher/cypher-ui/tabs"
...
import AboutCypherTab from "./AboutCypherTab"
...
const Settings: Component<SettingsProps> = (props) => {
  ...
  const open = (scope: "local" | "global") => {
    ...
    vscode.postMessage({
      ...
      labels: {
        ...
        sourceHomeCypher: language.t("settings.config.source.homeCypher"),
        sourceHomeCyphercode: language.t("settings.config.source.homeCyphercode"),
        ...
        sourceProjectCypher: language.t("settings.config.source.projectCypher"),
        sourceProjectRoot: language.t("settings.config.source.projectRoot"),
        sourceProjectCyphercode: language.t("settings.config.source.projectCyphercode"),
  ...
  return (
    <div style={{ display: "flex", "flex-direction": "column", height: "100%", "min-height": 0 }}>
      ...
      >
        <h2 style={{ "font-size": "var(--cypher-font-size-16)", "font-weight": "600", margin: 0, flex: 1 }}>
      ...
      >
        <Tabs.List>
          ...
          <Tabs.Trigger value="aboutCypher" aria-label={language.t("settings.aboutCypher.title")}>
            <Icon name="help" />
            <span class="label">{language.t("settings.aboutCypher.title")}</span>
          </Tabs.Trigger>
        </Tabs.List>
        ...
        <Tabs.Content value="aboutCypher">
          <h3>{language.t("settings.aboutCypher.title")}</h3>
          <AboutCypherTab
