...
import type { BrowserSettings, Config, FeatureFlags, IndexingStatus, CypherEmbeddingModelCatalog } from "./config"
import type { WorkStyle, WorkStyleState } from "../../../../src/shared/work-style-presets"
import type { CyphercodeNotification, ProfileData } from "./profile"
import type {
...
export interface SelectCypherModelMessage {
  type: "selectCypherModel"
  modelID?: string
  agent?: string
}
...
export interface CypherEmbeddingModelsLoadedMessage {
  type: "cypherEmbeddingModelsLoaded"
  catalog: CypherEmbeddingModelCatalog
}
...
export type ExtensionMessage =
  ...
  | CypherEmbeddingModelsLoadedMessage
