...
export interface OpenConfigFileRequest {
  ...
  labels: {
    ...
    openFailed: string
    sourceXdg: string
    sourceHomeCypher: string
    sourceHomeCyphercode: string
    sourceHomeOpencode: string
    sourceEnvFile: string
    sourceEnvDir: string
    sourceEnvContent: string
    sourceProjectCypher: string
    sourceProjectRoot: string
    sourceProjectCyphercode: string
...
export interface OpenCypherClawRequest {
  type: "openCypherClaw"
}
...
export interface RequestCypherEmbeddingModelsMessage {
  type: "requestCypherEmbeddingModels"
}
...
export interface UpdateConfigMessage {
  type: "updateConfig"
  /** Global config patch written to ~/.config/cypher/cypher.json. */
  config: Partial<Config>
  globalUnset?: string[][]
  /** Project config patch written to the workspace's .cypher/cypher.jsonc or existing project config. */
...
export type WebviewMessage =
  ...
  | RequestCypherEmbeddingModelsMessage
  | UpdateConfigMessage
