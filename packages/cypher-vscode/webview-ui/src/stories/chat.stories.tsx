...
export const UserMessageReviewComments: Story = {
  ...
  render: () => {
    const comments: ReviewComment[] = [
      {
        id: "review-1",
        file: "src/components/chat/CypherBackendChatManager.kt",
        side: "additions",
        line: 114,
      ...
      {
        id: "review-2",
        file: "resources/messages/CypherBundle_bs.properties",
        side: "deletions",
        line: 235,
  ...
  [toolAssistantID]: [
    ...
    },
    {
      ...
      state: {
        ...
        output: "/Users/marius/Documents/git/cypher/.cypher/worktrees/zest-kettledrum",
        title: "pwd",
        metadata: {},
...
const usageData = {
  ...
  models: [
    { providerID: "cypher", modelID: "qwen/qwen3.7-plus-20260602", steps: 3, cost: 0.067214, tokens: usageTokens },
    {
      providerID: "minimax",
      modelID: "minimax-m3",
      steps: 1,
...
const usageProvider = {
  ...
  connected: () => ["cypher", "minimax"],
  defaults: () => ({}),
  defaultSelection: () => ({ providerID: "cypher", modelID: "qwen/qwen3.7-plus" }),
  models: () => [],
  findModel: () => undefined,
  authMethods: () => ({}),
  authStates: () => ({}),
...
// ---------------------------------------------------------------------------
// Welcome screen with AccountSwitcher + CypherNotifications
// ---------------------------------------------------------------------------

const MOCK_NOTIFICATION = {
  id: "notif-1",
  title: "Try BYOK for Cypher Gateway",
  message: "Bring your own API key for even more flexibility with Cypher Gateway models.",
  action: { actionText: "Learn more", actionURL: "https://cypher.ai/docs" },
}
...
const mockServer = {
  ...
  profileData: () => ({
    profile: {
      email: "dev@cypher.dev",
      name: "Dev User",
      organizations: [{ id: "org-1", name: "Cypher Org", role: "member" }],
    },
    balance: { balance: 5.0 },
    currentOrgId: "org-1",
  }),
