  ...
  render: () => (
    <StoryProviders>
      <div style={{ display: "flex", "align-items": "center", gap: "8px" }}>
        <ModelSelectorBase
          value={{ providerID: "cypher", modelID: "cypher-auto/frontier" }}
          onSelect={() => {}}
...
const ACCESSIBLE_MODELS: EnrichedModel[] = [
  ...
  { id: "alpha", name: "Alpha", providerID: "cypher", providerName: "Cypher" },
  { id: "bravo", name: "Bravo", providerID: "cypher", providerName: "Cypher" },
  { id: "charlie", name: "Charlie", providerID: "cypher", providerName: "Cypher" },
  { id: "delta", name: "Delta", providerID: "cypher", providerName: "Cypher" },
  { id: "echo", name: "Echo", providerID: "cypher", providerName: "Cypher" },
...
const AccessibleModelSelector = () => {
  const [value, setValue] = createSignal<ModelSelection | null>({ providerID: "cypher", modelID: "alpha" })
...
export const ModelSelectorSelectedFavorite: Story = {
  ...
  render: () => {
    const session = {
      ...mockSessionValue(),
      favoriteModels: () => [{ providerID: "cypher", modelID: "alpha" }],
    }
