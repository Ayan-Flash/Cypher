...
import type { AssistantMessage, ToolPart } from "@cypher/sdk/v2"
...
const shellPart: ToolPart = {
  ...
  state: {
    ...
    input: {
      ...
      command: `grep -n "migration\\|openMigration" packages/cypher-vscode/webview-ui/src/types/messages.ts`,
    },
