...
import type { CyphercodeNotification, ExtensionMessage } from "../types/messages"

interface NotificationsContextValue {
  notifications: Accessor<CyphercodeNotification[]>
  filteredNotifications: Accessor<CyphercodeNotification[]>
