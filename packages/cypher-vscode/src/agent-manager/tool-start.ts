...
export interface ToolDeps {
  ...
  sessionMetadata: (client: CypherClient, dir: string) => Promise<Record<string, unknown>>
...
async function prompt(client: CypherClient, sid: string, dir: string, task: ToolTask) {
...
async function local(deps: ToolDeps, client: CypherClient, task: ToolTask, directory?: string) {
