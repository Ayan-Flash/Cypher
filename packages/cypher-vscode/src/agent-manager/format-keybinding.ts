...
const AM_PREFIX = "cypher-cli.new.agentManager."

/** Global commands whose keybindings are forwarded to the webview. */
const GLOBAL_KEYBINDINGS: Record<string, string> = {
  "cypher-cli.new.agentManagerOpen": "agentManagerOpen",
  "cypher-cli.new.cycleAgentMode": "cycleAgentMode",
  "cypher-cli.new.cyclePreviousAgentMode": "cyclePreviousAgentMode",
}
