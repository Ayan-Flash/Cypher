...
export class SessionTerminalManager {
  ...
  constructor(
    ...
    this.disposables.push(
      ...
      host.onActiveTerminalChanged((terminal) => {
        ...
        void host.setContext("cypher-cli.agentTerminalFocus", managed)
      }),
    )
  ...
  dispose(): void {
    void this.host.setContext("cypher-cli.agentTerminalFocus", false)
  ...
  private updateContextKey(): void {
    ...
    void this.host.setContext("cypher-cli.agentTerminalFocus", managed)
  }
