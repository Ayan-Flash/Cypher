 ...
 *
 * Reads/writes ~/.local/state/cypher/model.json (same file the CLI TUI uses)
...
async function resolve(client: CypherClient | null): Promise<string | undefined> {
...
async function read(client: CypherClient | null): Promise<Record<string, unknown>> {
...
function write(client: CypherClient | null, key: string, value: unknown): Promise<void> {
...
export async function reset(client: CypherClient | null, post: PostMessage): Promise<void> {
