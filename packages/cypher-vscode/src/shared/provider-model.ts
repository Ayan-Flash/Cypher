export const CYPHER_PROVIDER_ID = "cypher"
export const CYPHER_AUTO = { providerID: CYPHER_PROVIDER_ID, modelID: "cypher-auto/free" } as const
...
export function createCypherFallbackProvider() {
  return {
    id: CYPHER_PROVIDER_ID,
    name: "Cypher Gateway",
    source: "custom" as const,
    env: ["CYPHER_API_KEY"],
    metadata: {
      noteKey: "settings.providers.note.cypher",
      icon: CYPHER_PROVIDER_ID,
      priority: 0,
    },
    models: {},
  }
