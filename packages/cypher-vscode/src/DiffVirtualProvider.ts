...
export class DiffVirtualProvider implements vscode.Disposable {
  ...
  constructor(private readonly extensionUri: vscode.Uri) {
    this.outputChannel = vscode.window.createOutputChannel("Cypher Diff Virtual")
  }
  ...
  public open(diff: DiffVirtualFile): void {
    ...
    const panel = vscode.window.createWebviewPanel("cypher-cli.new.DiffVirtualPanel", title, vscode.ViewColumn.One, {
      enableScripts: true,
