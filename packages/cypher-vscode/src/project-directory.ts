 ...
 * ## Why this exists
 *
 * The sidebar CypherProvider always uses `getWorkspaceDirectory()`, which returns
 ...
 *
 * ## How CypherProvider uses this
 *
 * Each CypherProvider instance can receive an explicit `projectDirectory` via
 * `CypherProviderOptions`. When set:
 *
...
/**
 * Resolve the effective project directory for a CypherProvider instance.
 *
 * @param override - Explicit directory from CypherProviderOptions. `undefined`
 ...
 *   `getWorkspaceDirectory(sessionId)` from CypherProvider).
 */
