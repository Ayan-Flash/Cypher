...
const SUPPORTED_PROVIDER_DISPLAY_NAME = "Cypher Gateway"
const SETTINGS_COMMAND = `command:cypher-cli.new.settingsButtonClicked?${encodeURIComponent(JSON.stringify(["autocomplete"]))}`
...
export class AutocompleteStatusBar {
  ...
  private init() {
    this.statusBar.text = t("cypher:autocomplete.statusBar.enabled")
    this.statusBar.tooltip = this.createMarkdownTooltip(t("cypher:autocomplete.statusBar.tooltip.basic"))
    this.statusBar.show()
  }
  ...
  private renderDefault() {
    ...
    const snoozedSuffix = this.props.snoozed ? ` (${t("cypher:autocomplete.statusBar.snoozed")})` : ""
    this.statusBar.text = `${t("cypher:autocomplete.statusBar.enabled")} (${this.props.completionCount})${snoozedSuffix}`

    this.statusBar.tooltip = this.createMarkdownTooltip(
      [
        t("cypher:autocomplete.statusBar.tooltip.completionSummary", {
        ...
        this.props.model && this.props.provider
          ? t("cypher:autocomplete.statusBar.tooltip.providerInfo", {
  ...
  private renderNoUsableProviderError() {
    this.statusBar.text = t("cypher:autocomplete.statusBar.warning")
    this.statusBar.tooltip = this.createMarkdownTooltip(
      t("cypher:autocomplete.statusBar.tooltip.noUsableProvider", {
