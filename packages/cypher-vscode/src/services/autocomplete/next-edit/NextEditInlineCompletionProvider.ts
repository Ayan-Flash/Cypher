...
const INLINE_COMPLETION_ACCEPTED_COMMAND = "cypher-cli.new.autocomplete.nextEdit.accepted"
const DEFAULT_DEBOUNCE_MS = 250

export interface NextEditProviderDeps {
  /** Routes Mercury calls through the local Cypher gateway (handles auth + BYOK). */
  connectionService: CypherConnectionService
  /** Optional source of recently-viewed snippets (cypher's VisibleCodeTracker can adapt to this). */
