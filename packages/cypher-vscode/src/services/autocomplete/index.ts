...
export const registerAutocompleteProvider = async (
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("cypher-cli.new.autocomplete.reload", async () => {
      await autocompleteManager.load()
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("cypher-cli.new.autocomplete.codeActionQuickFix", async () => {
      return
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("cypher-cli.new.autocomplete.cancelSuggestions", () => {
      vscode.commands.executeCommand("editor.action.inlineSuggest.hide")
      vscode.commands.executeCommand("setContext", "cypher-cli.new.autocomplete.hasSuggestions", false)
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("cypher-cli.new.autocomplete.generateSuggestions", async () => {
      autocompleteManager.codeSuggestion()
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("cypher-cli.new.autocomplete.showIncompatibilityExtensionPopup", async () => {
      await autocompleteManager.showIncompatibilityExtensionPopup()
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("cypher-cli.new.autocomplete.disable", async () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("cypher-cli.new.autocomplete.nextEdit.acceptOrJump", async () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("cypher-cli.new.autocomplete.nextEdit.dismiss", () => {
  ...
  context.subscriptions.push(
    vscode.workspace.onDidChangeConfiguration((e) => {
      if (e.affectsConfiguration("cypher-cli.new.autocomplete")) {
