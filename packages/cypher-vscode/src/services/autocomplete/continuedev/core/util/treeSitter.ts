...
async function loadLanguageForFileExt(fileExtension: string): Promise<Language> {
  ...
  // In production (compiled): __dirname = /path/to/cypher/src/dist or dist/
  // In development: __dirname = /path/to/cypher/src/services/autocomplete/continuedev/core/util
  const candidatePaths: string[] = [
