...
export class InstallationDetector {
   ...
   *
   * Agents are detected from .cypher/agents/*.md files.
   * MCP servers and modes are detected from cypher.json config files.
  ...
  /** Scan .cypher/agents/*.md files to detect installed marketplace agents. */
  ...
  /** Read mcp and agent entries from a cypher.json config file. */
