/**
 * legacy-migration - Types for legacy Cypher CLI extension (v5.x) data structures.
 *
 * These types represent the shapes stored in VS Code SecretStorage and on disk
 * by the legacy extension (cypher.cypher-cli v5.x, a Roo Code fork).
...
// ---------------------------------------------------------------------------
// Settings (stored in VS Code globalState under "cypher-cli.*" keys)
// ---------------------------------------------------------------------------
